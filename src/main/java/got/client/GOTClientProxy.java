...
public class GOTClientProxy extends GOTCommonProxy {
	...
	private static GOTTickHandlerClient tickHandler;
	...
	static {
		setRenderPlayer(new GOTRenderPlayer());
		setSwingHandler(new GOTSwingHandler());
		setTickHandler(new GOTTickHandlerClient());
		setGuiHandler(new GOTGuiHandler());
	}
	...
	public static void setRenderPlayer(GOTRenderPlayer gotRenderPlayer) {
		GOTClientProxy.renderPlayer = gotRenderPlayer;
	}

	public static void setSwingHandler(GOTSwingHandler gotSwingHandler) {
		GOTClientProxy.swingHandler = gotSwingHandler;
	}

	public static void setGuiHandler(GOTGuiHandler gotGuiHandler) {
		GOTClientProxy.guiHandler = gotGuiHandler;
	}
}