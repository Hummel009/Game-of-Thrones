...
public class GOTModelSummerChestplate extends GOTModelBiped {
	...
	public GOTModelSummerChestplate(float f) {
		...
		chestHorn1.rotateAngleX = (float) -0.4363323129985824;
		chestHorn1.rotateAngleZ = (float) 0.4363323129985824;
		...
		chestHorn2.rotateAngleX = (float) -0.4363323129985824;
		chestHorn2.rotateAngleZ = (float) 0.0;
		...
		chestHorn3.rotateAngleX = (float) -0.4363323129985824;
		chestHorn3.rotateAngleZ = (float) -0.4363323129985824;
		...
		rightHorn1.rotateAngleZ = (float) -0.17453292519943295;
		...
		rightHorn2.rotateAngleZ = (float) -0.17453292519943295;
		...
		leftHorn1.rotateAngleZ = (float) 0.17453292519943295;
		...
		leftHorn2.rotateAngleZ = (float) 0.17453292519943295;
