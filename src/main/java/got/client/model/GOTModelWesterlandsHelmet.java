...
public class GOTModelWesterlandsHelmet extends GOTModelBiped {
	...
	public GOTModelWesterlandsHelmet(float f) {
		...
		crest.rotateAngleX = (float) -0.06981317007977318;
		...
		tusks1.rotateAngleX = (float) 0.3490658503988659;
		tusks1.rotateAngleY = (float) 0.5235987755982988;
		...
		tusks2.rotateAngleX = (float) 0.3490658503988659;
		tusks2.rotateAngleY = (float) -0.3490658503988659;
		...
		tusks3.rotateAngleX = (float) 0.3490658503988659;
		tusks3.rotateAngleY = (float) 0.3490658503988659;
		...
		tusks4.rotateAngleX = (float) 0.3490658503988659;
		tusks4.rotateAngleY = (float) -0.5235987755982988;
