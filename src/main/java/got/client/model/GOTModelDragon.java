...
public class GOTModelDragon extends ModelBase {
	...
	public GOTModelDragon(GOTDragonBreed breed) {
		textureWidth = 256;
		textureHeight = 256;
		bodyTexture = new ResourceLocation("got:mob/animal/dragon/body.png");
		glowTexture = new ResourceLocation("got:mob/animal/dragon/glow.png");
		saddleTexture = new ResourceLocation("got:mob/animal/dragon/saddle.png");
		eggTexture = new ResourceLocation("got:mob/animal/dragon/egg.png");
		this.breed = breed;
