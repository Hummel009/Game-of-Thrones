...
public class GOTRender {
	...
	public static void onInit() {
		...
		renders.put(GOTEntityLengMan.class, new GOTRenderFactionNPC("essos/leng"));
		...
		renders.put(GOTEntityAsshaiArchmag.class, new GOTRenderLegendaryNPC("archmag"));
		...
		renders.put(GOTEntityJonSnow.Stage1.class, new GOTRenderLegendaryNPCLayered("jon_snow"));
		renders.put(GOTEntityJonSnow.Stage2.class, new GOTRenderLegendaryNPCLayered("jon_snow_north"));
		...
		renders.put(GOTEntityThief.class, new GOTRenderFactionNPCMonofolder("westeros/unreliable"));
		renders.put(GOTEntityThiefEssos.class, new GOTRenderFactionNPCMonofolder("essos/unreliable"));
		renders.put(GOTEntityBandit.class, new GOTRenderFactionNPCMonofolder("westeros/unreliable"));
		renders.put(GOTEntityBanditEssos.class, new GOTRenderFactionNPCMonofolder("essos/unreliable"));
		renders.put(GOTEntityScrapTrader.class, new GOTRenderFactionNPCMonofolder("westeros/unreliable"));
		renders.put(GOTEntityScrapTraderEssos.class, new GOTRenderFactionNPCMonofolder("essos/unreliable"));
		...
		renders.put(GOTEntityGregorClegane.Alive.class, new GOTRenderGregorClegane.Alive());
		renders.put(GOTEntityGregorClegane.Dead.class, new GOTRenderGregorClegane.Dead());
		...
		renders.put(GOTEntityLancelLannister.Normal.class, new GOTRenderLancelLannister.Normal());
		renders.put(GOTEntityLancelLannister.Religious.class, new GOTRenderLancelLannister.Religious());
		...
		renders.put(GOTEntityTheonGreyjoy.Normal.class, new GOTRenderTheonGreyjoy.Normal());
		renders.put(GOTEntityTheonGreyjoy.Tormented.class, new GOTRenderTheonGreyjoy.Tormented());
