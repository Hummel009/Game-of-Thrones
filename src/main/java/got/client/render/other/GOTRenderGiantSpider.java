...
public class GOTRenderGiantSpider extends GOTRenderSpiderBase {
	private static ResourceLocation[] spiderSkins = { new ResourceLocation("got:textures/entity/ulthos/spider.png"), new ResourceLocation("got:textures/entity/ulthos/spiderSlowness.png"), new ResourceLocation("got:textures/entity/ulthos/spiderPoison.png") };
