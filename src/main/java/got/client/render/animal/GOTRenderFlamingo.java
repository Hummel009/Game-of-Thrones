...
public class GOTRenderFlamingo extends RenderLiving {
	public static ResourceLocation texture = new ResourceLocation("got:mob/animal/flamingo/flamingo.png");
	public static ResourceLocation textureChick = new ResourceLocation("got:mob/animal/flamingo/chick.png");
