...
public class GOTContainerAlloyForge extends Container {
	...
	public ItemStack transferStackInSlot(EntityPlayer entityplayer, int i) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			} else if (i >= 8 && i != 12 ? GOTTileEntityAlloyForge.getSmeltingResult(itemstack1) != null ? !mergeItemStack(itemstack1, 4, 8, false) : TileEntityFurnace.isItemFuel(itemstack1) ? !mergeItemStack(itemstack1, 12, 13, false) : i < 40 ? !mergeItemStack(itemstack1, 40, 49, false) : i < 49 && !mergeItemStack(itemstack1, 13, 40, false) : !mergeItemStack(itemstack1, 13, 49, false)) {
				return null;
			}
