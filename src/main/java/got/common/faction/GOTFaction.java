...
public enum GOTFaction {
	WHITE_WALKER(0x8ddaf8, DimensionRegion.WESTEROS, new GOTMapRegion(550, 550, 500)),
	 ...
	 BRAAVOS(0x832929, DimensionRegion.WEST_ESSOS, new GOTMapRegion(1221, 1351, 137)),
	 VOLANTIS(0x743C8E, DimensionRegion.WEST_ESSOS, new GOTMapRegion(1553, 1928, 210)),
	 PENTOS(0x13425F, DimensionRegion.WEST_ESSOS, new GOTMapRegion(1234, 1566, 172)),
	 NORVOS(0x9A676A, DimensionRegion.WEST_ESSOS, new GOTMapRegion(1437, 1468, 201)),
	 LORATH(0xCCA5A5, DimensionRegion.WEST_ESSOS, new GOTMapRegion(1379, 1354, 119)),
	 QOHOR(0x053246, DimensionRegion.WEST_ESSOS, new GOTMapRegion(1590, 1594, 214)),
	 LYS(0x4E412A, DimensionRegion.WEST_ESSOS, new GOTMapRegion(1204, 2053, 65)),
	 MYR(0x8A8A8A, DimensionRegion.WEST_ESSOS, new GOTMapRegion(1325, 1797, 223)),
	 ...
	 ULTHOS(0x343A2C, DimensionRegion.OTHER, new GOTMapRegion(4800, 3011, 2000)),
