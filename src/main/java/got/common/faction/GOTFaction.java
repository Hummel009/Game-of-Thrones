...
public enum GOTFaction {
	...
	ARRYN(3511475, DimensionRegion.WESTEROS, new GOTMapRegion(842, 1329, 176)), 
	...
	MYR(7250085, DimensionRegion.WEST_ESSOS, new GOTMapRegion(1325, 1797, 223)), 
	...
	QARTH(8536951, DimensionRegion.WEST_ESSOS, new GOTMapRegion(2750, 2277, 221)), 
	...
	ULTHOS(0x2B3F19, DimensionRegion.OTHER, new GOTMapRegion(4800, 3011, 2000)), HOSTILE(true, -1), UNALIGNED(false, 0);
