...
public class GOTItems {
	...
	public static void assignContent() {
		...
		fuse = new GOTItemDoubleTorch(GOTBlocks.fuse).setCreativeTab(GOTCreativeTabs.tabDeco);
		...
		sothoryosDoubleTorch = new GOTItemDoubleTorch(GOTBlocks.sothoryosDoubleTorch).setCreativeTab(GOTCreativeTabs.tabDeco);
