...
public class GOTAchievement {
	...
	public static void onInit() {
		...
		int entId = 1;
		enterAlwaysWinter = new GOTAchievement(Category.ENTER, entId++, Blocks.ice, "ENTER_ALWAYS_WINTER").setBiomeAchievement();
		enterArryn = new GOTAchievement(Category.ENTER, entId++, GOTItems.arrynHelmet, "ENTER_ARRYN").setBiomeAchievement();
		...
		enterCannibalSands = new GOTAchievement(Category.ENTER, entId++, GOTBlocks.quicksand, "ENTER_CANNIBAL_SANDS").setBiomeAchievement();
		enterColdCoast = new GOTAchievement(Category.ENTER, entId++, GOTItems.wildlingPolearm, "ENTER_COLD_COAST").setBiomeAchievement();
		enterCrownlands = new GOTAchievement(Category.ENTER, entId++, GOTItems.crownlandsHelmet, "ENTER_CROWNLANDS").setBiomeAchievement();
		enterCrownlandsTown = new GOTAchievement(Category.ENTER, entId++, GOTItems.crownlandsHelmet, "ENTER_CROWNLANDS_TOWN").setBiomeAchievement();
		enterDisputedLands = new GOTAchievement(Category.ENTER, entId++, GOTItems.goldHelmet, "ENTER_DISPUTED_LANDS").setBiomeAchievement();
		enterDorne = new GOTAchievement(Category.ENTER, entId++, GOTItems.dorneHelmet, "ENTER_DORNE").setBiomeAchievement();
		enterDorneDesert = new GOTAchievement(Category.ENTER, entId++, Blocks.sand, "ENTER_DORNE_DESERT").setBiomeAchievement();
		enterDorneMesa = new GOTAchievement(Category.ENTER, entId++, Blocks.clay, "ENTER_DORNE_MESA").setBiomeAchievement();
		enterDorneMountains = new GOTAchievement(Category.ENTER, entId++, new ItemStack(GOTBlocks.rock, 1, 4), "ENTER_DORNE_MOUNTAINS").setBiomeAchievement();
		enterDothrakiSea = new GOTAchievement(Category.ENTER, entId++, GOTItems.nomadSword, "ENTER_DOTHRAKI_SEA").setBiomeAchievement();
		enterDragonstone = new GOTAchievement(Category.ENTER, entId++, GOTItems.obsidianShard, "ENTER_DRAGONSTONE").setBiomeAchievement();
		enterEssosMountains = new GOTAchievement(Category.ENTER, entId++, Blocks.stone, "ENTER_ESSOS_MOUNTAINS").setBiomeAchievement();
		enterFrostfangs = new GOTAchievement(Category.ENTER, entId++, Blocks.packed_ice, "ENTER_FROSTFANGS").setBiomeAchievement();
		enterGhiscar = new GOTAchievement(Category.ENTER, entId++, GOTItems.harpy, "ENTER_GHISCAR").setBiomeAchievement();
		enterGhiscarColony = new GOTAchievement(Category.ENTER, entId++, GOTItems.ghiscarHelmet, "ENTER_GHISCAR_COLONY").setBiomeAchievement();
		enterGiftNew = new GOTAchievement(Category.ENTER, entId++, Blocks.snow, "ENTER_GIFT_NEW").setBiomeAchievement();
		enterGiftOld = new GOTAchievement(Category.ENTER, entId++, GOTBlocks.brickIce, "ENTER_GIFT_OLD").setBiomeAchievement();
		enterHauntedForest = new GOTAchievement(Category.ENTER, entId++, GOTItems.club, "ENTER_HAUNTED_FOREST").setBiomeAchievement();
		enterIbben = new GOTAchievement(Category.ENTER, entId++, GOTItems.flintDagger, "ENTER_IBBEN").setBiomeAchievement();
		enterIfekevronForest = new GOTAchievement(Category.ENTER, entId++, GOTItems.flintSpear, "ENTER_IFEKEVRON_FOREST").setBiomeAchievement();
		enterIronIslands = new GOTAchievement(Category.ENTER, entId++, GOTItems.ironbornHelmet, "ENTER_IRON_ISLANDS").setBiomeAchievement();
		enterIsleOfFaces = new GOTAchievement(Category.ENTER, entId++, new ItemStack(GOTBlocks.leaves9, 1, 2), "ENTER_ISLE_OF_FACES").setBiomeAchievement();
		enterJogosNhai = new GOTAchievement(Category.ENTER, entId++, GOTItems.nomadBow, "ENTER_JOGOS_NHAI").setBiomeAchievement();
		enterJogosNhaiDesert = new GOTAchievement(Category.ENTER, entId++, GOTBlocks.quicksand, "ENTER_JOGOS_NHAI_DESERT").setBiomeAchievement();
		enterKingswood = new GOTAchievement(Category.ENTER, entId++, GOTItems.mugRedWine, "ENTER_KINGSWOOD").setBiomeAchievement();
		enterLhazar = new GOTAchievement(Category.ENTER, entId++, GOTItems.lhazarHelmet, "ENTER_LHAZAR").setBiomeAchievement();
		enterLongSummer = new GOTAchievement(Category.ENTER, entId++, Blocks.fire, "ENTER_LONG_SUMMER").setBiomeAchievement();
		enterLorath = new GOTAchievement(Category.ENTER, entId++, GOTItems.lorathHelmet, "ENTER_LORATH").setBiomeAchievement();
		enterLys = new GOTAchievement(Category.ENTER, entId++, GOTItems.lysHelmet, "ENTER_LYS").setBiomeAchievement();
		enterMossovy = new GOTAchievement(Category.ENTER, entId++, GOTItems.mossovySword, "ENTER_MOSSOVY").setBiomeAchievement();
		enterMossovyMarshes = new GOTAchievement(Category.ENTER, entId++, GOTBlocks.reeds, "ENTER_MOSSOVY_MARSHES").setBiomeAchievement();
		enterMossovyMountains = new GOTAchievement(Category.ENTER, entId++, Blocks.stone, "ENTER_MOSSOVY_MOUNTAINS").setBiomeAchievement();
		enterMyr = new GOTAchievement(Category.ENTER, entId++, GOTItems.myrHelmet, "ENTER_MYR").setBiomeAchievement();
		enterNeck = new GOTAchievement(Category.ENTER, entId++, GOTBlocks.quagmire, "ENTER_NECK").setBiomeAchievement();
		enterNorth = new GOTAchievement(Category.ENTER, entId++, GOTItems.northHelmet, "ENTER_NORTH").setBiomeAchievement();
		enterNorthBarrows = new GOTAchievement(Category.ENTER, entId++, GOTItems.coin, "ENTER_NORTH_BARROWS").setBiomeAchievement();
		enterNorthForestIrontree = new GOTAchievement(Category.ENTER, entId++, Items.iron_axe, "ENTER_NORTH_FOREST_IRONTREE").setBiomeAchievement();
		enterNorthMountains = new GOTAchievement(Category.ENTER, entId++, new ItemStack(GOTBlocks.rock, 1, 1), "ENTER_NORTH_MOUNTAINS").setBiomeAchievement();
		enterNorthTown = new GOTAchievement(Category.ENTER, entId++, GOTItems.northguardHelmet, "ENTER_NORTH_TOWN").setBiomeAchievement();
		enterNorthWild = new GOTAchievement(Category.ENTER, entId++, GOTItems.trident, "ENTER_NORTH_WILD").setBiomeAchievement();
		enterNorvos = new GOTAchievement(Category.ENTER, entId++, GOTItems.norvosHelmet, "ENTER_NORVOS").setBiomeAchievement();
		enterPentos = new GOTAchievement(Category.ENTER, entId++, GOTItems.pentosHelmet, "ENTER_PENTOS").setBiomeAchievement();
		enterQarth = new GOTAchievement(Category.ENTER, entId++, GOTItems.qarthHelmet, "ENTER_QARTH").setBiomeAchievement();
		...
		enterReachTown = new GOTAchievement(Category.ENTER, entId++, GOTItems.reachguardHelmet, "ENTER_REACH_TOWN").setBiomeAchievement();
		enterRiverlands = new GOTAchievement(Category.ENTER, entId++, GOTItems.riverlandsHelmet, "ENTER_RIVERLANDS").setBiomeAchievement();
		enterShadowLand = new GOTAchievement(Category.ENTER, entId++, GOTBlocks.asshaiFlower, "ENTER_SHADOW_LAND").setBiomeAchievement();
		enterShadowMountains = new GOTAchievement(Category.ENTER, entId++, new ItemStack(GOTBlocks.rock, 1, 0), "ENTER_SHADOW_MOUNTAINS").setBiomeAchievement();
		enterShrykesLand = new GOTAchievement(Category.ENTER, entId++, new ItemStack(GOTBlocks.deadMarshPlant), "ENTER_SHRYKES_LAND").setBiomeAchievement();
		enterSkagos = new GOTAchievement(Category.ENTER, entId++, GOTItems.trident, "ENTER_SKAGOS").setBiomeAchievement();
		enterSothoryosBushland = new GOTAchievement(Category.ENTER, entId++, GOTItems.termite, "ENTER_SOTHORYOS_BUSHLAND").setBiomeAchievement();
		enterSothoryosDesert = new GOTAchievement(Category.ENTER, entId++, Blocks.sand, "ENTER_SOTHORYOS_DESERT").setBiomeAchievement();
		...
		enterSothoryosSavannah = new GOTAchievement(Category.ENTER, entId++, Blocks.grass, "ENTER_SOTHORYOS_SAVANNAH").setBiomeAchievement();
		enterSothoryosTaiga = new GOTAchievement(Category.ENTER, entId++, GOTItems.club, "ENTER_SOTHORYOS_TAIGA").setBiomeAchievement();
		enterStepstones = new GOTAchievement(Category.ENTER, entId++, GOTItems.essosBow, "ENTER_STEPSTONES").setBiomeAchievement();
		enterStoneCoast = new GOTAchievement(Category.ENTER, entId++, GOTItems.westerosDaggerPoisoned, "ENTER_STONE_COAST").setBiomeAchievement();
		enterStormlands = new GOTAchievement(Category.ENTER, entId++, GOTItems.stormlandsHelmet, "ENTER_STORMLANDS").setBiomeAchievement();
		enterStormlandsTarth = new GOTAchievement(Category.ENTER, entId++, GOTBlocks.whiteSandstone, "ENTER_STORMLANDS_TARTH").setBiomeAchievement();
		enterSummerColony = new GOTAchievement(Category.ENTER, entId++, GOTItems.summerHelmet, "ENTER_SUMMER_COLONY").setBiomeAchievement();
		enterSummerIslands = new GOTAchievement(Category.ENTER, entId++, GOTItems.summerHelmet, "ENTER_SUMMER_ISLANDS").setBiomeAchievement();
		enterThennLand = new GOTAchievement(Category.ENTER, entId++, GOTItems.wildlingBattleaxe, "ENTER_THENN_LAND").setBiomeAchievement();
		enterTropicalForest = new GOTAchievement(Category.ENTER, entId++, GOTItems.yitiHelmetShogune, "ENTER_TROPICAL_FOREST").setBiomeAchievement();
		enterTyrosh = new GOTAchievement(Category.ENTER, entId++, GOTItems.tyroshHelmet, "ENTER_TYROSH").setBiomeAchievement();
		enterUlthos = new GOTAchievement(Category.ENTER, entId++, Blocks.web, "ENTER_ULTHOS").setBiomeAchievement();
		enterUlthosDesert = new GOTAchievement(Category.ENTER, entId++, Blocks.sand, "ENTER_ULTHOS_DESERT").setBiomeAchievement();
		enterUlthosDesertCold = new GOTAchievement(Category.ENTER, entId++, new ItemStack(Blocks.sand), "ENTER_ULTHOS_DESERT_COLD").setBiomeAchievement();
		enterUlthosForest = new GOTAchievement(Category.ENTER, entId++, new ItemStack(GOTBlocks.wood1, 1, 2), "ENTER_ULTHOS_FOREST").setBiomeAchievement();
		enterUlthosFrost = new GOTAchievement(Category.ENTER, entId++, new ItemStack(Blocks.snow), "ENTER_ULTHOS_FROST").setBiomeAchievement();
		enterUlthosMarshes = new GOTAchievement(Category.ENTER, entId++, new ItemStack(GOTBlocks.deadMarshPlant), "ENTER_ULTHOS_MARSHES").setBiomeAchievement();
		enterUlthosMountains = new GOTAchievement(Category.ENTER, entId++, new ItemStack(GOTBlocks.rock, 1, 3), "ENTER_ULTHOS_MOUNTAINS").setBiomeAchievement();
		enterUlthosRedForest = new GOTAchievement(Category.ENTER, entId++, new ItemStack(GOTBlocks.wood1), "ENTER_ULTHOS_RED_FOREST").setBiomeAchievement();
		enterUlthosTaiga = new GOTAchievement(Category.ENTER, entId++, new ItemStack(GOTBlocks.wood1, 1, 0), "ENTER_ULTHOS_TAIGA").setBiomeAchievement();
		enterValyria = new GOTAchievement(Category.ENTER, entId++, Blocks.vine, "ENTER_VALYRIA").setBiomeAchievement();
		enterValyriaVolcano = new GOTAchievement(Category.ENTER, entId++, Blocks.lava, "ENTER_VALYRIA_VOLCANO").setBiomeAchievement();
		enterVolantis = new GOTAchievement(Category.ENTER, entId++, GOTItems.volantisHelmet, "ENTER_VOLANTIS").setBiomeAchievement();
		enterVolantisOrangeForest = new GOTAchievement(Category.ENTER, entId++, GOTItems.orange, "ENTER_VOLANTIS_ORANGE_FOREST").setBiomeAchievement();
		enterWesterlands = new GOTAchievement(Category.ENTER, entId++, GOTItems.westerlandsHelmet, "ENTER_WESTERLANDS").setBiomeAchievement();
		enterWesterlandsTown = new GOTAchievement(Category.ENTER, entId++, GOTItems.westerlandsguardHelmet, "ENTER_WESTERLANDS_TOWN").setBiomeAchievement();
