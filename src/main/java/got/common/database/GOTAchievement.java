...
public class GOTAchievement {
	...
	public static void onInit() {
		...
		killThennBerserker = new GOTAchievement(Category.KILL, killId++, GOTItems.wildlingSword, "KILL_THENN_BERSERKER");
		...
		killAlliserThorne = createLegendaryAchievement(legId++, "KILL_ALLISER_THORNE").createTitle();
		killArdrianCeltigar = createLegendaryAchievement(legId++, "KILL_ARDRIAN_CELTIGAR").createTitle();
		...
		killBericDayne = createLegendaryAchievement(legId++, "KILL_BERIC_DAYNE");
		killBericDondarrion = createLegendaryAchievement(legId++, "KILL_BERIC_DONDARRION").createTitle();
		killBrienneTarth = createLegendaryAchievement(legId++, "KILL_BRIENNE_TARTH");
		killBryndenTully = createLegendaryAchievement(legId++, "KILL_BRYNDEN_TULLY").createTitle();
		killBuGai = createLegendaryAchievement(legId++, "KILL_BU_GAI").createTitle();
		killCerseiLannister = createLegendaryAchievement(legId++, "KILL_CERSEI_LANNISTER");
		killCraster = createLegendaryAchievement(legId++, "KILL_CRASTER").createTitle();
		killDaenerysTargaryen = createLegendaryAchievement(legId++, "KILL_DAENERYS_TARGARYEN").createTitle();
		...
		killEllaryaSand = createLegendaryAchievement(legId++, "KILL_ELLARYA_SAND").createTitle();
		...
		killGeroldDayne = createLegendaryAchievement(legId++, "KILL_GEROLD_DAYNE");
		...
		killJaqenHghar = createLegendaryAchievement(legId++, "KILL_JAQEN_HGHAR").createTitle();
		killJeorMormont = createLegendaryAchievement(legId++, "KILL_JEOR_MORMONT").createTitle();
		killJonSnow = createLegendaryAchievement(legId++, "KILL_JON_SNOW").createTitle();
		...
		killOberynMartell = createLegendaryAchievement(legId++, "KILL_OBERYN_MARTELL").createTitle();
		...
		killSandorClegane = createLegendaryAchievement(legId++, "KILL_SANDOR_CLEGANE").createTitle();
		killSansaStark = createLegendaryAchievement(legId++, "KILL_SANSA_STARK");
		killTheKing = createLegendaryAchievement(legId++, "KILL_THE_KING").createTitle();
		...
		killTugarKhan = createLegendaryAchievement(legId++, "KILL_TUGAR_KHAN").createTitle();
		killTyrion = createLegendaryAchievement(legId++, "KILL_TYRION");
		killTywin = createLegendaryAchievement(legId++, "KILL_TYWIN").createTitle();
