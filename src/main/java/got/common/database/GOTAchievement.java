...
public class GOTAchievement {
	...
	public static void onInit() {
		...
		enterArrynVale = new GOTAchievement(Category.VISIT, id++, GOTRegistry.arrynHelmet, "VISIT_ARRYN");
		enterMoonMountains = new GOTAchievement(Category.VISIT, id++, new ItemStack(GOTRegistry.rock, 1, 1), "VISIT_ARRYN_MOUNTAINS");
		...
		enterIsleOfFaces = new GOTAchievement(Category.VISIT, id++, new ItemStack(GOTRegistry.leaves9, 1, 2), "VISIT_FACES");
		...
		enterMoonMountainsFoothills = new GOTAchievement(Category.VISIT, id++, GOTRegistry.trident, "VISIT_HILL_TRIBES");
		enterIbben = new GOTAchievement(Category.VISIT, id++, GOTRegistry.flintDagger, "VISIT_IBBEN");
		enterIfekevronForest = new GOTAchievement(Category.VISIT, id++, GOTRegistry.flintSpear, "VISIT_IFEKEVRON");
		enterIronIslands = new GOTAchievement(Category.VISIT, id++, GOTRegistry.ironbornHelmet, "VISIT_IRONBORN");
		enterIrontreeForest = new GOTAchievement(Category.VISIT, id++, Items.iron_axe, "VISIT_IRONTREE");
		enterJogosNhai = new GOTAchievement(Category.VISIT, id++, GOTRegistry.nomadBow, "VISIT_JOGOS");
		enterJogosNhaiDesert = new GOTAchievement(Category.VISIT, id++, GOTRegistry.quicksand, "VISIT_JOGOS_DESERT");
		...
		enterSothoryosForest = new GOTAchievement(Category.VISIT, id++, GOTRegistry.sothoryosHelmetGold, "VISIT_SOTHORYOS_KANUKA");
