...
public class GOTSpawnList {
	...
	public static GOTSpawnList DOTHRAKI_CIVILIAN = new GOTSpawnList(new GOTSpawnEntry(GOTEntityDothraki.class, 10, 1, 2), new GOTSpawnEntry(GOTEntityDothrakiKhalin.class, 1, 1, 2));
	...
	public static GOTSpawnList GHISCAR_CORSAIR = new GOTSpawnList(new GOTSpawnEntry(GOTEntityGhiscarCorsair.class, 10, 1, 2));
	...
	public static GOTSpawnList YITI_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityYiTiLevyman.class, 10, 1, 2), new GOTSpawnEntry(GOTEntityYiTiSoldier.class, 10, 1, 2), new GOTSpawnEntry(GOTEntityYiTiSoldierCrossbower.class, 5, 1, 1), new GOTSpawnEntry(GOTEntityYiTiFireThrower.class, 2, 1, 1), new GOTSpawnEntry(GOTEntityYiTiBombardier.class, 2, 1, 1));
	public static GOTSpawnList YITI_SAMURAI = new GOTSpawnList(new GOTSpawnEntry(GOTEntityYiTiSamurai.class, 10, 1, 2));
	public static GOTSpawnList YITI_FRONTIER = new GOTSpawnList(new GOTSpawnEntry(GOTEntityYiTiFrontier.class, 10, 1, 2), new GOTSpawnEntry(GOTEntityYiTiFrontierCrossbower.class, 5, 1, 1));
