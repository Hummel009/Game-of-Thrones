...
public class GOTSpawnList {
	...
	public static GOTSpawnList BRAAVOS_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityBraavosLevyman.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityBraavosLevymanArcher.class, 5, 1, 3));
	...
	public static GOTSpawnList GHISCAR_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityGhiscarLevyman.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityGhiscarLevymanArcher.class, 5, 1, 3));
	...
	public static GOTSpawnList LORATH_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityLorathLevyman.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityLorathLevymanArcher.class, 5, 1, 3));
	public static GOTSpawnList LYS_CIVILIAN = new GOTSpawnList(new GOTSpawnEntry(GOTEntityLysMan.class, 10, 2, 4));
	public static GOTSpawnList LYS_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityLysLevyman.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityLysLevymanArcher.class, 5, 1, 3));
	...
	public static GOTSpawnList MYR_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityMyrLevyman.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityMyrLevymanArcher.class, 5, 1, 3));
	...
	public static GOTSpawnList NORVOS_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityNorvosLevyman.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityNorvosLevymanArcher.class, 5, 1, 3));
	public static GOTSpawnList PENTOS_CIVILIAN = new GOTSpawnList(new GOTSpawnEntry(GOTEntityPentosMan.class, 10, 2, 4));
	public static GOTSpawnList PENTOS_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityPentosLevyman.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityPentosLevymanArcher.class, 5, 1, 3));
	public static GOTSpawnList QARTH_CIVILIAN = new GOTSpawnList(new GOTSpawnEntry(GOTEntityQarthMan.class, 10, 2, 4));
	public static GOTSpawnList QARTH_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityQarthLevyman.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityQarthLevymanArcher.class, 5, 1, 3));
	public static GOTSpawnList QOHOR_CIVILIAN = new GOTSpawnList(new GOTSpawnEntry(GOTEntityQohorMan.class, 10, 2, 4));
	public static GOTSpawnList QOHOR_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityQohorUnsullied.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityQohorLevymanArcher.class, 5, 1, 3));
	...
	public static GOTSpawnList TYROSH_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityTyroshLevyman.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityTyroshLevymanArcher.class, 5, 1, 3));
	...
	public static GOTSpawnList VOLANTIS_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityVolantisLevyman.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityVolantisLevymanArcher.class, 5, 1, 3));
	...
	public static GOTSpawnList YITI_MILITARY = new GOTSpawnList(new GOTSpawnEntry(GOTEntityYiTiLevyman.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityYiTiSoldier.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityYiTiSoldierCrossbower.class, 5, 1, 1), new GOTSpawnEntry(GOTEntityYiTiFireThrower.class, 2, 1, 1), new GOTSpawnEntry(GOTEntityYiTiBombardier.class, 2, 1, 1));
	public static GOTSpawnList YITI_SAMURAI = new GOTSpawnList(new GOTSpawnEntry(GOTEntityYiTiSamurai.class, 10, 1, 3));
	public static GOTSpawnList YITI_FRONTIER = new GOTSpawnList(new GOTSpawnEntry(GOTEntityYiTiFrontier.class, 10, 1, 3), new GOTSpawnEntry(GOTEntityYiTiFrontierCrossbower.class, 5, 1, 1));
