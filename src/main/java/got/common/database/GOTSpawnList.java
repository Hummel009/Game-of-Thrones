...
public class GOTSpawnList {
	...
	private static final List<GOTSpawnEntry> ARRYN_GUARDIAN_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> ARRYN_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> ASSHAI_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> BRAAVOS_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> BRAAVOS_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> CROCODILE_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> CROWNLANDS_CIVILIAN_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> CROWNLANDS_GUARDIAN_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> CROWNLANDS_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> DESERT_SCORPION_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> DORNE_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> DORNE_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> DRAGONSTONE_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> DRAGONSTONE_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> GHISCAR_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> GHISCAR_HARPY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> GHISCAR_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> GHISCAR_UNSULLIED_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> GIFT_GUARDIAN_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> GOLDEN_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> HILL_TRIBES_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> IBBEN_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> IBBEN_MILITARY_L = new ArrayList<>();
	...
	private static final List<GOTSpawnEntry> LORATH_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> LORATH_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> LYS_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> LYS_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> MANTICORE_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> MOSSOVY_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> MOSSOVY_WEREWOLF_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> MYR_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> MYR_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> NORTH_CIVILIAN_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> NORTH_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> NORTH_GUARDIAN_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> NORTH_HILLMEN_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> NORTH_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> NORVOS_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> NORVOS_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> PENTOS_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> PENTOS_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> QARTH_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> QARTH_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> QOHOR_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> QOHOR_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> REACH_CIVILIAN_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> REACH_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> REACH_GUARDIAN_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> REACH_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> RED_SCORPION_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> RIVERLANDS_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> RIVERLANDS_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> SHRYKE_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> SOTHORYOS_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> STORMLANDS_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> STORMLANDS_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> SUMMER_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> TYROSH_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> TYROSH_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> ULTHOS_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> VALYRIA_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> VOLANTIS_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> VOLANTIS_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> WALKERS_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> WALKERS_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> WESTERLANDS_CIVILIAN_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> WESTERLANDS_CONQUEST_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> WESTERLANDS_GUARDIAN_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> WESTERLANDS_MILITARY_L = new ArrayList<>();
	private static final List<GOTSpawnEntry> WILDING_GIANT_L = new ArrayList<>();
	...
	static {
		...
		GHISCAR_CONQUEST_L.add(new GOTSpawnEntry(GOTEntityGhiscarSoldier.class, 10, 1, 2));
		GHISCAR_CONQUEST_L.add(new GOTSpawnEntry(GOTEntityGhiscarSoldierArcher.class, 5, 1, 2));
		...
		GOLDEN_MILITARY_L.add(new GOTSpawnEntry(GOTEntityGoldenCompanySpearman.class, 5, 1, 2));
		GOLDEN_MILITARY_L.add(new GOTSpawnEntry(GOTEntityGoldenCompanyWarrior.class, 10, 1, 2));
		...
		IBBEN_CONQUEST_L.add(new GOTSpawnEntry(GOTEntityIbbenSoldier.class, 10, 1, 2));
		IBBEN_CONQUEST_L.add(new GOTSpawnEntry(GOTEntityIbbenSoldierArcher.class, 5, 1, 2));
		IBBEN_MILITARY_L.add(new GOTSpawnEntry(GOTEntityIbbenLevyman.class, 10, 1, 2));
		IBBEN_MILITARY_L.add(new GOTSpawnEntry(GOTEntityIbbenLevymanArcher.class, 5, 1, 2));
		...
		LHAZAR_MILITARY_L.add(new GOTSpawnEntry(GOTEntityLhazarLevyman.class, 10, 1, 2));
		LHAZAR_MILITARY_L.add(new GOTSpawnEntry(GOTEntityLhazarLevymanArcher.class, 5, 1, 2));
		...
		MOSSOVY_WEREWOLF_L.add(new GOTSpawnEntry(GOTEntityWerewolf.class, 10, 1, 2));
		...
		NORVOS_CONQUEST_L.add(new GOTSpawnEntry(GOTEntityNorvosSoldier.class, 10, 1, 2));
		NORVOS_CONQUEST_L.add(new GOTSpawnEntry(GOTEntityNorvosSoldierArcher.class, 5, 1, 2));
		...
		PENTOS_CONQUEST_L.add(new GOTSpawnEntry(GOTEntityPentosSoldier.class, 10, 1, 2));
		PENTOS_CONQUEST_L.add(new GOTSpawnEntry(GOTEntityPentosSoldierArcher.class, 5, 1, 2));
		...
		QARTH_CONQUEST_L.add(new GOTSpawnEntry(GOTEntityQarthSoldier.class, 10, 1, 2));
		QARTH_CONQUEST_L.add(new GOTSpawnEntry(GOTEntityQarthSoldierArcher.class, 5, 1, 2));
		...
		QOHOR_CONQUEST_L.add(new GOTSpawnEntry(GOTEntityQohorSoldier.class, 10, 1, 2));
		QOHOR_CONQUEST_L.add(new GOTSpawnEntry(GOTEntityQohorSoldierArcher.class, 5, 1, 2));
		...
		SUMMER_MILITARY_L.add(new GOTSpawnEntry(GOTEntitySummerSoldierArcher.class, 5, 1, 2));
		SUMMER_MILITARY_L.add(new GOTSpawnEntry(GOTEntitySummerSoldier.class, 10, 1, 2));
		...
		WILDING_MILITARY_L.add(new GOTSpawnEntry(GOTEntityWildlingWarrior.class, 10, 1, 2));
		...
		IBBEN_CONQUEST = new GOTSpawnList(IBBEN_CONQUEST_L);
		...
		NORVOS_CONQUEST = new GOTSpawnList(NORVOS_CONQUEST_L);
		NORVOS_MILITARY = new GOTSpawnList(NORVOS_MILITARY_L);
		PENTOS_CONQUEST = new GOTSpawnList(PENTOS_CONQUEST_L);
		PENTOS_MILITARY = new GOTSpawnList(PENTOS_MILITARY_L);
		QARTH_CONQUEST = new GOTSpawnList(QARTH_CONQUEST_L);
		QARTH_MILITARY = new GOTSpawnList(QARTH_MILITARY_L);
		QOHOR_CONQUEST = new GOTSpawnList(QOHOR_CONQUEST_L);
