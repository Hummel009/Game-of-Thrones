...
public class GOTTradeEntries {
	...
	public static final GOTTradeEntries YI_TI_BLACKSMITH_BUY;
	public static final GOTTradeEntries YI_TI_MASON_BUY;

	public static final GOTTradeEntries EMPTY_SELL = new GOTTradeEntries(TradeType.WE_CAN_BUY, Collections.emptyList());
	public static final GOTTradeEntries EMPTY_BUY = new GOTTradeEntries(TradeType.WE_CAN_SELL, Collections.emptyList());
	...
	private static final List<GOTTradeEntry> YI_TI_MASON_B_L = new ArrayList<>();
	...
	private static final List<GOTTradeEntry> YI_TI_BLACKSMITH_B_L = new ArrayList<>();
	...
	static {
		...
		C_GOLDSMITH_S_L.add(new GOTTradeEntry(new ItemStack(GOTItems.diamond), DIAMOND, true));
		C_GOLDSMITH_S_L.add(new GOTTradeEntry(new ItemStack(GOTItems.emerald), EMERALD, true));
		C_GOLDSMITH_S_L.add(new GOTTradeEntry(new ItemStack(GOTItems.opal), OPAL, true));
		C_GOLDSMITH_S_L.add(new GOTTradeEntry(new ItemStack(GOTItems.ruby), RUBY, true));
		C_GOLDSMITH_S_L.add(new GOTTradeEntry(new ItemStack(GOTItems.sapphire), SAPPHIRE, true));
		C_GOLDSMITH_S_L.add(new GOTTradeEntry(new ItemStack(GOTItems.silverIngot), SILVER_INGOT, true));
		C_GOLDSMITH_S_L.add(new GOTTradeEntry(new ItemStack(GOTItems.topaz), TOPAZ, true));
		C_GOLDSMITH_S_L.add(new GOTTradeEntry(new ItemStack(GOTItems.valyrianIngot), VALYRIAN_INGOT, true));
		C_GOLDSMITH_S_L.add(new GOTTradeEntry(new ItemStack(Items.gold_ingot), GOLD_INGOT, true));

		C_MINER_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.amber), AMBER, true));
		C_MINER_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.amethyst), AMETHYST, true));
		C_MINER_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.diamond), DIAMOND, true));
		C_MINER_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.emerald), EMERALD, true));
		C_MINER_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.opal), OPAL, true));
		C_MINER_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.ruby), RUBY, true));
		C_MINER_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.sapphire), SAPPHIRE, true));
		C_MINER_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.silverIngot), SILVER_INGOT, true));
		C_MINER_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.topaz), TOPAZ, true));
		...
		C_FISHMONGER_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.pearl), 12));
		...
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(Blocks.iron_bars, 8), 20));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.blacksmithHammer), 18));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.bomb), 64));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.bronzeBars, 8), 20));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.bronzeCrossbow), 12));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.crossbowBolt, 4), 3));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.ironCrossbow), 15));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.tableYiTi), 100));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiBattleaxe), 18));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiBoots), 17));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiBootsBombardier), 19));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiBootsSamurai), 21));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiChestplate), 32));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiChestplateBombardier), 35));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiChestplateSamurai), 37));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiDagger), 9));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiHelmet), 20));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiHelmetBombardier), 22));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiHelmetSamurai), 24));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiHorseArmor), 37));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiLeggings), 26));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiLeggingsBombardier), 28));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiLeggingsSamurai), 30));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiPike), 16));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiPolearm), 16));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiSpear), 16));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.yiTiSword), 15));
		YI_TI_BLACKSMITH_B_L.add(new GOTTradeEntry(new ItemStack(GOTItems.firePot), 32));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(Blocks.cobblestone, 8), 1));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(Blocks.hardened_clay, 8), 4));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(Blocks.sandstone, 8), 4));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(Blocks.stone, 8), 2));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(Blocks.stonebrick, 1, 8), 2));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.brick5, 1, 12), 2));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.brick5, 1, 15), 2));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.brick5, 8, 11), 3));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.brick6, 1, 2), 8));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.brick6, 8, 1), 8));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.pillar2, 4, 8), 3));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.pillar2, 4, 9), 8));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.redSandstone, 8), 12));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.rock, 8, 4), 8));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.tableYiTi), 100));
		YI_TI_MASON_B_L.add(new GOTTradeEntry(new ItemStack(GOTBlocks.whiteSandstone, 8), 6));
		...
		SUMMER_BLACKSMITH_BUY = new GOTTradeEntries(GOTTradeEntries.TradeType.WE_CAN_BUY, SUMMER_BLACKSMITH_B_L).setVessels(GOTFoods.DEFAULT_DRINK);
		...
		YI_TI_BLACKSMITH_BUY = new GOTTradeEntries(GOTTradeEntries.TradeType.WE_CAN_BUY, YI_TI_BLACKSMITH_B_L);
		YI_TI_MASON_BUY = new GOTTradeEntries(GOTTradeEntries.TradeType.WE_CAN_BUY, YI_TI_MASON_B_L);
	}
