...
public class GOTTradeEntries {
	...
	static {
		...
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugAle), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugAraq), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugBananaBeer), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugBrandy), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugCactusLiqueur), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugCarrotWine), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugCherryLiqueur), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugCider), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugCornLiquor), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugGin), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugLemonLiqueur), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugLimeLiqueur), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugMapleBeer), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugMead), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugMelonLiqueur), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugPerry), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugPlumKvass), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugPomegranateWine), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugRedWine), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugRum), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugSambuca), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugSourMilk), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugVodka), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugWhisky), 12));
		brewerSells.add(new GOTTradeEntry(new ItemStack(GOTItems.mugWhiteWine), 12));
		...
		List<GOTTradeEntry> bartenderSells = new ArrayList<>(brewerSells);
