		...
		try {
			...
			if (mc.getSource().isFile()) {
				...
				while (entries.hasMoreElements()) {
					...
					String path = "assets/got/names/" + GOTConfig.getLanguageCode() + "/";
					if (!s.startsWith("assets/got/names/" + GOTConfig.getLanguageCode() + "/") || !s.endsWith(".txt")) {
						continue;
					}
				...
				File nameBankDir = new File(GOTRegistry.class.getResource("/assets/got/names/" + GOTConfig.getLanguageCode()).toURI());
