...
public class GOTFoods {
	...
	public static GOTFoods WESTEROS_DRINK = new GOTFoods(new ItemStack[]{new ItemStack(GOTItems.mugAle), new ItemStack(GOTItems.mugAle), new ItemStack(GOTItems.mugAle), new ItemStack(GOTItems.mugMead), new ItemStack(GOTItems.mugCider), new ItemStack(GOTItems.mugPerry), new ItemStack(GOTItems.mugAppleJuice)}).setDrinkVessels(GOTItemMug.Vessel.MUG, GOTItemMug.Vessel.MUG_CLAY, GOTItemMug.Vessel.GOBLET_GOLD, GOTItemMug.Vessel.GOBLET_SILVER, GOTItemMug.Vessel.GOBLET_COPPER, GOTItemMug.Vessel.GOBLET_WOOD, GOTItemMug.Vessel.BOTTLE, GOTItemMug.Vessel.HORN);
	public static GOTFoods WILD = new GOTFoods(new ItemStack[]{new ItemStack(Items.cooked_porkchop), new ItemStack(Items.cooked_fished), new ItemStack(Items.cooked_chicken), new ItemStack(Items.cooked_beef), new ItemStack(GOTItems.muttonCooked), new ItemStack(GOTItems.gammon), new ItemStack(Items.baked_potato), new ItemStack(Items.apple), new ItemStack(GOTItems.appleGreen), new ItemStack(GOTItems.pear), new ItemStack(Items.bread), new ItemStack(GOTItems.rabbitCooked), new ItemStack(GOTItems.chestnutRoast)});
	public static GOTFoods WILD_DRINK = new GOTFoods(new ItemStack[]{new ItemStack(GOTItems.mugAle), new ItemStack(GOTItems.mugAle), new ItemStack(GOTItems.mugMead), new ItemStack(GOTItems.mugCider), new ItemStack(GOTItems.mugRum)}).setDrinkVessels(GOTItemMug.Vessel.MUG, GOTItemMug.Vessel.GOBLET_WOOD, GOTItemMug.Vessel.SKULL, GOTItemMug.Vessel.SKIN, GOTItemMug.Vessel.HORN);
	public static GOTFoods YITI = new GOTFoods(new ItemStack[]{new ItemStack(Items.bread), new ItemStack(GOTItems.oliveBread), new ItemStack(Items.carrot), new ItemStack(GOTItems.lettuce), new ItemStack(GOTItems.turnip), new ItemStack(GOTItems.turnipCooked), new ItemStack(GOTItems.rabbitCooked), new ItemStack(GOTItems.deerCooked), new ItemStack(GOTItems.olive), new ItemStack(GOTItems.plum), new ItemStack(GOTItems.almond), new ItemStack(Items.cooked_fished), new ItemStack(Items.cooked_chicken), new ItemStack(Items.cooked_beef), new ItemStack(Items.cooked_porkchop), new ItemStack(GOTItems.grapeRed), new ItemStack(GOTItems.grapeWhite), new ItemStack(GOTItems.raisins), new ItemStack(GOTItems.date), new ItemStack(GOTItems.pomegranate)});
	...
	public static GOTFoods SOTHORYOS = new GOTFoods(new ItemStack[]{new ItemStack(Items.bread), new ItemStack(GOTItems.bananaBread), new ItemStack(GOTItems.cornBread), new ItemStack(GOTItems.corn), new ItemStack(GOTItems.cornCooked), new ItemStack(Items.baked_potato), new ItemStack(GOTItems.banana), new ItemStack(GOTItems.mango), new ItemStack(Items.melon), new ItemStack(GOTItems.melonSoup), new ItemStack(Items.cooked_fished)});
	public static GOTFoods SOTHORYOS_DRINK = new GOTFoods(new ItemStack[]{new ItemStack(GOTItems.mugChocolate), new ItemStack(GOTItems.mugMangoJuice), new ItemStack(GOTItems.mugBananaBeer), new ItemStack(GOTItems.mugMelonLiqueur), new ItemStack(GOTItems.mugCornLiquor)}).setDrinkVessels(GOTItemMug.Vessel.MUG, GOTItemMug.Vessel.GOBLET_GOLD, GOTItemMug.Vessel.GOBLET_WOOD);
	public static GOTFoods RICH_DRINK = new GOTFoods(new ItemStack[]{new ItemStack(GOTItems.mugRedWine)}).setDrinkVessels(GOTItemMug.Vessel.GOBLET_GOLD, GOTItemMug.Vessel.BOTTLE);
