...
public class GOTFoods {
	...
	public static final GOTFoods WESTEROS_DRINK = new GOTFoods(new ItemStack[]{new ItemStack(GOTItems.mugAle), new ItemStack(GOTItems.mugAle), new ItemStack(GOTItems.mugAle), new ItemStack(GOTItems.mugMead), new ItemStack(GOTItems.mugCider), new ItemStack(GOTItems.mugPerry), new ItemStack(GOTItems.mugAppleJuice)}).setDrinkVessels(GOTItemMug.Vessel.MUG, GOTItemMug.Vessel.MUG_CLAY, GOTItemMug.Vessel.GOBLET_COPPER, GOTItemMug.Vessel.GOBLET_WOOD, GOTItemMug.Vessel.BOTTLE, GOTItemMug.Vessel.HORN);
	...
	public static final GOTFoods SOTHORYOS_DRINK = new GOTFoods(new ItemStack[]{new ItemStack(GOTItems.mugChocolate), new ItemStack(GOTItems.mugMangoJuice), new ItemStack(GOTItems.mugBananaBeer), new ItemStack(GOTItems.mugMelonLiqueur), new ItemStack(GOTItems.mugCornLiquor)}).setDrinkVessels(GOTItemMug.Vessel.MUG, GOTItemMug.Vessel.GOBLET_COPPER, GOTItemMug.Vessel.GOBLET_WOOD);
	public static final GOTFoods RICH_DRINK = new GOTFoods(new ItemStack[]{new ItemStack(GOTItems.mugRedWine)}).setDrinkVessels(GOTItemMug.Vessel.GOBLET_COPPER, GOTItemMug.Vessel.BOTTLE);
