...
public class GOTUnitTradeEntries {
	...
	public static GOTUnitTradeEntries ARRYN;
	public static GOTUnitTradeEntries BRAAVOS;
	public static GOTUnitTradeEntries DORNE;
	public static GOTUnitTradeEntries DRAGONSTONE;
	public static GOTUnitTradeEntries GHISCAR;
	public static GOTUnitTradeEntries IRONBORN;
	public static GOTUnitTradeEntries LORATH;
	public static GOTUnitTradeEntries LYS;
	public static GOTUnitTradeEntries MYR;
	public static GOTUnitTradeEntries NORTH;
	public static GOTUnitTradeEntries NORVOS;
	public static GOTUnitTradeEntries PENTOS;
	public static GOTUnitTradeEntries QARTH;
	public static GOTUnitTradeEntries QOHOR;
	public static GOTUnitTradeEntries REACH;
	public static GOTUnitTradeEntries RIVERLANDS;
	public static GOTUnitTradeEntries STORMLANDS;
	public static GOTUnitTradeEntries TYROSH;
	public static GOTUnitTradeEntries VOLANTIS;
	public static GOTUnitTradeEntries WESTERLANDS;
	public static GOTUnitTradeEntries LHAZAR;
	public static GOTUnitTradeEntries YITI;
	public static GOTUnitTradeEntries KINGSGUARD;
	public static GOTUnitTradeEntries ASSHAI;
	public static GOTUnitTradeEntries CROWNLANDS;
	public static GOTUnitTradeEntries CROWNLANDS_GUARDIAN;
	public static GOTUnitTradeEntries GHISCAR_UNSULLIED;
	public static GOTUnitTradeEntries WILDLING;
	public static GOTUnitTradeEntries SUMMER;
	public static GOTUnitTradeEntries THENN;
	public static GOTUnitTradeEntries SOTHORYOS;
	public static GOTUnitTradeEntries NORTH_HILLMEN;
	public static GOTUnitTradeEntries GIFT;
	public static GOTUnitTradeEntries GOLDENCOMPANY;
	public static GOTUnitTradeEntries IBBEN;
	public static GOTUnitTradeEntries JOGOS;
	public static GOTUnitTradeEntries HILLMEN;
	public static GOTUnitTradeEntries DOTHRAKI;
	public static GOTUnitTradeEntries ARRYN_FARMER;
	public static GOTUnitTradeEntries CROWNLANDS_FARMER;
	public static GOTUnitTradeEntries DORNE_FARMER;
	public static GOTUnitTradeEntries DRAGONSTONE_FARMER;
	public static GOTUnitTradeEntries IBBEN_FARMER;
	public static GOTUnitTradeEntries IRONBORN_FARMER;
	public static GOTUnitTradeEntries NORTH_FARMER;
	public static GOTUnitTradeEntries REACH_FARMER;
	public static GOTUnitTradeEntries RIVERLANDS_FARMER;
	public static GOTUnitTradeEntries SOTHORYOS_FARMER;
	public static GOTUnitTradeEntries STORMLANDS_FARMER;
	public static GOTUnitTradeEntries SUMMER_FARMER;
	public static GOTUnitTradeEntries WESTERLANDS_FARMER;
	public static GOTUnitTradeEntries LORATH_FARMER;
	public static GOTUnitTradeEntries BRAAVOS_FARMER;
	public static GOTUnitTradeEntries NORVOS_FARMER;
	public static GOTUnitTradeEntries PENTOS_FARMER;
	public static GOTUnitTradeEntries QOHOR_FARMER;
	public static GOTUnitTradeEntries QARTH_FARMER;
	public static GOTUnitTradeEntries YITI_FARMER;
	public static GOTUnitTradeEntries GHISCAR_SLAVER;
	public static GOTUnitTradeEntries LYS_SLAVER;
	public static GOTUnitTradeEntries MYR_SLAVER;
	public static GOTUnitTradeEntries TYROSH_SLAVER;
	public static GOTUnitTradeEntries VOLANTIS_SLAVER;
	public static GOTUnitTradeEntries PROSTITUTE_KEEPER;
	...
	static {
		...
		YITI_L.add(new GOTUnitTradeEntry(GOTEntityYiTiSamurai.class, GOTEntityHorse.class, "Rider", SOLDIERH + 10, SOLDIERH_F + 10.0f).setMountArmor(GOTItems.yitiHorseArmor).setPledgeExclusive());
		YITI_L.add(new GOTUnitTradeEntry(GOTEntityYiTiBannerBearer.class, SOLDIER, SOLDIER_F));
		YITI_L.add(new GOTUnitTradeEntry(GOTEntityYiTiBannerBearer.class, GOTEntityHorse.class, "Rider", SOLDIERH, SOLDIERH_F).setMountArmor(GOTItems.yitiHorseArmor));
		...
		CROWNLANDS_L.add(new GOTUnitTradeEntry(GOTEntityCrownlandsBannerBearer.class, GOTEntityHorse.class, "Rider", SOLDIERH, SOLDIERH_F).setMountArmor(GOTItems.westerosHorseArmor));
		...
		CROWNLANDS_GUARDIAN = new GOTUnitTradeEntries(50.0f, CROWNLANDS_GUARDIAN_L);
