...
public class GOTMaterial {
	...
	public static final ItemArmor.ArmorMaterial VALYRIAN_CHAINMAIL = EnumHelper.addArmorMaterial("GOT_VALYRIAN_CHAINMAIL", 33, new int[]{3, 7, 5, 3}, 13);
	...
	public static void onInit() {
		...
		LHAZAR.customCraftingMaterial = Items.iron_ingot;
