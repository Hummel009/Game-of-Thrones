...
public class GOTRegistry {
	...
	public static void assignContent() {
		...
		alloySteelHalberd = new GOTItemBattleaxe(GOTMaterial.COBALT_TOOL);
		...
		valyrianPike = new GOTItemPolearmLong(GOTMaterial.VALYRIAN_TOOL);
	...
	public static void registerItems() {
		...
		registerItem(valyrianPike, "valyrianHalberd");
