...
public class GOTRegistry {
	...
	public static void assignContent() {
		...
		asshaiBattleaxe = new GOTItemBattleaxe(ToolMaterial.IRON);
		...
		asshaiDagger = new GOTItemDagger(ToolMaterial.IRON);
		asshaiDaggerPoisoned = new GOTItemDagger(ToolMaterial.IRON, GOTItemDagger.HitEffect.POISON);
		asshaiHammer = new GOTItemHammer(ToolMaterial.IRON);
		...
		asshaiSpear = new GOTItemSpear(ToolMaterial.IRON);
		asshaiStaff = new GOTItemAsshaiShadowbinderStaff();
		asshaiSword = new GOTItemSword(ToolMaterial.IRON);
