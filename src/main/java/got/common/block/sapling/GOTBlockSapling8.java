...
public class GOTBlockSapling8 extends GOTBlockSaplingBase {
	public GOTBlockSapling8() {
		setSaplingNames("plum", "redwood", "pomegranate", "palm");
	}
	...
	public void growTree(World world, int i, int j, int k, Random random) {
		...
		if (meta == 1) {
			...
			if (treeGen == null && (tree4x4 = GOTBlockSaplingBase.findSaplingSquare(world, i, j, k, this, meta, -1, 2, -2, 1)) != null) {
			...
			if (treeGen == null && (tree3x3 = GOTBlockSaplingBase.findPartyTree(world, i, j, k, this, meta)) != null) {
