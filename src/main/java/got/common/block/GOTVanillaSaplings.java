	...
	public static void growTree(World world, int i, int j, int k, Random random) {
		...
		if (meta == 1) {
			for (int i12 = 0; i12 >= -1; --i12) {
				for (k1 = 0; k1 >= -1; --k1) {
					if (!GOTVanillaSaplings.isSameSapling(world, i + i12, j, k + k1, meta) || !GOTVanillaSaplings.isSameSapling(world, i + i12 + 1, j, k + k1, meta) || !GOTVanillaSaplings.isSameSapling(world, i + i12, j, k + k1 + 1, meta) || !GOTVanillaSaplings.isSameSapling(world, i + i12 + 1, j, k + k1 + 1, meta)) {
						continue;
					}
		...
		if (meta == 3) {
			for (int i13 = 0; i13 >= -1; --i13) {
				for (k1 = 0; k1 >= -1; --k1) {
					if (!GOTVanillaSaplings.isSameSapling(world, i + i13, j, k + k1, meta) || !GOTVanillaSaplings.isSameSapling(world, i + i13 + 1, j, k + k1, meta) || !GOTVanillaSaplings.isSameSapling(world, i + i13, j, k + k1 + 1, meta) || !GOTVanillaSaplings.isSameSapling(world, i + i13 + 1, j, k + k1 + 1, meta)) {
						continue;
					}
			...
			if (treeGen == null) {
				for (int i14 = 0; i14 >= -1; --i14) {
					for (int k12 = 0; k12 >= -1; --k12) {
						if (!GOTVanillaSaplings.isSameSapling(world, i + i14, j, k + k12, meta) || !GOTVanillaSaplings.isSameSapling(world, i + i14 + 1, j, k + k12, meta) || !GOTVanillaSaplings.isSameSapling(world, i + i14, j, k + k12 + 1, meta) || !GOTVanillaSaplings.isSameSapling(world, i + i14 + 1, j, k + k12 + 1, meta)) {
							continue;
						}
