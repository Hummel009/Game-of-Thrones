...
public enum GOTTreeType {
	...
	}), OAK_TALLER((flag, rand) -> new GOTWorldGenSimpleTrees(flag, 12, 16, Blocks.log, 0, Blocks.leaves, 0)), OAK_LARGE((flag, rand) -> new GOTWorldGenBigTrees(flag, Blocks.log, 0, Blocks.leaves)), OAK_PARTY((flag, rand) -> new GOTWorldGenPartyTrees(Blocks.log, 0, Blocks.leaves, 0)), OAK_GIANT((flag, rand) -> new GOTWorldGenGiantTrees(flag, Blocks.log, 0, Blocks.leaves, 0)), WEIRWOOD((flag, rand) -> new GOTWorldGenPartyTrees(GOTBlocks.wood9, 2, GOTBlocks.leaves9, 2)), OAK_SWAMP((flag, rand) -> new WorldGenSwamp()), OAK_DEAD((flag, rand) -> new GOTWorldGenDeadTrees(Blocks.log, 0)), OAK_DESERT((flag, rand) -> new GOTWorldGenDesertTrees(flag, Blocks.log, 0, Blocks.leaves, 0)), BIRCH((flag, rand) -> {
		if (rand.nextInt(3) != 0) {
	...
	public static class WeightedTreeType extends WeightedRandom.Item {
		private final GOTTreeType treeType;
		...
		public GOTTreeType getTreeType() {
			return treeType;
		}
	}
}