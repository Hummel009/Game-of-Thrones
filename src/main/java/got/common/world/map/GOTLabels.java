...
public enum GOTLabels {
	WESTEROS("westeros", 650, 1350, 30.0f, 67, -6.0f, -1.0f), ESSOS("essos", 2200, 1650, 50.0f, -10, -6.0f, -1.0f), SOTHORYOS("sothoryos", 2400, 3600, 40.0f, 60, -6.0f, -1.0f), ULTHOS("ulthos", 4900, 3000, 50.0f, 10, -6.0f, -1.0f), IBBEN("ibben", 2700, 1000, 15.0f, 0, -6.0f, -1.0f), LANG("lang", 3550, 2500, 15.0f, 67, -6.0f, 1.0f), NARROW("narrow", 1050, 1600, 9.0f, 70, -6.0f, 2.0f), JADE("jade", 3050, 3000, 10.0f, 0, -6.0f, -1.0f), SUMMER("summer", 2150, 2530, 15.0f, -10, -6.0f, -1.0f), SUNSET("sunset", 100, 1500, 15.0f, -70, -6.0f, -1.0f), SHIVERING("shivering", 2250, 500, 40.0f, 0, -6.0f, -1.0f);
