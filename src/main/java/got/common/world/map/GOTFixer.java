...
public class GOTFixer {
	...
	public static void addWaypointLocations(GOTBiome biome) {
		...
		registerLocation(new GOTStructureDothrakiSettlement(biome, 0.0f).type(GOTStructureDothrakiSettlement.Type.BIG, 5), GOTWaypoint.Hornoth.info(0.5, 0), GOTWaypoint.Kyth.info(0.3, -0.4), GOTWaypoint.Sathar.info(0.5, 0), GOTWaypoint.Rathylar.info(0.6, -0.1), GOTWaypoint.Saath.info(0, -0.5), GOTWaypoint.VaesAthjikhari.info(0, -0.5), GOTWaypoint.VaesDiaf, GOTWaypoint.VaesDothrak, GOTWaypoint.VaesEfe, GOTWaypoint.VaesGorqoyi.info(0.3, -0.4), GOTWaypoint.VaesGraddakh, GOTWaypoint.VaesJini.info(0, 0.5), GOTWaypoint.VojjorSamvi.info(0, -0.5), GOTWaypoint.VaesKhadokh.info(-0.1, -0.5), GOTWaypoint.VaesKhewo.info(0, -0.5), GOTWaypoint.VaesLeqse.info(0.5, 0), GOTWaypoint.VaesMejhah.info(0, -0.5), GOTWaypoint.KrazaajHas.info(0, -0.6));
		...
		registerLocation(new GOTStructureLhazarSettlement(biome, 0.0f).type(GOTStructureLhazarSettlement.Type.TOWN, 6), GOTWaypoint.Hesh.info(1.2, 0, 3), GOTWaypoint.Kosrak.info(1, 0, 3), GOTWaypoint.Lhazosh.info(1, 0, 3));
