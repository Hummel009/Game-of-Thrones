...
public class GOTFixer {
	...
	public static void addWaypointLocations(GOTBiome biome) {
		...
		registerLocation(new GOTStructureAsshaiSettlement(biome, 0.0f), GOTWaypoint.Asshai.info(0, 0.8, Dir.SOUTH));
		registerLocation(new GOTStructureBraavosSettlement(biome, 0.0f).type(GOTStructureBraavosSettlement.Type.TOWN, 6), GOTWaypoint.Braavos.info(essosGateShift, -0.5, Dir.SOUTH));
		registerLocation(new GOTStructureCrownlandsSettlement(biome, 0.0f).type(GOTStructureCrownlandsSettlement.Type.FORT, 3), GOTWaypoint.Antlers.info(0, -0.5), GOTWaypoint.Brownhollow, GOTWaypoint.DyreDen, GOTWaypoint.Stokeworth.info(-0.5, 0, Dir.WEST), GOTWaypoint.Hayford.info(0, -0.5), GOTWaypoint.RooksRest.info(0, -0.5), GOTWaypoint.Rosby.info(-0.55, 0, Dir.WEST));
		registerLocation(new GOTStructureCrownlandsSettlement(biome, 0.0f).type(GOTStructureCrownlandsSettlement.Type.KINGS_LANDING, 6), GOTWaypoint.KingsLanding.info(0.9, 0, Dir.EAST));
		registerLocation(new GOTStructureCrownlandsSettlement(biome, 0.0f).type(GOTStructureCrownlandsSettlement.Type.RED_KEEP, 3), GOTWaypoint.KingsLanding.info(2, 0, Dir.EAST));
		...
		registerLocation(new GOTStructureGhiscarSettlement(biome, 0.0f).type(GOTStructureGhiscarSettlement.Type.COLONY, 4), GOTWaypoint.IsleOfWhips, GOTWaypoint.BarterBeach, GOTWaypoint.Gogossos, GOTWaypoint.Gorosh, GOTWaypoint.Zamettar.info(0, -0.5, Dir.SOUTH));
		...
		registerLocation(new GOTStructureGhiscarSettlement(biome, 0.0f).type(GOTStructureGhiscarSettlement.Type.TOWN, 6), GOTWaypoint.Meereen.info(essosGateShift, -0.5, Dir.SOUTH), GOTWaypoint.Astapor.info(-0.5, -essosGateShift, Dir.EAST), GOTWaypoint.NewGhis, GOTWaypoint.Yunkai.info(-0.5, -essosGateShift, Dir.EAST));
		...
		registerLocation(new GOTStructureLhazarSettlement(biome, 0.0f).type(GOTStructureLhazarSettlement.Type.TOWN, 6), GOTWaypoint.Hesh.info(1.2, 0, Dir.WEST), GOTWaypoint.Kosrak.info(1, 0, Dir.WEST), GOTWaypoint.Lhazosh.info(1, 0, Dir.WEST));
		...
		registerLocation(new GOTStructureMyrSettlement(biome, 0.0f).type(GOTStructureMyrSettlement.Type.TOWN, 6), GOTWaypoint.Myr.info(-0.5, -essosGateShift, Dir.EAST));
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).type(GOTStructureNorthSettlement.Type.FORT, 3), GOTWaypoint.CatfishRock, GOTWaypoint.BreakstoneHill, GOTWaypoint.Goldgrass.info(0, 0.5, Dir.SOUTH), GOTWaypoint.RyswellsCastle.info(-0.5, 0, Dir.WEST), GOTWaypoint.ServinsCastle.info(-0.5, 0, Dir.WEST), GOTWaypoint.Winterfell.info(-0.5, 0, Dir.WEST), GOTWaypoint.BlackPool, GOTWaypoint.DeepwoodMotte, GOTWaypoint.Dreadfort.info(0, -0.5), GOTWaypoint.FlintsFinger, GOTWaypoint.Highpoint, GOTWaypoint.TorhensSquare.info(-0.5, 0, Dir.WEST), GOTWaypoint.WidowsWatch, GOTWaypoint.Hornwood, GOTWaypoint.Ironrath, GOTWaypoint.Karhold.info(0.5, 0, Dir.EAST), GOTWaypoint.LastHearth, GOTWaypoint.MoatKailin, GOTWaypoint.MormontsKeep, GOTWaypoint.OldCastle, GOTWaypoint.RamsGate, GOTWaypoint.RillwaterCrossing.info(-0.5, 0, Dir.WEST));
		...
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).type(GOTStructureNorthSettlement.Type.TOWN, 6), GOTWaypoint.WhiteHarbour.info(0.9, 0, Dir.EAST));
		...
		registerLocation(new GOTStructureNorvosSettlement(biome, 0.0f).type(GOTStructureNorvosSettlement.Type.TOWN, 6), GOTWaypoint.Norvos.info(essosGateShift, -0.5, Dir.SOUTH));
		registerLocation(new GOTStructurePentosSettlement(biome, 0.0f).type(GOTStructurePentosSettlement.Type.TOWN, 6), GOTWaypoint.Pentos.info(-0.5, -essosGateShift, Dir.EAST));
		...
		registerLocation(new GOTStructureQohorSettlement(biome, 0.0f).type(GOTStructureQohorSettlement.Type.TOWN, 6), GOTWaypoint.Qohor.info(-0.6, -essosGateShift, Dir.EAST));
		registerLocation(new GOTStructureReachSettlement(biome, 0.0f).type(GOTStructureReachSettlement.Type.FORT, 3), GOTWaypoint.Appleton.info(0, -0.51), GOTWaypoint.Ashford, GOTWaypoint.Bandallon, GOTWaypoint.Goldengrove, GOTWaypoint.GrassyVale, GOTWaypoint.Greenshield, GOTWaypoint.Grimston, GOTWaypoint.Hammerhal.info(0.5, 0, Dir.EAST), GOTWaypoint.RedLake.info(0, 0.5, Dir.SOUTH), GOTWaypoint.Ring.info(0, -0.5), GOTWaypoint.Southshield, GOTWaypoint.Uplands, GOTWaypoint.Holyhall.info(0.5, 0, Dir.EAST), GOTWaypoint.Honeyholt, GOTWaypoint.HornHill, GOTWaypoint.IvyHall.info(0, 0.5, Dir.SOUTH), GOTWaypoint.Longtable, GOTWaypoint.NewBarrel, GOTWaypoint.Blackcrown, GOTWaypoint.BrightwaterKeep, GOTWaypoint.CiderHall, GOTWaypoint.Coldmoat.info(0, 0.5, Dir.SOUTH), GOTWaypoint.DarkDell.info(-0.5, 0, Dir.WEST), GOTWaypoint.Dunstonbury, GOTWaypoint.Bitterbridge.info(0, 0.5, Dir.SOUTH), GOTWaypoint.GarnetGrove.info(-0.5, 0, Dir.WEST), GOTWaypoint.HewettTown, GOTWaypoint.OldOak.info(0, 0.5, Dir.SOUTH), GOTWaypoint.SunHouse.info(0, 0.5, Dir.SOUTH), GOTWaypoint.Whitegrove.info(-0.5, 0, Dir.WEST));
		registerLocation(new GOTStructureReachSettlement(biome, 0.0f).type(GOTStructureReachSettlement.Type.HIGHGARDEN, 3), GOTWaypoint.Highgarden.info(0.5, 0, Dir.EAST));
		registerLocation(new GOTStructureReachSettlement(biome, 0.0f).type(GOTStructureReachSettlement.Type.TOWN, 6), GOTWaypoint.Oldtown.info(-1.1, 0, Dir.WEST), GOTWaypoint.Appleton.info(0.1, 1.1, Dir.SOUTH), GOTWaypoint.Ashford, GOTWaypoint.HewettTown, GOTWaypoint.Smithyton.info(0, 0.9, Dir.SOUTH), GOTWaypoint.StarfishHarbor, GOTWaypoint.Vinetown, GOTWaypoint.Ryamsport, GOTWaypoint.Tumbleton.info(0, -1.0));
		registerLocation(new GOTStructureRiverlandsSettlement(biome, 0.0f).type(GOTStructureRiverlandsSettlement.Type.CROSSROADS, 2), GOTWaypoint.CrossroadsInn);
		...
		registerLocation(new GOTStructureTower(biome, 0.0f), GOTWaypoint.ThreeTowers.info(-0.5, -0.5, Dir.WEST), GOTWaypoint.ThreeTowers.info(-0.5, 0, Dir.WEST), GOTWaypoint.ThreeTowers.info(-0.5, 0.5, Dir.WEST), GOTWaypoint.TowerOfGlimmering, GOTWaypoint.BaelishKeep, GOTWaypoint.HightowerLitehouse, GOTWaypoint.RamseyTower, GOTWaypoint.Standfast, GOTWaypoint.TwinsLeft, GOTWaypoint.TwinsRight);
		...
		registerLocation(new GOTStructureWesterlandsSettlement(biome, 0.0f).type(GOTStructureWesterlandsSettlement.Type.FORT, 3), GOTWaypoint.Crakehall.info(-0.5, 0, Dir.WEST), GOTWaypoint.GoldenTooth.info(0, -0.52), GOTWaypoint.Kayce, GOTWaypoint.Sarsfield.info(0, -0.5), GOTWaypoint.Silverhill, GOTWaypoint.Wyndhall, GOTWaypoint.Plumwood, GOTWaypoint.Riverspring, GOTWaypoint.Greenfield, GOTWaypoint.Hornvale, GOTWaypoint.DeepDen, GOTWaypoint.Faircastle, GOTWaypoint.Feastfires, GOTWaypoint.CleganesKeep, GOTWaypoint.Cornfield, GOTWaypoint.Crag, GOTWaypoint.Ashemark, GOTWaypoint.Banefort);
		registerLocation(new GOTStructureWesterlandsSettlement(biome, 0.0f).type(GOTStructureWesterlandsSettlement.Type.CASTERLY_ROCK, 3), GOTWaypoint.CasterlyRock.info(-0.5, 0, Dir.WEST));
		registerLocation(new GOTStructureWesterlandsSettlement(biome, 0.0f).type(GOTStructureWesterlandsSettlement.Type.TOWN, 6), GOTWaypoint.Kayce, GOTWaypoint.Lannisport.info(-0.9, 0, Dir.WEST));
		registerLocation(new GOTStructureWesterlandsSettlement(biome, 0.0f).type(GOTStructureWesterlandsSettlement.Type.VILLAGE, 6), GOTWaypoint.Oxcross.info(0.2, 0.6));
