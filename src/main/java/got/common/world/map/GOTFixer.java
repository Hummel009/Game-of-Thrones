...
public class GOTFixer {
	...
	public static void addWaypointLocations(GOTBiome biome) {
		...
		registerLocation(new GOTStructureYiTiSettlement(biome, 0.0f).type(GOTStructureYiTiSettlement.Type.TOWN, 7), GOTWaypoint.Asabhad.info(-1, 0), GOTWaypoint.Baoji.info(0, -1), GOTWaypoint.Eijiang.info(0, 1), GOTWaypoint.Jinqi.info(-1, 0), GOTWaypoint.Lizhao.info(1, 0), GOTWaypoint.Manjin.info(1.1, -0.2, 1), GOTWaypoint.SiQo.info(1, 0), GOTWaypoint.Tiqui.info(0, -1), GOTWaypoint.TraderTown.info(0, -1), GOTWaypoint.Vaibei.info(0, -1), GOTWaypoint.Yibin.info(0, -1), GOTWaypoint.Yin.info(0, 1), GOTWaypoint.Yunnan.info(1, 0), GOTWaypoint.Changan.info(1, 0), GOTWaypoint.FuNing.info(1.1, 0.1, 1), GOTWaypoint.Zabhad, GOTWaypoint.Turrani, GOTWaypoint.Vahar, GOTWaypoint.Faros, GOTWaypoint.Huiji, GOTWaypoint.LengMa, GOTWaypoint.LengYi, GOTWaypoint.LesserMoraq, GOTWaypoint.Marahai, GOTWaypoint.PortMoraq);
