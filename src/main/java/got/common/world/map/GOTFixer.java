...
public class GOTFixer {
	...
	public static void addWaypointLocations(GOTBiome biome) {
		...
		registerLocation(new GOTStructureDothrakiSettlement(biome, 0.0f).setIsBig(), GOTWaypoint.Hornoth.info(0.5, 0, 0), GOTWaypoint.Kyth.info(0.5, 0, 0), GOTWaypoint.Sathar.info(0.5, 0, 0), GOTWaypoint.Rathylar.info(0, -0.5, 0), GOTWaypoint.VaesAthjikhari.info(0, -0.5, 0), GOTWaypoint.VaesDiaf, GOTWaypoint.VaesDothrak, GOTWaypoint.VaesEfe, GOTWaypoint.VaesGorqoyi.info(0, -0.5, 0), GOTWaypoint.VaesGraddakh, GOTWaypoint.VaesJini.info(0, -0.5, 0), GOTWaypoint.VaesKhadokh.info(0, -0.5, 0), GOTWaypoint.VaesKhewo.info(0, -0.5, 0), GOTWaypoint.VaesLeqse.info(0.5, 0, 0), GOTWaypoint.VaesMejhah.info(0, -0.5, 0));
		...
		registerLocation(new GOTStructureGiftSettlement(biome, 0.0f).setIsCastleBlack(), GOTWaypoint.CastleBlack.info(0, 0, 0));
		...
		registerLocation(new GOTStructureLhazarSettlement(biome, 0.0f).setIsTown(), GOTWaypoint.Hesh.info(1, 0, 3), GOTWaypoint.Kosrak.info(1, 0, 1), GOTWaypoint.Lhazosh.info(-1, 0, 1));
		...
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).setIsCastle(), GOTWaypoint.CatfishRock.info(0, 0, 0), GOTWaypoint.BreakstoneHill, GOTWaypoint.Goldgrass.info(0, 0.5), GOTWaypoint.RisvellsCastle.info(0, 0.5), GOTWaypoint.ServinsCastle.info(-0.5, 0, 0), GOTWaypoint.Winterfell.info(0, 0, 1), GOTWaypoint.BlackPool.info(0, 0.5), GOTWaypoint.DeepwoodMotte, GOTWaypoint.Dreadfort.info(0, 0.5), GOTWaypoint.FlintsFinger, GOTWaypoint.Highpoint, GOTWaypoint.TorhensSquare.info(-0.5, 0), GOTWaypoint.WidowsWatch, GOTWaypoint.Hornwood, GOTWaypoint.Ironrath, GOTWaypoint.Karhold.info(0.5, 0), GOTWaypoint.LastHearth, GOTWaypoint.MoatKailin, GOTWaypoint.MormontsKeep, GOTWaypoint.OldCastle, GOTWaypoint.RamsGate.info(0.5, 0), GOTWaypoint.RillwaterCrossing.info(0, -0.5));
		...
		registerLocation(new GOTStructureTower(biome, 0.0f), GOTWaypoint.ThreeTowers1.info(0, 0, 1), GOTWaypoint.ThreeTowers2.info(0, 0, 1), GOTWaypoint.ThreeTowers3.info(0, 0, 1), GOTWaypoint.TowerOfGlimmering, GOTWaypoint.BaelishKeep, GOTWaypoint.HightowerLitehouse, GOTWaypoint.RamseyTower, GOTWaypoint.Standfast, GOTWaypoint.TwinsLeft.info(0, 0, 2), GOTWaypoint.TwinsRight);
