...
public class GOTFixer {
	...
	public static void addWaypointLocations(GOTBiome biome) {
		locations.clear();
		registerLocation(new GOTStructureArrynSettlement(biome, 0.0f).type(GOTStructureArrynSettlement.Type.FORT, 3, 3), GOTWaypoint.BloodyGate.info(0, -0.5), GOTWaypoint.TheEyrie.info(0, -0.5), GOTWaypoint.ColdwaterBurn, GOTWaypoint.GreyGlen, GOTWaypoint.HeartsHome, GOTWaypoint.IronOak, GOTWaypoint.LongbowHall, GOTWaypoint.Ninestars, GOTWaypoint.OldAnchor, GOTWaypoint.Pebble, GOTWaypoint.Redfort, GOTWaypoint.Runestone, GOTWaypoint.Snakewood, GOTWaypoint.Strongsong, GOTWaypoint.ThePaps, GOTWaypoint.Wickenden, GOTWaypoint.WitchIsle, GOTWaypoint.GateOfTheMoon.info(0.5, 0, 1));
		registerLocation(new GOTStructureArrynSettlement(biome, 0.0f).type(GOTStructureArrynSettlement.Type.TOWN, 6, 6), GOTWaypoint.Gulltown, GOTWaypoint.Sisterton);
		...
		registerLocation(new GOTStructureDothrakiSettlement(biome, 0.0f).setIsBig(), GOTWaypoint.Hornoth.info(0.5, 0), GOTWaypoint.Kyth.info(0.3, -0.4), GOTWaypoint.Sathar.info(0.5, 0), GOTWaypoint.Rathylar.info(0.6, -0.1), GOTWaypoint.Saath.info(0, -0.5), GOTWaypoint.VaesAthjikhari.info(0, -0.5), GOTWaypoint.VaesDiaf, GOTWaypoint.VaesDothrak, GOTWaypoint.VaesEfe, GOTWaypoint.VaesGorqoyi.info(0.3, -0.4), GOTWaypoint.VaesGraddakh, GOTWaypoint.VaesJini.info(0, 0.5), GOTWaypoint.VojjorSamvi.info(0, -0.5), GOTWaypoint.VaesKhadokh.info(-0.1, -0.5), GOTWaypoint.VaesKhewo.info(0, -0.5), GOTWaypoint.VaesLeqse.info(0.5, 0), GOTWaypoint.VaesMejhah.info(0, -0.5), GOTWaypoint.KrazaajHas.info(0, -0.5));
		...
		registerLocation(new GOTStructureIronbornSettlement(biome, 0.0f).setIsVillage(), GOTWaypoint.Pebbleton);
		...
		registerLocation(new GOTStructureLhazarSettlement(biome, 0.0f).setIsTown(), GOTWaypoint.Hesh.info(1.2, 0, 3), GOTWaypoint.Kosrak.info(1, 0, 3), GOTWaypoint.Lhazosh.info(1, 0, 3));
		...
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).type(GOTStructureNorthSettlement.Type.VILLAGE, 6, 6), GOTWaypoint.GreywaterWatch);
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).type(GOTStructureNorthSettlement.Type.FORT, 3, 3), GOTWaypoint.CatfishRock, GOTWaypoint.BreakstoneHill, GOTWaypoint.Goldgrass.info(0, 0.5, 2), GOTWaypoint.RisvellsCastle.info(-0.5, 0, 3), GOTWaypoint.ServinsCastle.info(-0.5, 0, 3), GOTWaypoint.Winterfell.info(-0.5, 0, 3), GOTWaypoint.BlackPool, GOTWaypoint.DeepwoodMotte, GOTWaypoint.Dreadfort.info(0, -0.5), GOTWaypoint.FlintsFinger, GOTWaypoint.Highpoint, GOTWaypoint.TorhensSquare.info(0, -0.5), GOTWaypoint.WidowsWatch, GOTWaypoint.Hornwood, GOTWaypoint.Ironrath, GOTWaypoint.Karhold.info(0.5, 0, 1), GOTWaypoint.LastHearth, GOTWaypoint.MoatKailin, GOTWaypoint.MormontsKeep, GOTWaypoint.OldCastle, GOTWaypoint.RamsGate, GOTWaypoint.RillwaterCrossing.info(-0.5, 0, 3));
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).type(GOTStructureNorthSettlement.Type.HILLMAN, 6, 6), GOTWaypoint.Skane, GOTWaypoint.Deepdown, GOTWaypoint.DriftwoodHall, GOTWaypoint.Kingshouse);
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).type(GOTStructureNorthSettlement.Type.SMALL_TOWN, 6, 6), GOTWaypoint.Barrowtown);
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).type(GOTStructureNorthSettlement.Type.TOWN, 6, 6), GOTWaypoint.WhiteHarbour.info(0.9, 0, 1));
		...
		registerLocation(new GOTStructureRiverlandsSettlement(biome, 0.0f).setIsVillage(), GOTWaypoint.FairMarket, GOTWaypoint.Pennytree, GOTWaypoint.Sevenstreams);
