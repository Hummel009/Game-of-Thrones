...
public class GOTFixer {
	...
	public static void addWaypointLocations(GOTBiome biome) {
		...
		registerLocation(new GOTStructureCrownlandsSettlement(biome, 0.0f).type(GOTStructureCrownlandsSettlement.Type.FORT, 3), GOTWaypoint.Antlers.info(0, -0.5), GOTWaypoint.Brownhollow, GOTWaypoint.DyreDen, GOTWaypoint.Stokeworth.info(-0.5, 0, 3), GOTWaypoint.Hayford.info(0, -0.5), GOTWaypoint.RooksRest.info(0, -0.5), GOTWaypoint.Rosby.info(-0.55, 0, 3));
		...
		registerLocation(new GOTStructureCrownlandsSettlement(biome, 0.0f).type(GOTStructureCrownlandsSettlement.Type.TOWN, 6), GOTWaypoint.Duskendale.info(-0.1, -1.1));
		...
		registerLocation(new GOTStructureDorneSettlement(biome, 0.0f).type(GOTStructureDorneSettlement.Type.FORT, 3), GOTWaypoint.Blackmont.info(0.5, 0, 1), GOTWaypoint.GhostHill, GOTWaypoint.Godsgrace, GOTWaypoint.Hellholt, GOTWaypoint.HighHermitage.info(0.5, 0, 1), GOTWaypoint.Tor, GOTWaypoint.Vaith, GOTWaypoint.WaterGardens, GOTWaypoint.Spottswood, GOTWaypoint.Lemonwood, GOTWaypoint.Saltshore, GOTWaypoint.Sandstone, GOTWaypoint.Kingsgrave.info(0.5, 0, 1), GOTWaypoint.SkyReach.info(0, 0.5, 2), GOTWaypoint.Starfall.info(0, 0.6, 2), GOTWaypoint.Wyl.info(-0.55, 0, 3), GOTWaypoint.Yronwood.info(0.5, 0, 1));
		...
		registerLocation(new GOTStructureRiverlandsSettlement(biome, 0.0f).type(GOTStructureRiverlandsSettlement.Type.FORT, 3), GOTWaypoint.Darry, GOTWaypoint.Maidenpool.info(0, -0.5), GOTWaypoint.PinkmaidenCastle, GOTWaypoint.RaventreeHall, GOTWaypoint.WayfarerRest.info(-0.5, 0, 3), GOTWaypoint.AcornHall.info(-0.5, 0, 3), GOTWaypoint.Atranta, GOTWaypoint.Riverrun.info(0, -0.5), GOTWaypoint.Seagard.info(0, -0.7), GOTWaypoint.StoneHedge.info(0, -0.5));
		registerLocation(new GOTStructureRiverlandsSettlement(biome, 0.0f).type(GOTStructureRiverlandsSettlement.Type.TOWN, 6), GOTWaypoint.Harroway.info(0, 0.9, 2), GOTWaypoint.Maidenpool.info(0, 0.9, 2), GOTWaypoint.Saltpans.info(0.9, 0), GOTWaypoint.StoneySept.info(-0.9, 0, 3), GOTWaypoint.Seagard.info(0, 0.9, 2));
		...
		registerLocation(new GOTStructureStormlandsSettlement(biome, 0.0f).type(GOTStructureStormlandsSettlement.Type.FORT, 3), GOTWaypoint.CrowsNest, GOTWaypoint.GriffinsRoost, GOTWaypoint.Blackhaven.info(-0.5, 0, 3), GOTWaypoint.Bronzegate.info(0, -0.5), GOTWaypoint.DeatsHear, GOTWaypoint.EvenfallHall, GOTWaypoint.Fawntown, GOTWaypoint.Amberly, GOTWaypoint.BlackHeart, GOTWaypoint.BroadArch, GOTWaypoint.Parchments.info(0, -0.5), GOTWaypoint.Poddingfield.info(0, -0.5), GOTWaypoint.RainHouse, GOTWaypoint.SeaworthCastle, GOTWaypoint.Stonehelm, GOTWaypoint.StormsEnd.info(0, 0.5, 2), GOTWaypoint.TudburyHoll, GOTWaypoint.Gallowsgrey.info(0, -0.5), GOTWaypoint.Grandview.info(-0.5, 0, 3), GOTWaypoint.Greenstone, GOTWaypoint.HarvestHall.info(0, -0.5), GOTWaypoint.HaystackHall.info(0, -0.5), GOTWaypoint.Mistwood, GOTWaypoint.Felwood.info(0, -0.5), GOTWaypoint.Nightsong.info(0, -0.5));
		...
		registerLocation(new GOTStructureWesterlandsSettlement(biome, 0.0f).type(GOTStructureWesterlandsSettlement.Type.FORT, 3), GOTWaypoint.CasterlyRock.info(-0.5, 0, 3), GOTWaypoint.Crakehall.info(-0.5, 0, 3), GOTWaypoint.GoldenTooth.info(0, -0.51), GOTWaypoint.Kayce, GOTWaypoint.Sarsfield.info(0, -0.5), GOTWaypoint.Silverhill, GOTWaypoint.Wyndhall, GOTWaypoint.Plumwood, GOTWaypoint.Riverspring, GOTWaypoint.Greenfield, GOTWaypoint.Hornvale, GOTWaypoint.DeepDen, GOTWaypoint.Faircastle, GOTWaypoint.Feastfires, GOTWaypoint.CleganesKeep, GOTWaypoint.Cornfield, GOTWaypoint.Crag, GOTWaypoint.Ashemark, GOTWaypoint.Banefort);
	...
	public static void onInit() {
		...
		structures.put(GOTWaypoint.RyswellsCastle.info(-0.5, 0, 3), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
