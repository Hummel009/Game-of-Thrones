...
public class GOTFixer {
	...
	public static void initLocations() {
		...
		registerLocation(new GOTStructureCrownlandsSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureCrownlandsSettlement.Type.FORT, 3), GOTWaypoint.ANTLERS.info(0, -0.5), GOTWaypoint.BROWNHOLLOW, GOTWaypoint.DYRE_DEN, GOTWaypoint.STOKEWORTH.info(-0.5, 0, Dir.WEST), GOTWaypoint.HAYFORD.info(0, -0.5), GOTWaypoint.ROOKS_REST.info(0, -0.5), GOTWaypoint.ROSBY.info(-0.55, 0, Dir.WEST));
		...
		registerLocation(new GOTStructureDorneSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureDorneSettlement.Type.FORT, 3), GOTWaypoint.BLACKMONT.info(0.5, 0, Dir.EAST), GOTWaypoint.GHOST_HILL, GOTWaypoint.GODSGRACE, GOTWaypoint.HELLHOLT, GOTWaypoint.HIGH_HERMITAGE.info(0.5, 0, Dir.EAST), GOTWaypoint.TOR, GOTWaypoint.VAITH, GOTWaypoint.WATER_GARDENS, GOTWaypoint.SPOTTSWOOD, GOTWaypoint.LEMONWOOD, GOTWaypoint.SALTSHORE, GOTWaypoint.SANDSTONE, GOTWaypoint.KINGSGRAVE.info(0.5, 0, Dir.EAST), GOTWaypoint.SKY_REACH.info(0, 0.5, Dir.SOUTH), GOTWaypoint.STARFALL.info(0, 0.6, Dir.SOUTH), GOTWaypoint.WYL.info(-0.55, 0, Dir.WEST), GOTWaypoint.YRONWOOD.info(0.5, 0, Dir.EAST));
		...
		registerLocation(new GOTStructureGiftSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureGiftSettlement.Type.ABANDONED, 2), GOTWaypoint.GREENGUARD, GOTWaypoint.TORCHES, GOTWaypoint.LONG_BARROW, GOTWaypoint.RIMEGATE, GOTWaypoint.SABLE_HALL, GOTWaypoint.WOODSWATCH, GOTWaypoint.NIGHTFORT, GOTWaypoint.DEEP_LAKE, GOTWaypoint.OAKENSHIELD, GOTWaypoint.ICEMARK, GOTWaypoint.HOARFROST_HILL, GOTWaypoint.STONEDOOR, GOTWaypoint.GREYGUARD, GOTWaypoint.QUEENSGATE, GOTWaypoint.SENTINEL_STAND);
		...
		registerLocation(new GOTStructureGiftSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureGiftSettlement.Type.EAST_WATCH, 2), GOTWaypoint.EAST_WATCH);
		...
		registerLocation(new GOTStructureNorthSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureNorthSettlement.Type.FORT, 3), GOTWaypoint.CATFISH_ROCK, GOTWaypoint.BREAKSTONE_HILL, GOTWaypoint.GOLDGRASS.info(0, 0.5, Dir.SOUTH), GOTWaypoint.RYSWELLS_CASTLE.info(-0.5, 0, Dir.WEST), GOTWaypoint.SERVINS_CASTLE.info(-0.5, 0, Dir.WEST), GOTWaypoint.WINTERFELL.info(-0.5, 0, Dir.WEST), GOTWaypoint.BLACK_POOL, GOTWaypoint.DEEPWOOD_MOTTE, GOTWaypoint.DREADFORT.info(0, -0.5), GOTWaypoint.FLINTS_FINGER, GOTWaypoint.HIGHPOINT, GOTWaypoint.TORHENS_SQUARE.info(-0.5, 0, Dir.WEST), GOTWaypoint.WIDOWS_WATCH, GOTWaypoint.HORNWOOD, GOTWaypoint.IRONRATH, GOTWaypoint.KARHOLD.info(0.5, 0, Dir.EAST), GOTWaypoint.LAST_HEARTH, GOTWaypoint.MOAT_KAILIN, GOTWaypoint.MORMONTS_KEEP, GOTWaypoint.OLD_CASTLE, GOTWaypoint.RAMS_GATE, GOTWaypoint.RILLWATER_CROSSING.info(-0.5, 0, Dir.WEST));
		...
		registerLocation(new GOTStructureReachSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureReachSettlement.Type.TOWN, 6), GOTWaypoint.OLDTOWN.info(-1.1, 0, Dir.WEST), GOTWaypoint.APPLETON.info(0.1, 1.1, Dir.SOUTH), GOTWaypoint.ASHFORD, GOTWaypoint.HEWETT_TOWN, GOTWaypoint.SMITHYTON.info(0, 0.9, Dir.SOUTH), GOTWaypoint.STARFISH_HARBOR, GOTWaypoint.VINETOWN, GOTWaypoint.RYAMSPORT, GOTWaypoint.TUMBLETON.info(0, -1.0));
		...
		registerLocation(new GOTStructureRiverlandsSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureRiverlandsSettlement.Type.FORT, 3), GOTWaypoint.DARRY, GOTWaypoint.MAIDENPOOL.info(0, -0.5), GOTWaypoint.PINKMAIDEN_CASTLE, GOTWaypoint.RAVENTREE_HALL, GOTWaypoint.WAYFARER_REST.info(-0.5, 0, Dir.WEST), GOTWaypoint.ACORN_HALL.info(-0.5, 0, Dir.WEST), GOTWaypoint.ATRANTA, GOTWaypoint.RIVERRUN.info(0, -0.5), GOTWaypoint.SEAGARD.info(0, -0.7), GOTWaypoint.STONE_HEDGE.info(0, -0.5));
		...
		registerLocation(new GOTStructureRiverlandsSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureRiverlandsSettlement.Type.VILLAGE, 6), GOTWaypoint.FAIR_MARKET, GOTWaypoint.PENNYTREE, GOTWaypoint.SEVENSTREAMS);
		registerLocation(new GOTStructureRuins(GOTBiome.ocean, 0.0f), GOTWaypoint.WEST_WATCH.info(-0.3, 0), GOTWaypoint.VAES_LEISI.info(0, 0.3), GOTWaypoint.MORNE.info(0, 0.3), GOTWaypoint.NY_SAR.info(0, 0.15), GOTWaypoint.OLD_GHIS.info(0, 0.3), GOTWaypoint.SAR_MELL.info(0, -0.25), GOTWaypoint.SARHOY.info(0, 0.3), GOTWaypoint.SHANDYSTONE.info(0, 0.3), GOTWaypoint.STARPIKE.info(0, 0.3), GOTWaypoint.TELYRIA.info(0, 0.3), GOTWaypoint.TORTURERS_DEEP.info(0, 0.3), GOTWaypoint.VAES_ORVIK.info(0.3, 0), GOTWaypoint.VAES_QOSAR.info(0, 0.3), GOTWaypoint.VAES_SHIROSI.info(0, 0.3), GOTWaypoint.VAES_TOLORRO.info(0, 0.3), GOTWaypoint.VALYRIAN_ROAD.info(-0.2, 0), GOTWaypoint.VELOS.info(0, 0.3), GOTWaypoint.GREY_GALLOWS.info(0, 0.3), GOTWaypoint.BLOOD_STONE.info(0, 0.3), GOTWaypoint.ANOGARIA.info(0, 0.2), GOTWaypoint.KAYAKAYANAYA.info(0, 0.3), GOTWaypoint.AEGON.info(0, 0.3), GOTWaypoint.RAENYS.info(0, 0.3), GOTWaypoint.VISENYA.info(0, 0.3), GOTWaypoint.GHOZAI.info(0, 0.3), GOTWaypoint.CHROYANE.info(0.3, 0), GOTWaypoint.FOURTEEN_FLAMES.info(0, 0.3), GOTWaypoint.IBBISH.info(0, 0.3), GOTWaypoint.SAMYRIANA.info(0, 0.3), GOTWaypoint.BHORASH.info(0, 0.2), GOTWaypoint.BAYASABHAD.info(0, 0.3), GOTWaypoint.AR_NOY.info(-0.1, -0.25), GOTWaypoint.ADAKHAKILEKI.info(0, 0.3), GOTWaypoint.CASTLE_LYCHESTER.info(0, -0.3), GOTWaypoint.MHYSA_FAER.info(0, 0.3), GOTWaypoint.AQUOS_DHAEN.info(0, 0.3), GOTWaypoint.DRACONYS.info(0, 0.3), GOTWaypoint.TYRIA.info(0, 0.3), GOTWaypoint.RHYOS.info(0, 0.3), GOTWaypoint.OROS.info(0, 0.2), GOTWaypoint.VULTURES_ROOST.info(0, 0.3), GOTWaypoint.SPICETOWN.info(0, 0.3), GOTWaypoint.CASTAMERE.info(0, 0.3), GOTWaypoint.GOLDENHILL.info(0, 0.3), GOTWaypoint.GREYIRON_CASTLE.info(0, 0.3), GOTWaypoint.HOARE_CASTLE.info(0, 0.3), GOTWaypoint.HOARE_KEEP.info(0, 0.3), GOTWaypoint.HOGG_HALL.info(0.2, -0.2), GOTWaypoint.HOLLARD_CASTLE.info(0.3, 0), GOTWaypoint.OLD_STONES.info(0, 0.3), GOTWaypoint.SUMMERHALL.info(-0.3, 0), GOTWaypoint.TARBECK_HALL.info(0, 0.3), GOTWaypoint.TOWER_OF_JOY.info(-0.3, 0), GOTWaypoint.WHISPERS.info(0, 0.3), GOTWaypoint.WHITE_WALLS.info(0.2, -0.2));
		...
		registerLocation(new GOTStructureStormlandsSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureStormlandsSettlement.Type.FORT, 3), GOTWaypoint.CROWS_NEST, GOTWaypoint.GRIFFINS_ROOST, GOTWaypoint.BLACKHAVEN.info(-0.5, 0, Dir.WEST), GOTWaypoint.BRONZEGATE.info(0, -0.5), GOTWaypoint.DEATS_HEAR, GOTWaypoint.EVENFALL_HALL, GOTWaypoint.FAWNTOWN, GOTWaypoint.AMBERLY, GOTWaypoint.BLACK_HEART, GOTWaypoint.BROAD_ARCH, GOTWaypoint.PARCHMENTS.info(0, -0.5), GOTWaypoint.PODDINGFIELD.info(0, -0.5), GOTWaypoint.RAIN_HOUSE, GOTWaypoint.SEAWORTH_CASTLE, GOTWaypoint.STONEHELM, GOTWaypoint.STORMS_END.info(0, 0.5, Dir.SOUTH), GOTWaypoint.TUDBURY_HOLL, GOTWaypoint.GALLOWSGREY.info(0, -0.5), GOTWaypoint.GRANDVIEW.info(-0.5, 0, Dir.WEST), GOTWaypoint.GREENSTONE, GOTWaypoint.HARVEST_HALL.info(0, -0.5), GOTWaypoint.HAYSTACK_HALL.info(0, -0.5), GOTWaypoint.MISTWOOD, GOTWaypoint.FELWOOD.info(0, -0.5), GOTWaypoint.NIGHTSONG.info(0, -0.5));
		...
		registerLocation(new GOTStructureWesterlandsSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureWesterlandsSettlement.Type.FORT, 3), GOTWaypoint.CRAKEHALL.info(-0.5, 0, Dir.WEST), GOTWaypoint.GOLDEN_TOOTH.info(0, -0.52), GOTWaypoint.KAYCE, GOTWaypoint.SARSFIELD.info(0, -0.5), GOTWaypoint.SILVERHILL, GOTWaypoint.WYNDHALL, GOTWaypoint.PLUMWOOD, GOTWaypoint.RIVERSPRING, GOTWaypoint.GREENFIELD, GOTWaypoint.HORNVALE, GOTWaypoint.DEEP_DEN, GOTWaypoint.FAIRCASTLE, GOTWaypoint.FEASTFIRES, GOTWaypoint.CLEGANES_KEEP, GOTWaypoint.CORNFIELD, GOTWaypoint.CRAG, GOTWaypoint.ASHEMARK, GOTWaypoint.BANEFORT);
		registerLocation(new GOTStructureWesterlandsSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureWesterlandsSettlement.Type.CASTERLY_ROCK, 3), GOTWaypoint.CASTERLY_ROCK.info(-0.5, 0, Dir.WEST));
	...
	public static void initSpawners() {
		...
		structures.put(GOTWaypoint.CASTERLY_ROCK.info(-0.5, 0), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.GOLDEN_TOOTH.info(0, -0.52), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.IRON_OAK, new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.NAGGA_HILL, new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.SERVINS_CASTLE.info(-0.5, 0), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.SKY_REACH.info(0, 0.5), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.THE_EYRIE.info(0, -0.5), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.WHITE_WOOD, new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
