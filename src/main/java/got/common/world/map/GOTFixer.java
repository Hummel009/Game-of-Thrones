...
public class GOTFixer {
	...
	public static void addWaypointLocations(GOTBiome biome) {
		...
		registerLocation(new GOTStructureArrynSettlement(biome, 0.0f).type(GOTStructureArrynSettlement.Type.TOWN, 6), GOTWaypoint.Gulltown, GOTWaypoint.Sisterton);
		registerLocation(new GOTStructureAsshaiSettlement(biome, 0.0f), GOTWaypoint.Asshai.info(0, 0.8, 2));
		registerLocation(new GOTStructureBraavosSettlement(biome, 0.0f).type(GOTStructureBraavosSettlement.Type.TOWN, 6), GOTWaypoint.Braavos.info(essosGateShift, -0.5, 2));
		registerLocation(new GOTStructureCrownlandsSettlement(biome, 0.0f).type(GOTStructureCrownlandsSettlement.Type.FORT, 3), GOTWaypoint.Antlers.info(0, -0.5), GOTWaypoint.Brownhollow, GOTWaypoint.DyreDen, GOTWaypoint.Stokeworth.info(-0.5, 0), GOTWaypoint.Hayford.info(0, -0.5), GOTWaypoint.RooksRest.info(0, -0.5), GOTWaypoint.Rosby.info(-0.6, 0, 3));
		registerLocation(new GOTStructureCrownlandsSettlement(biome, 0.0f).type(GOTStructureCrownlandsSettlement.Type.KINGS_LANDING, 6), GOTWaypoint.KingsLanding.info(0.9, 0, 1));
		registerLocation(new GOTStructureCrownlandsSettlement(biome, 0.0f).type(GOTStructureCrownlandsSettlement.Type.RED_KEEP, 3), GOTWaypoint.KingsLanding.info(2, 0, 1));
		registerLocation(new GOTStructureCrownlandsSettlement(biome, 0.0f).type(GOTStructureCrownlandsSettlement.Type.TOWN, 6), GOTWaypoint.Duskendale.info(0, -1.3));
		registerLocation(new GOTStructureCrownlandsSettlement(biome, 0.0f).type(GOTStructureCrownlandsSettlement.Type.VILLAGE, 6), GOTWaypoint.Briarwhite.info(0, -0.7), GOTWaypoint.Rosby.info(0.7, 0));
		registerLocation(new GOTStructureDorneSettlement(biome, 0.0f).type(GOTStructureDorneSettlement.Type.FORT, 3), GOTWaypoint.Blackmont.info(0.5, 0), GOTWaypoint.GhostHill, GOTWaypoint.Godsgrace, GOTWaypoint.Hellholt, GOTWaypoint.HighHermitage.info(0.5, 0), GOTWaypoint.Tor, GOTWaypoint.Vaith, GOTWaypoint.WaterGardens, GOTWaypoint.Spottswood, GOTWaypoint.Lemonwood, GOTWaypoint.Saltshore, GOTWaypoint.Sandstone, GOTWaypoint.Kingsgrave.info(0.5, 0), GOTWaypoint.SkyReach.info(0, 0.5, 2), GOTWaypoint.Starfall.info(0, 0.6, 2), GOTWaypoint.Wyl.info(-0.5, 0), GOTWaypoint.Yronwood.info(0.5, 0, 1));
		registerLocation(new GOTStructureDorneSettlement(biome, 0.0f).type(GOTStructureDorneSettlement.Type.TOWN, 6), GOTWaypoint.GhastonGrey, GOTWaypoint.PlankyTown, GOTWaypoint.Sunspear);
		registerLocation(new GOTStructureDothrakiSettlement(biome, 0.0f).type(GOTStructureDothrakiSettlement.Type.BIG, 5), GOTWaypoint.Hornoth.info(0.5, 0), GOTWaypoint.Kyth.info(0.3, -0.4), GOTWaypoint.Sathar.info(0.5, 0), GOTWaypoint.Rathylar.info(0.6, -0.1), GOTWaypoint.Saath.info(0, -0.5), GOTWaypoint.VaesAthjikhari.info(0, -0.5), GOTWaypoint.VaesDiaf, GOTWaypoint.VaesDothrak, GOTWaypoint.VaesEfe, GOTWaypoint.VaesGorqoyi.info(0.3, -0.4), GOTWaypoint.VaesGraddakh, GOTWaypoint.VaesJini.info(0, 0.5), GOTWaypoint.VojjorSamvi.info(0, -0.5), GOTWaypoint.VaesKhadokh.info(-0.1, -0.5), GOTWaypoint.VaesKhewo.info(0, -0.5), GOTWaypoint.VaesLeqse.info(0.5, 0), GOTWaypoint.VaesMejhah.info(0, -0.5), GOTWaypoint.KrazaajHas.info(0, -0.5));
		registerLocation(new GOTStructureDragonstoneSettlement(biome, 0.0f).type(GOTStructureDragonstoneSettlement.Type.FORT, 3), GOTWaypoint.ClawIsle, GOTWaypoint.Dragonstone, GOTWaypoint.Driftmark, GOTWaypoint.HighTide, GOTWaypoint.SharpPoint, GOTWaypoint.Stonedance, GOTWaypoint.SweetportSound);
		registerLocation(new GOTStructureDragonstoneSettlement(biome, 0.0f).type(GOTStructureDragonstoneSettlement.Type.TOWN, 6), GOTWaypoint.Hull);
		registerLocation(new GOTStructureGhiscarSettlement(biome, 0.0f).type(GOTStructureGhiscarSettlement.Type.COLONY, 4), GOTWaypoint.IsleOfWhips, GOTWaypoint.BarterBeach, GOTWaypoint.Gogossos, GOTWaypoint.Gorosh, GOTWaypoint.Zamettar.info(0, -0.5, 2));
		registerLocation(new GOTStructureGhiscarSettlement(biome, 0.0f).type(GOTStructureGhiscarSettlement.Type.PYRAMID, 3), GOTWaypoint.Meereen.info(essosGateShift, -1.5), GOTWaypoint.Astapor.info(-1.5, -essosGateShift), GOTWaypoint.NewGhis.info(-1, 0), GOTWaypoint.Yunkai.info(-1.5, -essosGateShift));
		registerLocation(new GOTStructureGhiscarSettlement(biome, 0.0f).type(GOTStructureGhiscarSettlement.Type.TOWN, 6), GOTWaypoint.Meereen.info(essosGateShift, -0.5, 2), GOTWaypoint.Astapor.info(-0.5, -essosGateShift, 1), GOTWaypoint.NewGhis, GOTWaypoint.Yunkai.info(-0.5, -essosGateShift, 1));
		registerLocation(new GOTStructureGiftSettlement(biome, 0.0f).type(GOTStructureGiftSettlement.Type.ABANDONED, 2), GOTWaypoint.Greenguard, GOTWaypoint.Torches, GOTWaypoint.LongBarrow, GOTWaypoint.Rimegate, GOTWaypoint.SableHall, GOTWaypoint.Woodswatch, GOTWaypoint.Nightfort, GOTWaypoint.DeepLake, GOTWaypoint.Oakenshield, GOTWaypoint.Icemark, GOTWaypoint.HoarfrostHill, GOTWaypoint.Stonedoor, GOTWaypoint.Greyguard, GOTWaypoint.Queensgate, GOTWaypoint.SentinelStand);
		registerLocation(new GOTStructureGiftSettlement(biome, 0.0f).type(GOTStructureGiftSettlement.Type.CASTLE_BLACK, 2), GOTWaypoint.CastleBlack);
		registerLocation(new GOTStructureGiftSettlement(biome, 0.0f).type(GOTStructureGiftSettlement.Type.EAST_WATCH, 2), GOTWaypoint.EastWatch);
		registerLocation(new GOTStructureGiftSettlement(biome, 0.0f).type(GOTStructureGiftSettlement.Type.SHADOW_TOWER, 2), GOTWaypoint.ShadowTower);
		registerLocation(new GOTStructureGiftSettlement(biome, 0.0f).type(GOTStructureGiftSettlement.Type.VILLAGE, 4), GOTWaypoint.Moletown, GOTWaypoint.Queenscrown);
		registerLocation(new GOTStructureIbbenSettlement(biome, 0.0f).type(GOTStructureIbbenSettlement.Type.FORT, 6), GOTWaypoint.IbNor, GOTWaypoint.IbSar, GOTWaypoint.NewIbbish, GOTWaypoint.PortOfIbben);
		registerLocation(new GOTStructureIronbornSettlement(biome, 0.0f).type(GOTStructureIronbornSettlement.Type.CAMP, 5), GOTWaypoint.VictarionLanding);
		registerLocation(new GOTStructureIronbornSettlement(biome, 0.0f).type(GOTStructureIronbornSettlement.Type.FORT, 3), GOTWaypoint.CatfishRock, GOTWaypoint.Blacktyde, GOTWaypoint.CorpseLake, GOTWaypoint.CrowSpikeKeep, GOTWaypoint.Downdelving, GOTWaypoint.DrummCastle, GOTWaypoint.GreyGarden, GOTWaypoint.Hammerhorn, GOTWaypoint.HarlawHall, GOTWaypoint.HarridanHill, GOTWaypoint.IronHolt, GOTWaypoint.LonelyLight, GOTWaypoint.MyreCastle, GOTWaypoint.Orkwood, GOTWaypoint.Pyke, GOTWaypoint.Saltcliffe, GOTWaypoint.SealskinPoint, GOTWaypoint.Shatterstone, GOTWaypoint.SparrCastle, GOTWaypoint.Stonehouse, GOTWaypoint.StonetreeCastle, GOTWaypoint.Sunderly, GOTWaypoint.TawneyCastle, GOTWaypoint.TenTowers, GOTWaypoint.Volmark);
		registerLocation(new GOTStructureIronbornSettlement(biome, 0.0f).type(GOTStructureIronbornSettlement.Type.TOWN, 6), GOTWaypoint.Lordsport, GOTWaypoint.RedHaven);
		registerLocation(new GOTStructureIronbornSettlement(biome, 0.0f).type(GOTStructureIronbornSettlement.Type.VILLAGE, 6), GOTWaypoint.Pebbleton);
		registerLocation(new GOTStructureJogosSettlement(biome, 0.0f).type(GOTStructureJogosSettlement.Type.BIG, 5), GOTWaypoint.Hojdbaatar);
		registerLocation(new GOTStructureLhazarSettlement(biome, 0.0f).type(GOTStructureLhazarSettlement.Type.TOWN, 6), GOTWaypoint.Hesh.info(1.2, 0), GOTWaypoint.Kosrak.info(1, 0), GOTWaypoint.Lhazosh.info(1, 0, 3));
		registerLocation(new GOTStructureLorathSettlement(biome, 0.0f).type(GOTStructureLorathSettlement.Type.TOWN, 6), GOTWaypoint.Lorath, GOTWaypoint.Morosh);
		registerLocation(new GOTStructureLysSettlement(biome, 0.0f).type(GOTStructureLysSettlement.Type.TOWN, 6), GOTWaypoint.Lys);
		registerLocation(new GOTStructureMossovySettlement(biome, 0.0f).type(GOTStructureMossovySettlement.Type.VILLAGE, 6), GOTWaypoint.Kuurulgan, GOTWaypoint.SuudanKorkuu, GOTWaypoint.KanduuBet, GOTWaypoint.Tashtoo, GOTWaypoint.Bashkaruuchu, GOTWaypoint.AzuuKan, GOTWaypoint.Kujruk, GOTWaypoint.Korkunuchtuu, GOTWaypoint.NymduuOoz, GOTWaypoint.Azhydaar, GOTWaypoint.AkShaar, GOTWaypoint.SuuNym, GOTWaypoint.ShyluunUusu, GOTWaypoint.Kadar, GOTWaypoint.Nefer, GOTWaypoint.KDath);
		registerLocation(new GOTStructureMyrSettlement(biome, 0.0f).type(GOTStructureMyrSettlement.Type.TOWN, 6), GOTWaypoint.Myr.info(-0.5, -essosGateShift, 1));
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).type(GOTStructureNorthSettlement.Type.FORT, 3), GOTWaypoint.CatfishRock, GOTWaypoint.BreakstoneHill, GOTWaypoint.Goldgrass.info(0, 0.5, 2), GOTWaypoint.RisvellsCastle.info(-0.5, 0), GOTWaypoint.ServinsCastle.info(-0.5, 0), GOTWaypoint.Winterfell.info(-0.5, 0), GOTWaypoint.BlackPool, GOTWaypoint.DeepwoodMotte, GOTWaypoint.Dreadfort.info(0, -0.5), GOTWaypoint.FlintsFinger, GOTWaypoint.Highpoint, GOTWaypoint.TorhensSquare.info(0, -0.5), GOTWaypoint.WidowsWatch, GOTWaypoint.Hornwood, GOTWaypoint.Ironrath, GOTWaypoint.Karhold.info(0.5, 0), GOTWaypoint.LastHearth, GOTWaypoint.MoatKailin, GOTWaypoint.MormontsKeep, GOTWaypoint.OldCastle, GOTWaypoint.RamsGate, GOTWaypoint.RillwaterCrossing.info(-0.5, 0, 3));
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).type(GOTStructureNorthSettlement.Type.HILLMAN, 6), GOTWaypoint.Skane, GOTWaypoint.Deepdown, GOTWaypoint.DriftwoodHall, GOTWaypoint.Kingshouse);
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).type(GOTStructureNorthSettlement.Type.SMALL_TOWN, 6), GOTWaypoint.Barrowtown);
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).type(GOTStructureNorthSettlement.Type.TOWN, 6), GOTWaypoint.WhiteHarbour.info(0.9, 0, 1));
		registerLocation(new GOTStructureNorthSettlement(biome, 0.0f).type(GOTStructureNorthSettlement.Type.VILLAGE, 6), GOTWaypoint.GreywaterWatch);
		registerLocation(new GOTStructureNorvosSettlement(biome, 0.0f).type(GOTStructureNorvosSettlement.Type.TOWN, 6), GOTWaypoint.Norvos.info(essosGateShift, -0.5, 2));
		registerLocation(new GOTStructurePentosSettlement(biome, 0.0f).type(GOTStructurePentosSettlement.Type.TOWN, 6), GOTWaypoint.Pentos.info(-0.5, -essosGateShift, 1));
		registerLocation(new GOTStructurePentosSettlement(biome, 0.0f).type(GOTStructurePentosSettlement.Type.VILLAGE, 5), GOTWaypoint.GhoyanDrohe.info(0, 0.7));
		registerLocation(new GOTStructureQarthSettlement(biome, 0.0f).type(GOTStructureQarthSettlement.Type.COLONY, 4), GOTWaypoint.Teriman, GOTWaypoint.Batargas, GOTWaypoint.Karimagar);
		registerLocation(new GOTStructureQarthSettlement(biome, 0.0f).type(GOTStructureQarthSettlement.Type.TOWN, 6), GOTWaypoint.PortYhos.info(-essosGateShift, 0.5), GOTWaypoint.Qarkash.info(-essosGateShift, 0.5), GOTWaypoint.Qarth.info(-essosGateShift, 0.5));
		registerLocation(new GOTStructureQohorSettlement(biome, 0.0f).type(GOTStructureQohorSettlement.Type.TOWN, 6), GOTWaypoint.Qohor.info(-0.6, -essosGateShift, 1));
		registerLocation(new GOTStructureReachSettlement(biome, 0.0f).type(GOTStructureReachSettlement.Type.FORT, 3), GOTWaypoint.Highgarden.info(0.5, 0), GOTWaypoint.Appleton.info(0, -0.5), GOTWaypoint.Ashford, GOTWaypoint.Bandallon, GOTWaypoint.Goldengrove, GOTWaypoint.GrassyVale, GOTWaypoint.Greenshield, GOTWaypoint.Grimston, GOTWaypoint.Hammerhal.info(0.5, 0), GOTWaypoint.RedLake.info(0, 0.5, 2), GOTWaypoint.Ring.info(0, -0.5), GOTWaypoint.Southshield, GOTWaypoint.Uplands, GOTWaypoint.Holyhall.info(0.5, 0), GOTWaypoint.Honeyholt, GOTWaypoint.HornHill, GOTWaypoint.IvyHall.info(0, 0.5, 2), GOTWaypoint.Longtable, GOTWaypoint.NewBarrel, GOTWaypoint.Blackcrown, GOTWaypoint.BrightwaterKeep, GOTWaypoint.CiderHall, GOTWaypoint.Coldmoat.info(0, 0.5, 2), GOTWaypoint.DarkDell.info(-0.5, 0), GOTWaypoint.Dunstonbury, GOTWaypoint.Bitterbridge.info(0, 0.5, 2), GOTWaypoint.GarnetGrove.info(-0.5, 0), GOTWaypoint.HewettTown, GOTWaypoint.OldOak.info(0, 0.5, 2), GOTWaypoint.SunHouse.info(0, 0.5, 2), GOTWaypoint.Whitegrove.info(-0.5, 0, 3));
		registerLocation(new GOTStructureReachSettlement(biome, 0.0f).type(GOTStructureReachSettlement.Type.TOWN, 6), GOTWaypoint.Oldtown.info(-1.1, 0), GOTWaypoint.Appleton.info(0, 1.2, 2), GOTWaypoint.Ashford, GOTWaypoint.HewettTown, GOTWaypoint.Smithyton.info(0, 0.9, 2), GOTWaypoint.StarfishHarbor, GOTWaypoint.Vinetown, GOTWaypoint.Ryamsport, GOTWaypoint.Tumbleton.info(0, -1.0));
		...
		registerLocation(new GOTStructureRiverlandsSettlement(biome, 0.0f).type(GOTStructureRiverlandsSettlement.Type.FORT, 3), GOTWaypoint.Darry, GOTWaypoint.Maidenpool, GOTWaypoint.PinkmaidenCastle, GOTWaypoint.RaventreeHall, GOTWaypoint.WayfarerRest.info(-0.5, 0), GOTWaypoint.AcornHall.info(-0.5, 0), GOTWaypoint.Atranta, GOTWaypoint.Riverrun.info(0, -0.5), GOTWaypoint.Seagard.info(0, -0.7), GOTWaypoint.StoneHedge.info(0, -0.5));
		registerLocation(new GOTStructureRiverlandsSettlement(biome, 0.0f).type(GOTStructureRiverlandsSettlement.Type.TOWN, 6), GOTWaypoint.Harroway.info(0, 0.9, 2), GOTWaypoint.Maidenpool, GOTWaypoint.Saltpans.info(0.9, 0), GOTWaypoint.StoneySept.info(-0.9, 0), GOTWaypoint.Seagard.info(0, 0.9, 2));
		...
		registerLocation(new GOTStructureSothoryosSettlement(biome, 0.0f).type(GOTStructureSothoryosSettlement.Type.PYRAMID, 3), GOTWaypoint.Raumati);
		registerLocation(new GOTStructureSothoryosSettlement(biome, 0.0f).type(GOTStructureSothoryosSettlement.Type.VILLAGE, 3), GOTWaypoint.Maunga, GOTWaypoint.DragonPlace, GOTWaypoint.SouthPoint, GOTWaypoint.BigLake);
		registerLocation(new GOTStructureStormlandsSettlement(biome, 0.0f).type(GOTStructureStormlandsSettlement.Type.FORT, 3), GOTWaypoint.CrowsNest, GOTWaypoint.GriffinsRoost, GOTWaypoint.Blackhaven.info(-0.5, 0), GOTWaypoint.Bronzegate.info(0, -0.5), GOTWaypoint.DeatsHear, GOTWaypoint.EvenfallHall, GOTWaypoint.Fawntown, GOTWaypoint.Amberly, GOTWaypoint.BlackHeart, GOTWaypoint.BroadArch, GOTWaypoint.Parchments.info(0, -0.5), GOTWaypoint.Poddingfield.info(0, -0.5), GOTWaypoint.RainHouse, GOTWaypoint.SeaworthCastle, GOTWaypoint.Stonehelm, GOTWaypoint.StormsEnd.info(0, 0.5, 2), GOTWaypoint.TudburyHoll, GOTWaypoint.Gallowsgrey.info(0, -0.5), GOTWaypoint.Grandview.info(-0.5, 0), GOTWaypoint.Greenstone, GOTWaypoint.HarvestHall.info(0, -0.5), GOTWaypoint.HaystackHall.info(0, -0.5), GOTWaypoint.Mistwood, GOTWaypoint.Felwood.info(0, -0.5), GOTWaypoint.Nightsong.info(0, -0.5));
		registerLocation(new GOTStructureStormlandsSettlement(biome, 0.0f).type(GOTStructureStormlandsSettlement.Type.TOWN, 6), GOTWaypoint.WeepingTown);
		registerLocation(new GOTStructureSummerSettlement(biome, 0.0f).type(GOTStructureSummerSettlement.Type.FORT, 3), GOTWaypoint.Hauauru, GOTWaypoint.Matahau, GOTWaypoint.Takutai, GOTWaypoint.Ataahua, GOTWaypoint.Pereki, GOTWaypoint.Ngarara, GOTWaypoint.Tauranga, GOTWaypoint.Matao, GOTWaypoint.Ngahere, GOTWaypoint.Kohuru);
		...
		registerLocation(new GOTStructureTower(biome, 0.0f), GOTWaypoint.ThreeTowers.info(-0.5, -0.5, 1), GOTWaypoint.ThreeTowers.info(-0.5, 0), GOTWaypoint.ThreeTowers.info(-0.5, 0.5, 1), GOTWaypoint.TowerOfGlimmering, GOTWaypoint.BaelishKeep, GOTWaypoint.HightowerLitehouse, GOTWaypoint.RamseyTower, GOTWaypoint.Standfast, GOTWaypoint.TwinsLeft, GOTWaypoint.TwinsRight);
		registerLocation(new GOTStructureTyroshSettlement(biome, 0.0f).type(GOTStructureTyroshSettlement.Type.TOWN, 6), GOTWaypoint.Tyrosh);
		registerLocation(new GOTStructureVolantisSettlement(biome, 0.0f).type(GOTStructureVolantisSettlement.Type.TOWN, 6), GOTWaypoint.Elyria, GOTWaypoint.Tolos.info(-essosGateShift, 0.5), GOTWaypoint.LittleValyria.info(-essosGateShift, 0.7), GOTWaypoint.Mantarys.info(essosGateShift, -0.5, 2), GOTWaypoint.Selhorys.info(-0.5, -essosGateShift, 1), GOTWaypoint.Valysar.info(-0.7, -essosGateShift, 1), GOTWaypoint.Volantis.info(-essosGateShift - 0.2, 0.6), GOTWaypoint.VolonTherys.info(-essosGateShift, 0.5));
		registerLocation(new GOTStructureWesterlandsSettlement(biome, 0.0f).type(GOTStructureWesterlandsSettlement.Type.FORT, 3), GOTWaypoint.CasterlyRock.info(-0.5, 0), GOTWaypoint.Crakehall.info(-0.5, 0), GOTWaypoint.GoldenTooth.info(0, -0.5), GOTWaypoint.Kayce, GOTWaypoint.Sarsfield.info(0, -0.5), GOTWaypoint.Silverhill, GOTWaypoint.Wyndhall, GOTWaypoint.Plumwood, GOTWaypoint.Riverspring, GOTWaypoint.Greenfield, GOTWaypoint.Hornvale, GOTWaypoint.DeepDen, GOTWaypoint.Faircastle, GOTWaypoint.Feastfires, GOTWaypoint.CleganesKeep, GOTWaypoint.Cornfield, GOTWaypoint.Crag, GOTWaypoint.Ashemark, GOTWaypoint.Banefort);
		registerLocation(new GOTStructureWesterlandsSettlement(biome, 0.0f).type(GOTStructureWesterlandsSettlement.Type.TOWN, 6), GOTWaypoint.Kayce, GOTWaypoint.Lannisport.info(-0.9, 0, 3));
		registerLocation(new GOTStructureWesterlandsSettlement(biome, 0.0f).type(GOTStructureWesterlandsSettlement.Type.VILLAGE, 6), GOTWaypoint.Oxcross.info(0.1, 0.6));
		registerLocation(new GOTStructureWildlingSettlement(biome, 0.0f).type(GOTStructureWildlingSettlement.Type.CRASTER, 1), GOTWaypoint.CrastersKeep);
		registerLocation(new GOTStructureWildlingSettlement(biome, 0.0f).type(GOTStructureWildlingSettlement.Type.HARDHOME, 7), GOTWaypoint.Hardhome);
		registerLocation(new GOTStructureYiTiSettlement(biome, 0.0f).type(GOTStructureYiTiSettlement.Type.GATE, 2), GOTWaypoint.Jianmen, GOTWaypoint.Anguo, GOTWaypoint.Dingguo, GOTWaypoint.Pinnu, GOTWaypoint.Pingjiang, GOTWaypoint.Wude, GOTWaypoint.Wusheng, GOTWaypoint.Zhenguo, GOTWaypoint.Lungmen);
		registerLocation(new GOTStructureYiTiSettlement(biome, 0.0f).type(GOTStructureYiTiSettlement.Type.GATE_ROAD, 2), GOTWaypoint.Anjiang);
		registerLocation(new GOTStructureYiTiSettlement(biome, 0.0f).type(GOTStructureYiTiSettlement.Type.TOWER, 9), GOTWaypoint.FiveForts1, GOTWaypoint.FiveForts2, GOTWaypoint.FiveForts3, GOTWaypoint.FiveForts4, GOTWaypoint.FiveForts5);
		registerLocation(new GOTStructureYiTiSettlement(biome, 0.0f).type(GOTStructureYiTiSettlement.Type.TOWN, 7), GOTWaypoint.Asabhad.info(-1, 0, 3), GOTWaypoint.Baoji.info(0, -1), GOTWaypoint.Eijiang.info(0, 1, 2), GOTWaypoint.Jinqi.info(-1, 0, 3), GOTWaypoint.Lizhao.info(1, 0, 1), GOTWaypoint.Manjin.info(1.1, -0.2, 1), GOTWaypoint.SiQo.info(1, 0, 1), GOTWaypoint.Tiqui.info(0, -1), GOTWaypoint.TraderTown.info(0, -1), GOTWaypoint.Vaibei.info(0, -1), GOTWaypoint.Yibin.info(0, -1), GOTWaypoint.Yin.info(0, 1, 2), GOTWaypoint.Yunnan.info(1, 0, 1), GOTWaypoint.Changan.info(1, 0, 1), GOTWaypoint.FuNing.info(1.1, 0.1, 1), GOTWaypoint.Zabhad, GOTWaypoint.Turrani, GOTWaypoint.Vahar, GOTWaypoint.Faros, GOTWaypoint.Huiji, GOTWaypoint.LengMa, GOTWaypoint.LengYi, GOTWaypoint.LesserMoraq, GOTWaypoint.Marahai, GOTWaypoint.PortMoraq);
	...
	public static void onInit() {
		...
		structures.put(GOTWaypoint.Asshai.info(0, 0.8, 2), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.CasterlyRock.info(-0.5, 0, 3), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.Crakehall.info(-0.5, 0, 3), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.Highgarden.info(0.5, 0, 1), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.HighHermitage.info(0.5, 0, 1), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.Karhold.info(0.5, 0, 1), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.KingsLanding.info(0.9, 0, 1), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.Lannisport.info(-0.9, 0, 3), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.Oldtown.info(-1.1, 0, 3), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.RisvellsCastle.info(-0.5, 0, 3), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.ServinsCastle.info(-0.5, 0, 3), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.SkyReach.info(0, 0.5, 2), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.Starfall.info(0, 0.6, 2), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.StormsEnd.info(0, 0.5, 2), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.TorhensSquare.info(0, -0.5), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.WhiteHarbour.info(0.9, 0, 1), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.Winterfell.info(-0.5, 0, 3), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.Yin.info(0, 1, 2), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.Yronwood.info(0.5, 0, 1), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
