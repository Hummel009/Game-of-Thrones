...
public class GOTFixer {
	...
	public static void addSpecialLocations(World world, Random random, int i, int k) {
		...
		if (GOTFixedStructures.fixedAt(i, k, GOTWaypoint.WINTERFELL.info(-0.45, -0.1, Dir.WEST))) {
	...
	public static void initLocations() {
		...
		registerLocation(new GOTStructureCrownlandsSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureCrownlandsSettlement.Type.TOWN, 6), GOTWaypoint.DUSKENDALE.info(-0.3, -1.0));
		...
		registerLocation(new GOTStructureNorthSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureNorthSettlement.Type.FORT, 3), GOTWaypoint.CATFISH_ROCK, GOTWaypoint.BREAKSTONE_HILL, GOTWaypoint.GOLDGRASS.info(0, 0.4, Dir.SOUTH), GOTWaypoint.RYSWELLS_CASTLE.info(-0.5, 0, Dir.WEST), GOTWaypoint.CASTLE_CERWYN.info(-0.4, 0, Dir.WEST), GOTWaypoint.WINTERFELL.info(-0.45, -0.1, Dir.WEST), GOTWaypoint.BLACK_POOL, GOTWaypoint.DEEPWOOD_MOTTE, GOTWaypoint.DREADFORT.info(0, -0.45), GOTWaypoint.FLINTS_FINGER, GOTWaypoint.HIGHPOINT, GOTWaypoint.TORRHENS_SQUARE.info(-0.4, 0, Dir.WEST), GOTWaypoint.WIDOWS_WATCH, GOTWaypoint.HORNWOOD, GOTWaypoint.IRONRATH, GOTWaypoint.KARHOLD.info(0.4, 0, Dir.EAST), GOTWaypoint.LAST_HEARTH, GOTWaypoint.MOAT_KAILIN, GOTWaypoint.MORMONTS_KEEP, GOTWaypoint.OLDCASTLE, GOTWaypoint.RAMSGATE, GOTWaypoint.RILLWATER_CROSSING.info(-0.4, 0, Dir.WEST));
		...
		registerLocation(new GOTStructureReachSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureReachSettlement.Type.FORT, 3), GOTWaypoint.APPLETON.info(-0.1, -0.5), GOTWaypoint.ASHFORD, GOTWaypoint.BANDALLON, GOTWaypoint.GOLDENGROVE, GOTWaypoint.GRASSY_VALE, GOTWaypoint.GREENSHIELD, GOTWaypoint.GRIMSTON, GOTWaypoint.HAMMERHAL.info(0.45, -0.1, Dir.EAST), GOTWaypoint.RED_LAKE.info(0, 0.45, Dir.SOUTH), GOTWaypoint.RING.info(0, -0.4), GOTWaypoint.SOUTHSHIELD, GOTWaypoint.UPLANDS, GOTWaypoint.HOLYHALL.info(0.45, 0, Dir.EAST), GOTWaypoint.HONEYHOLT, GOTWaypoint.HORN_HILL, GOTWaypoint.IVY_HALL.info(0, 0.5, Dir.SOUTH), GOTWaypoint.LONGTABLE, GOTWaypoint.NEW_BARREL, GOTWaypoint.BLACKCROWN, GOTWaypoint.BRIGHTWATER_KEEP, GOTWaypoint.CIDER_HALL, GOTWaypoint.COLDMOAT.info(0, 0.45, Dir.SOUTH), GOTWaypoint.DARKDELL.info(-0.5, 0, Dir.WEST), GOTWaypoint.DUNSTONBURY, GOTWaypoint.BITTERBRIDGE.info(0, 0.45, Dir.SOUTH), GOTWaypoint.GARNETGROVE.info(-0.5, 0, Dir.WEST), GOTWaypoint.LORD_HEWETTS_TOWN, GOTWaypoint.OLD_OAK.info(0, 0.4, Dir.SOUTH), GOTWaypoint.SUNHOUSE.info(0, 0.5, Dir.SOUTH), GOTWaypoint.WHITEGROVE.info(-0.5, 0, Dir.WEST));
		...
		registerLocation(new GOTStructureReachSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureReachSettlement.Type.TOWN, 6), GOTWaypoint.OLDTOWN.info(-1.1, 0, Dir.WEST), GOTWaypoint.APPLETON.info(0.3, 1.0, Dir.SOUTH), GOTWaypoint.ASHFORD, GOTWaypoint.LORD_HEWETTS_TOWN, GOTWaypoint.SMITHYTON.info(0, 0.8, Dir.SOUTH), GOTWaypoint.STARFISH_HARBOR, GOTWaypoint.VINETOWN, GOTWaypoint.RYAMSPORT, GOTWaypoint.TUMBLETON.info(0, -1.0));
		...
		registerLocation(new GOTStructureWesterlandsSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureWesterlandsSettlement.Type.FORT, 3), GOTWaypoint.CRAKEHALL.info(-0.45, -0.1, Dir.WEST), GOTWaypoint.GOLDEN_TOOTH.info(-0.1, -0.5), GOTWaypoint.KAYCE, GOTWaypoint.SARSFIELD.info(-0.1, -0.5), GOTWaypoint.SILVERHILL, GOTWaypoint.WYNDHALL, GOTWaypoint.PLUMWOOD, GOTWaypoint.RIVERSPRING, GOTWaypoint.GREENFIELD, GOTWaypoint.HORNVALE, GOTWaypoint.DEEP_DEN, GOTWaypoint.FAIRCASTLE, GOTWaypoint.FEASTFIRES, GOTWaypoint.CLEGANES_KEEP, GOTWaypoint.CORNFIELD, GOTWaypoint.CRAG, GOTWaypoint.ASHEMARK, GOTWaypoint.BANEFORT);
		registerLocation(new GOTStructureWesterlandsSettlement(GOTBiome.ocean, 0.0f).type(GOTStructureWesterlandsSettlement.Type.CASTERLY_ROCK, 3), GOTWaypoint.CASTERLY_ROCK.info(-0.45, 0, Dir.WEST));
	...
	public static void initSpawners() {
		...
		structures.put(GOTWaypoint.CASTERLY_ROCK.info(-0.45, 0), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.CRAKEHALL.info(-0.45, 0), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.DREADFORT.info(0, -0.45), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.RING.info(0, -0.4), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
		...
		structures.put(GOTWaypoint.WINTERFELL.info(-0.45, -0.1), new Spawner() {
			@Override
			public void spawnLegendaryNPC(World world) {
