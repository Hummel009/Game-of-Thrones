...
public enum GOTWaypoint implements GOTAbstractWaypoint {
	...
	BLOOD_STONE("BloodStone", Region.DORNE, GOTFaction.DORNE, 1044, 1924),
	...
	DARK_DELL("DarkDell", Region.REACH, GOTFaction.REACH, 521, 1783),
	DARRY("Darry", Region.RIVERLANDS, GOTFaction.RIVERLANDS, 748, 1453),
	DEATS_HEAR("DeatsHear", Region.STORMLANDS, GOTFaction.STORMLANDS, 770, 1853),
	...
	GARNET_GROVE("GarnetGrove", Region.REACH, GOTFaction.REACH, 354, 2013),
	...
	IRON_OAK("IronOak", Region.ARRYN, GOTFaction.ARRYN, 881, 1369),
	...
	LONG_BARROW("LongBarrow", Region.NORTH, GOTFaction.NIGHT_WATCH, 803, 632),
	...
	OLD_CASTLE("OldCastle", Region.NORTH, GOTFaction.NORTH, 757, 1138),
	...
	RAMS_GATE("RamsGate", Region.NORTH, GOTFaction.NORTH, 857, 1037),
