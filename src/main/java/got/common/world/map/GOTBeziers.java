...
public class GOTBeziers {
	...
	public static void onInit() {
		...
		registerHiddenRoad(id++, GOTWaypoint.Asshai, GOTWaypoint.Asshai.info(0, -1));
		...
		registerHiddenRoad(id++, GOTWaypoint.TraderTown, GOTWaypoint.TraderTown.info(1, 0));
		...
		registerHiddenRoad(id++, GOTWaypoint.HornHill, GOTWaypoint.HornHill.info(0, 0.5));
		...
		registerHiddenRoad(id++, GOTWaypoint.RamsGate, GOTWaypoint.RamsGate.info(0.5, 0));
		registerHiddenRoad(id++, GOTWaypoint.RillwaterCrossing, GOTWaypoint.RillwaterCrossing.info(0, -0.5));
		registerHiddenRoad(id++, GOTWaypoint.RisvellsCastle, GOTWaypoint.RisvellsCastle.info(0, 0.5));
		...
		registerHiddenRoad(id++, GOTWaypoint.TorhensSquare, GOTWaypoint.TorhensSquare.info(-0.5, 0));
		registerHiddenRoad(id++, GOTWaypoint.BlackPool, GOTWaypoint.BlackPool.info(0, 0.5));
		registerHiddenRoad(id++, GOTWaypoint.Tumbleton, GOTWaypoint.Tumbleton.info(0, -0.9));
		registerHiddenRoad(id++, GOTWaypoint.Vaibei, GOTWaypoint.Vaibei.info(-1, 0));
		...
		registerHiddenRoad(id++, GOTWaypoint.Yunkai, GOTWaypoint.Meereen.info(-9, 55));
		...
		registerHiddenRoad(id++, GOTWaypoint.Karhold, GOTWaypoint.Karhold.info(1, 0));
	}
