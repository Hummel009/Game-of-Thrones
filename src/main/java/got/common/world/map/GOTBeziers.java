...
public class GOTBeziers {
	...
	public static void onInit() {
		...
		registerLinker(GOTWaypoint.APPLETON.info(-0.1, toWesterosCastle(-0.5)), false);
		registerLinker(GOTWaypoint.APPLETON.info(0.3, toWesterosTown(1.0)), false);
		registerLinker(GOTWaypoint.WINTERFELL.info(toWesterosCastle(-0.45), -0.1), true);
		registerLinker(GOTWaypoint.CASTERLY_ROCK.info(toWesterosCastle(-0.45), 0));
		registerLinker(GOTWaypoint.CRAKEHALL.info(toWesterosCastle(-0.45), -0.1), true);
		...
		registerLinker(GOTWaypoint.DREADFORT.info(0, toWesterosCastle(-0.45)));
		...
		registerLinker(GOTWaypoint.DUSKENDALE.info(-0.3, toWesterosTown(-1.0)), false);
		...
		registerLinker(GOTWaypoint.OLD_OAK.info(0, toWesterosCastle(0.4)));
		registerLinker(GOTWaypoint.RED_LAKE.info(0, toWesterosCastle(0.45)));
		registerLinker(GOTWaypoint.COLDMOAT.info(0, toWesterosCastle(0.45)));
		registerLinker(GOTWaypoint.BITTERBRIDGE.info(0, toWesterosCastle(0.45)));
		...
		registerLinker(GOTWaypoint.RING.info(0, toWesterosCastle(-0.4)));
		...
		registerLinker(GOTWaypoint.HAMMERHAL.info(toWesterosCastle(0.45), -0.1), true);
		registerLinker(GOTWaypoint.HOLYHALL.info(toWesterosCastle(0.45), 0));
