...
public class GOTBeziers {
	...
	public static void onInit() {
		...
		registerRoad(id++, GOTWaypoint.Bronzegate, GOTWaypoint.Bronzegate.info(1, 0));
		registerRoad(id++, GOTWaypoint.CasterlyRock, GOTWaypoint.Lannisport);
		registerRoad(id++, GOTWaypoint.CasterlyRock, GOTWaypoint.CasterlyRock.info(-1, 0));
		...
		registerRoad(id++, GOTWaypoint.Crakehall, GOTWaypoint.Crakehall.info(-1, 0));
		...
		registerRoad(id++, GOTWaypoint.Darry, GOTWaypoint.Darry.info(1, 0));
		registerRoad(id++, GOTWaypoint.Duskendale, GOTWaypoint.Duskendale.info(-2, 0));
		...
		registerRoad(id++, GOTWaypoint.Felwood, GOTWaypoint.Felwood.info(0, 1));
		...
		registerRoad(id++, GOTWaypoint.GateOfTheMoon, GOTWaypoint.GateOfTheMoon.info(0, 1));
		registerRoad(id++, GOTWaypoint.GoldenTooth, GOTWaypoint.GoldenTooth.info(0, 1));
		registerRoad(id++, GOTWaypoint.Goldgrass, GOTWaypoint.Goldgrass.info(0, 1));
		...
		registerRoad(id++, GOTWaypoint.Hayford, GOTWaypoint.Hayford.info(-1, 0));
		...
		registerRoad(id++, GOTWaypoint.Kingsgrave, GOTWaypoint.Kingsgrave.info(-1, 0));
		...
		registerRoad(id++, GOTWaypoint.Lannisport, GOTWaypoint.Lannisport.info(-1, 0));
		...
		registerRoad(id++, GOTWaypoint.Nightsong, GOTWaypoint.Nightsong.info(0, 1));
		...
		registerRoad(id++, GOTWaypoint.RamsGate, GOTWaypoint.RamsGate.info(-1, 0));
		registerRoad(id++, GOTWaypoint.Rhyos, GOTWaypoint.Oros);
		registerRoad(id++, GOTWaypoint.RillwaterCrossing, GOTWaypoint.RillwaterCrossing.info(0, 1));
		registerRoad(id++, GOTWaypoint.RisvellsCastle, GOTWaypoint.RisvellsCastle.info(0, 1));
		registerRoad(id++, GOTWaypoint.Riverrun, GOTWaypoint.Riverrun.info(1, 0));
		registerRoad(id++, GOTWaypoint.RooksRest, GOTWaypoint.RooksRest.info(0, 1));
		...
		registerRoad(id++, GOTWaypoint.Starfall, GOTWaypoint.Starfall.info(0, -1));
		registerRoad(id++, GOTWaypoint.StoneHedge, GOTWaypoint.StoneHedge.info(0, 1));
		registerRoad(id++, GOTWaypoint.StormsEnd, GOTWaypoint.StormsEnd.info(0, -1));
		...
		registerRoad(id++, GOTWaypoint.TheEyrie.info(0, 1), GOTWaypoint.GateOfTheMoon, GOTWaypoint.BloodyGate, GOTWaypoint.CrossroadsInn);
		registerRoad(id++, GOTWaypoint.TheEyrie.info(0, 1), GOTWaypoint.TheEyrie);
		registerRoad(id++, GOTWaypoint.BloodyGate.info(0, -1), GOTWaypoint.BloodyGate);
		...
		registerRoad(id++, GOTWaypoint.TorhensSquare, GOTWaypoint.BlackPool.info(-1, 0));
		...
		registerRoad(id++, GOTWaypoint.Wyl, GOTWaypoint.Wyl.info(0, -1));
		...
		registerRoad(id++, GOTWaypoint.Yronwood, GOTWaypoint.Yronwood.info(1, 0));
		...
		registerRoad(id++, GOTWaypoint.RillwaterCrossing.info(0, 1), GOTWaypoint.RisvellsCastle, GOTWaypoint.Barrowtown);
		registerRoad(id++, GOTWaypoint.Seagard.info(0, -1), GOTWaypoint.Seagard.info(0, 1));
		registerRoad(id++, GOTWaypoint.StormsEnd.info(0, -1), GOTWaypoint.Bronzegate, GOTWaypoint.Felwood, GOTWaypoint.KingsLanding.info(5, 28));
		registerRoad(id++, GOTWaypoint.TwinsRight.info(41, -19), new double[]{655, 1331}, GOTWaypoint.CrossroadsInn);
		registerRoad(id++, GOTWaypoint.WhiteHarbour.info(-9, 0), GOTWaypoint.WhiteHarbour);
