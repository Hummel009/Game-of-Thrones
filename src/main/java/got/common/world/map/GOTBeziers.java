...
public class GOTBeziers {
	...
	public static void onInit() {
		...
		registerLinker(GOTWaypoint.WHITE_HARBOUR.info(toWesterosTown(0.75), 0));
		...
		registerLinker(GOTWaypoint.SALTPANS.info(toWesterosTown(0.75), 0));
		...
		registerLinker(GOTWaypoint.STONEY_SEPT.info(toWesterosTown(-0.75), 0));
		...
		registerLinker(GOTWaypoint.IVY_HALL.info(0, toWesterosCastle(0.4)));
