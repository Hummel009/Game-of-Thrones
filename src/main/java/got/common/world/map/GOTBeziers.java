...
import static got.common.world.map.GOTCoordConerter.*;
...
public class GOTBeziers {
	...
	public static void onInit() {
		...
		registerLinker(GOTWaypoint.CasterlyRock.info(toWesterosCastle(-0.5), 0));
		...
		registerLinker(GOTWaypoint.ServinsCastle.info(toWesterosCastle(-0.5), 0));
		...
		registerLinker(GOTWaypoint.WhiteHarbour.info(toWesterosTown(0.9), 0));
		registerLinker(GOTWaypoint.TorhensSquare.info(0, toWesterosCastle(-0.5)));
		registerLinker(GOTWaypoint.RillwaterCrossing.info(toWesterosCastle(-0.5), 0));
		registerLinker(GOTWaypoint.RyswellsCastle.info(toWesterosCastle(-0.5), 0));
		...
		registerLinker(GOTWaypoint.StoneHedge.info(0, toWesterosCastle(-0.5)));
		registerLinker(GOTWaypoint.AcornHall.info(toWesterosCastle(-0.5), 0));
		registerLinker(GOTWaypoint.WayfarerRest.info(toWesterosCastle(-0.5), 0));
		registerLinker(GOTWaypoint.Riverrun.info(0, toWesterosCastle(-0.5)));
		registerLinker(GOTWaypoint.StoneySept.info(toWesterosTown(-0.9), 0));
		registerLinker(GOTWaypoint.BloodyGate.info(0, toWesterosCastle(-0.5)));
		registerLinker(GOTWaypoint.TheEyrie.info(0, toWesterosCastle(-0.5)));
		registerLinker(GOTWaypoint.GateOfTheMoon.info(toWesterosCastle(0.5), 0));
		registerLinker(GOTWaypoint.Hayford.info(0, toWesterosCastle(-0.5)));
		registerLinker(GOTWaypoint.RooksRest.info(0, toWesterosCastle(-0.5)));
		registerLinker(GOTWaypoint.Antlers.info(0, toWesterosCastle(-0.5)));
		registerLinker(GOTWaypoint.Stokeworth.info(toWesterosCastle(-0.5), 0));
		registerLinker(GOTWaypoint.Rosby.info(toWesterosCastle(-0.5) - 0.05, 0));
		...
		registerLinker(GOTWaypoint.GoldenTooth.info(0, toWesterosCastle(-0.5) - 0.02));
		registerLinker(GOTWaypoint.Sarsfield.info(0, toWesterosCastle(-0.5)));
		registerLinker(GOTWaypoint.OldOak.info(0, toWesterosCastle(0.5)));
		registerLinker(GOTWaypoint.RedLake.info(0, toWesterosCastle(0.5)));
		...
		registerLinker(GOTWaypoint.IvyHall.info(0, toWesterosCastle(0.5)));
		...
		registerLinker(GOTWaypoint.HaystackHall.info(0, toWesterosCastle(-0.5)));
		...
		registerLinker(GOTWaypoint.HarvestHall.info(0, toWesterosCastle(-0.5)));
		registerLinker(GOTWaypoint.Nightsong.info(0, toWesterosCastle(-0.5)));
		registerLinker(GOTWaypoint.StormsEnd.info(0, toWesterosCastle(0.5)));
		...
		registerLinker(GOTWaypoint.HighHermitage.info(toWesterosCastle(0.5), 0));
		...
		registerLinker(GOTWaypoint.VolonTherys.info(0, toEssosTown(0.5)));
		registerLinker(GOTWaypoint.LittleValyria.info(0.26, toEssosTown(0.5) + 0.1));
		registerLinker(GOTWaypoint.Tolos.info(0, toEssosTown(0.5)));
		registerLinker(GOTWaypoint.Meereen.info(0, toEssosTown(-0.5)));
		registerLinker(GOTWaypoint.PortYhos.info(0, toEssosTown(0.5)));
		...
		registerLinker(GOTWaypoint.TraderTown.info(0, toYiTiTown(-1.0)));
		...
		registerLinker(GOTWaypoint.SiQo.info(toYiTiTown(1.0), 0));
		...
		registerLinker(GOTWaypoint.FuNing.info(toYiTiTown(1.0) + 0.1, 0.1));
	}
