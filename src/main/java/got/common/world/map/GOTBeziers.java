...
public class GOTBeziers {
	...
	public static void onInit() {
		...
		registerBezier(Type.LINKER, GOTWaypoint.Seagard.info(0, -westerosCastle - 0.2), GOTWaypoint.Seagard.info(0, westerosTown));
		registerBezier(Type.LINKER, GOTWaypoint.Appleton, GOTWaypoint.Appleton.info(0, -westerosCastle - 0.01));
		registerBezier(Type.LINKER, GOTWaypoint.Appleton, GOTWaypoint.Appleton.info(0.1, westerosTown + 0.2));
		registerBezier(Type.LINKER, GOTWaypoint.Winterfell, GOTWaypoint.Winterfell.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.CasterlyRock, GOTWaypoint.CasterlyRock.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Crakehall, GOTWaypoint.Crakehall.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Lannisport, GOTWaypoint.Lannisport.info(-westerosTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.ServinsCastle, GOTWaypoint.ServinsCastle.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Dreadfort, GOTWaypoint.Dreadfort.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.Goldgrass, GOTWaypoint.Goldgrass.info(0, westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.Karhold, GOTWaypoint.Karhold.info(westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.WhiteHarbour, GOTWaypoint.WhiteHarbour.info(westerosTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.TorhensSquare, GOTWaypoint.TorhensSquare.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.RillwaterCrossing, GOTWaypoint.RillwaterCrossing.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.RyswellsCastle, GOTWaypoint.RyswellsCastle.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Saltpans, GOTWaypoint.Saltpans.info(westerosTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Harroway, GOTWaypoint.Harroway.info(0, westerosTown));
		registerBezier(Type.LINKER, GOTWaypoint.StoneHedge, GOTWaypoint.StoneHedge.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.AcornHall, GOTWaypoint.AcornHall.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.WayfarerRest, GOTWaypoint.WayfarerRest.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Riverrun, GOTWaypoint.Riverrun.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.StoneySept, GOTWaypoint.StoneySept.info(-westerosTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.BloodyGate, GOTWaypoint.BloodyGate.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.TheEyrie, GOTWaypoint.TheEyrie.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.GateOfTheMoon, GOTWaypoint.GateOfTheMoon.info(westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Hayford, GOTWaypoint.Hayford.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.RooksRest, GOTWaypoint.RooksRest.info(0, -westerosCastle));
		...
		registerBezier(Type.LINKER, GOTWaypoint.OldOak, GOTWaypoint.OldOak.info(0, westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.RedLake, GOTWaypoint.RedLake.info(0, westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.Coldmoat, GOTWaypoint.Coldmoat.info(0, westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.Bitterbridge, GOTWaypoint.Bitterbridge.info(0, westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.IvyHall, GOTWaypoint.IvyHall.info(0, westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.SunHouse, GOTWaypoint.SunHouse.info(0, westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.Ring, GOTWaypoint.Ring.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.Tumbleton, GOTWaypoint.Tumbleton.info(0, -westerosTown - 0.1));
		registerBezier(Type.LINKER, GOTWaypoint.Whitegrove, GOTWaypoint.Whitegrove.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.GarnetGrove, GOTWaypoint.GarnetGrove.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.DarkDell, GOTWaypoint.DarkDell.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Hammerhal, GOTWaypoint.Hammerhal.info(westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Holyhall, GOTWaypoint.Holyhall.info(westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Highgarden, GOTWaypoint.Highgarden.info(0.5, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Smithyton, GOTWaypoint.Smithyton.info(0, westerosTown));
		registerBezier(Type.LINKER, GOTWaypoint.Oldtown, GOTWaypoint.Oldtown.info(-westerosTown - 0.2, 0));
		registerBezier(Type.LINKER, GOTWaypoint.ThreeTowers, GOTWaypoint.ThreeTowers.info(-0.5, -0.5));
		registerBezier(Type.LINKER, GOTWaypoint.ThreeTowers, GOTWaypoint.ThreeTowers.info(-0.5, 0));
		registerBezier(Type.LINKER, GOTWaypoint.ThreeTowers, GOTWaypoint.ThreeTowers.info(-0.5, 0.5));
		registerBezier(Type.LINKER, GOTWaypoint.Grandview, GOTWaypoint.Grandview.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Blackhaven, GOTWaypoint.Blackhaven.info(-westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Felwood, GOTWaypoint.Felwood.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.HaystackHall, GOTWaypoint.HaystackHall.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.Gallowsgrey, GOTWaypoint.Gallowsgrey.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.Parchments, GOTWaypoint.Parchments.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.Bronzegate, GOTWaypoint.Bronzegate.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.Poddingfield, GOTWaypoint.Poddingfield.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.HarvestHall, GOTWaypoint.HarvestHall.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.Nightsong, GOTWaypoint.Nightsong.info(0, -westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.StormsEnd, GOTWaypoint.StormsEnd.info(0, westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.SkyReach, GOTWaypoint.SkyReach.info(0, westerosCastle));
		registerBezier(Type.LINKER, GOTWaypoint.Starfall, GOTWaypoint.Starfall.info(0, westerosCastle + 0.1));
		registerBezier(Type.LINKER, GOTWaypoint.HighHermitage, GOTWaypoint.HighHermitage.info(westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Blackmont, GOTWaypoint.Blackmont.info(westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Kingsgrave, GOTWaypoint.Kingsgrave.info(westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Yronwood, GOTWaypoint.Yronwood.info(westerosCastle, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Wyl, GOTWaypoint.Wyl.info(-westerosCastle - 0.05, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Zamettar, GOTWaypoint.Zamettar.info(0, -0.125));

		double essosTown = 0.1484375;

		registerBezier(Type.LINKER, GOTWaypoint.Braavos, GOTWaypoint.Braavos.info(0, -essosTown));
		registerBezier(Type.LINKER, GOTWaypoint.Norvos, GOTWaypoint.Norvos.info(0, -essosTown));
		registerBezier(Type.LINKER, GOTWaypoint.Mantarys, GOTWaypoint.Mantarys.info(0, -essosTown));
		registerBezier(Type.LINKER, GOTWaypoint.VolonTherys, GOTWaypoint.VolonTherys.info(0, essosTown));
		registerBezier(Type.LINKER, GOTWaypoint.LittleValyria, GOTWaypoint.LittleValyria.info(0.26, essosTown + 0.1));
		registerBezier(Type.LINKER, GOTWaypoint.Tolos, GOTWaypoint.Tolos.info(0, essosTown));
		registerBezier(Type.LINKER, GOTWaypoint.Meereen, GOTWaypoint.Meereen.info(0, -essosTown));
		registerBezier(Type.LINKER, GOTWaypoint.PortYhos, GOTWaypoint.PortYhos.info(0, essosTown));
		registerBezier(Type.LINKER, GOTWaypoint.Qarkash, GOTWaypoint.Qarkash.info(0, essosTown));
		registerBezier(Type.LINKER, GOTWaypoint.Qarth, GOTWaypoint.Qarth.info(0, essosTown));
		registerBezier(Type.LINKER, GOTWaypoint.Volantis, GOTWaypoint.Volantis.info(-0.2, essosTown + 0.1));
		registerBezier(Type.LINKER, GOTWaypoint.Pentos, GOTWaypoint.Pentos.info(-essosTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Myr, GOTWaypoint.Myr.info(-essosTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Qohor, GOTWaypoint.Qohor.info(-essosTown - 0.1, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Selhorys, GOTWaypoint.Selhorys.info(-essosTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Valysar, GOTWaypoint.Valysar.info(-essosTown - 0.1, 0.25));
		registerBezier(Type.LINKER, GOTWaypoint.Yunkai, GOTWaypoint.Yunkai.info(-essosTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Astapor, GOTWaypoint.Astapor.info(-essosTown, 0));

		registerBezier(Type.LINKER, GOTWaypoint.Kosrak, GOTWaypoint.Kosrak.info(1, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Lhazosh, GOTWaypoint.Lhazosh.info(1, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Hesh, GOTWaypoint.Hesh.info(1, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Asshai, GOTWaypoint.Asshai.info(0, westerosTown - 0.1));

		double yitiTown = 0.2734375;

		registerBezier(Type.LINKER, GOTWaypoint.TraderTown, GOTWaypoint.TraderTown.info(0, -yitiTown));
		registerBezier(Type.LINKER, GOTWaypoint.Yibin, GOTWaypoint.Yibin.info(0, -yitiTown));
		registerBezier(Type.LINKER, GOTWaypoint.Vaibei, GOTWaypoint.Vaibei.info(0, -yitiTown));
		registerBezier(Type.LINKER, GOTWaypoint.Baoji, GOTWaypoint.Baoji.info(0, -yitiTown));
		registerBezier(Type.LINKER, GOTWaypoint.Eijiang, GOTWaypoint.Eijiang.info(0, yitiTown));
		registerBezier(Type.LINKER, GOTWaypoint.Yin, GOTWaypoint.Yin.info(0, yitiTown));
		registerBezier(Type.LINKER, GOTWaypoint.Jinqi, GOTWaypoint.Jinqi.info(-yitiTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Asabhad, GOTWaypoint.Asabhad.info(-yitiTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.SiQo, GOTWaypoint.SiQo.info(yitiTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Yunnan, GOTWaypoint.Yunnan.info(yitiTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Manjin, GOTWaypoint.Manjin.info(yitiTown + 0.1, -0.2));
		registerBezier(Type.LINKER, GOTWaypoint.Lizhao, GOTWaypoint.Lizhao.info(yitiTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.Tiqui, GOTWaypoint.Tiqui.info(0, -yitiTown));
		registerBezier(Type.LINKER, GOTWaypoint.Changan, GOTWaypoint.Changan.info(yitiTown, 0));
		registerBezier(Type.LINKER, GOTWaypoint.FuNing, GOTWaypoint.FuNing.info(yitiTown + 0.1, 0.1));
	}
