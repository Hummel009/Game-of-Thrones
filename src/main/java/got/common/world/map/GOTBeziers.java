...
public class GOTBeziers {
	...
	public static void onInit() {
		...
		registerWall(id++, new int[]{2847, 1273}, new int[]{2820, 1292}, new int[]{2771, 1308}, new int[]{2732, 1308});
		registerWall(id++, new int[]{2732, 1308}, new int[]{2683, 1294}, new int[]{2628, 1294}, new int[]{2588, 1275});
		registerWall(id++, new int[]{2708, 1230}, new int[]{2683, 1244}, new int[]{2656, 1253}, new int[]{2638, 1252});

		registerHiddenRoad(id++, new int[]{559, 544}, new int[]{596, 544});
		...
		registerRoad(id++, GOTWaypoint.Asabhad, new int[]{3143, 2263}, new int[]{3190, 2276}, GOTWaypoint.SiQo);
		...
		registerRoad(id++, GOTWaypoint.Baoji, new int[]{3476, 2218}, new int[]{3454, 2212}, GOTWaypoint.Manjin);
		registerRoad(id++, GOTWaypoint.Baoji, new int[]{3554, 2181}, new int[]{3613, 2167}, GOTWaypoint.Lizhao);
		registerRoad(id++, GOTWaypoint.Baoji, new int[]{3570, 2227}, new int[]{3611, 2256}, new int[]{3634, 2281});
		registerRoad(id++, GOTWaypoint.Barrowtown, GOTWaypoint.Goldgrass);
		registerRoad(id++, GOTWaypoint.Bayasabhad, new int[]{3134, 2098}, new int[]{3132, 2128}, GOTWaypoint.Eijiang);
		...
		registerRoad(id++, GOTWaypoint.Braavos, new int[]{1174, 1274}, new int[]{1194, 1300}, new int[]{1208, 1335});
		...
		registerRoad(id++, GOTWaypoint.FiveForts1, GOTWaypoint.FiveForts2);
		registerRoad(id++, GOTWaypoint.FiveForts1, new int[]{3687, 1921}, new int[]{3600, 1973}, GOTWaypoint.Vaibei);
		...
		registerRoad(id++, GOTWaypoint.FiveForts5, new int[]{3797, 2008}, new int[]{3732, 2063}, GOTWaypoint.Yibin);
		registerRoad(id++, GOTWaypoint.GarnetGrove, near(GOTWaypoint.GarnetGrove, -1, 0));
		registerRoad(id++, GOTWaypoint.GarnetGrove, new int[]{379, 2023}, new int[]{397, 2045}, GOTWaypoint.SunHouse);
		...
		registerRoad(id++, GOTWaypoint.KrazaajHas, new int[]{2430, 1900}, GOTWaypoint.Hesh, GOTWaypoint.Lhazosh, new int[]{2447, 2138}, GOTWaypoint.VaesOrvik);
		registerRoad(id++, GOTWaypoint.Lannisport, near(GOTWaypoint.Lannisport, -1, 0));
		registerRoad(id++, GOTWaypoint.Lannisport, new int[]{371, 1622}, GOTWaypoint.Crakehall);
		registerRoad(id++, GOTWaypoint.Lannisport, new int[]{477, 1572}, new int[]{526, 1598}, new int[]{570, 1625}, new int[]{656, 1606}, new int[]{710, 1633}, GOTWaypoint.KingsLanding);
		registerRoad(id++, GOTWaypoint.Lhazosh, new int[]{2498, 1977}, GOTWaypoint.Kosrak);
		...
		registerRoad(id++, GOTWaypoint.Mantarys, new int[]{1831, 2092}, GOTWaypoint.Oros);
		registerRoad(id++, GOTWaypoint.Meereen, GOTWaypoint.KrazaajHas);
		registerRoad(id++, GOTWaypoint.Meereen, new int[]{2243, 1928}, new int[]{2183, 1928}, GOTWaypoint.Bhorash);
		registerRoad(id++, GOTWaypoint.Meereen, near(GOTWaypoint.Meereen, -9, 55), new int[]{2219, 2124}, GOTWaypoint.Astapor);
		registerRoad(id++, GOTWaypoint.Moletown, new int[]{747, 742}, new int[]{711, 783}, new int[]{672, 826}, near(GOTWaypoint.Winterfell, 0, -1));
		registerRoad(id++, GOTWaypoint.Myr, new int[]{1338, 1874}, GOTWaypoint.Chroyane);
		...
		registerRoad(id++, GOTWaypoint.OldOak, new int[]{438, 1773}, GOTWaypoint.Highgarden);
		registerRoad(id++, GOTWaypoint.Oldtown, near(GOTWaypoint.Oldtown, -1, 0));
		registerRoad(id++, GOTWaypoint.Oldtown, new int[]{393, 1966}, new int[]{377, 1988}, near(GOTWaypoint.ThreeTowers1, 1, 0));
		...
		registerRoad(id++, GOTWaypoint.SarMell, new int[]{1559, 2045}, GOTWaypoint.Volantis);
		...
		registerRoad(id++, GOTWaypoint.SunHouse, new int[]{450, 2033}, new int[]{471, 2025}, GOTWaypoint.Starfall);
		...
		registerRoad(id++, near(GOTWaypoint.ThreeTowers1, 1, 0), new int[]{353, 2005}, GOTWaypoint.GarnetGrove);
		registerRoad(id++, GOTWaypoint.Tiqui, near(GOTWaypoint.Tiqui, 0, -1));
		registerRoad(id++, GOTWaypoint.Tiqui, new int[]{3240, 2114}, new int[]{3193, 2134}, GOTWaypoint.Eijiang);
		registerRoad(id++, GOTWaypoint.Tiqui, new int[]{3374, 2123}, new int[]{3425, 2147}, GOTWaypoint.Manjin);
		...
		registerRoad(id++, GOTWaypoint.TraderTown, new int[]{3411, 1920}, new int[]{3473, 1951}, near(GOTWaypoint.Vaibei, -1, 0));
		...
		registerRoad(id++, GOTWaypoint.VaesMejhah, GOTWaypoint.VaesJini, GOTWaypoint.Samyriana, new int[]{3219, 1895}, GOTWaypoint.TraderTown);
		...
		registerRoad(id++, GOTWaypoint.Yibin, GOTWaypoint.Lizhao, new int[]{3679, 2188}, new int[]{3655, 2241}, new int[]{3634, 2281});
		registerRoad(id++, GOTWaypoint.Yibin, near(GOTWaypoint.Yibin, -1, 0));
		registerRoad(id++, GOTWaypoint.Yibin, new int[]{3622, 2031}, new int[]{3560, 2023}, GOTWaypoint.Vaibei);
		...
		registerRoad(id++, GOTWaypoint.Yronwood, new int[]{680, 1953}, GOTWaypoint.Wyl, GOTWaypoint.Blackhaven, GOTWaypoint.Summerhall, GOTWaypoint.Bronzegate);
		...
		registerRoad(id++, GOTWaypoint.Zamettar, new int[]{2150, 2793}, GOTWaypoint.Yeen);
		...
		registerRoad(id++, near(GOTWaypoint.Dreadfort, 1, 0), new int[]{879, 840}, GOTWaypoint.Karhold);
		...
		registerRoad(id++, near(GOTWaypoint.MoatKailin, 0, 1), new int[]{656, 1217}, near(GOTWaypoint.TwinsRight, 41, -19), GOTWaypoint.TwinsRight);
		registerRoad(id++, near(GOTWaypoint.MoatKailin, 1, 0), new int[]{685, 1110}, near(GOTWaypoint.WhiteHarbour, -9, 0));
		...
		registerRoad(id++, near(GOTWaypoint.TwinsRight, 41, -19), new int[]{655, 1331}, GOTWaypoint.CrossroadsInn);
		...
		registerRoad(id++, near(GOTWaypoint.Winterfell, 0, 1), GOTWaypoint.ServinsCastle, new int[]{628, 973}, near(GOTWaypoint.MoatKailin, 0, -1));
		registerRoad(id++, new int[]{1251, 1464}, new int[]{1246, 1424}, new int[]{1227, 1388}, new int[]{1208, 1335});
		registerRoad(id++, new int[]{1251, 1464}, new int[]{1267, 1498}, new int[]{1314, 1535}, GOTWaypoint.GhoyanDrohe);
		registerRoad(id++, new int[]{2723, 2245}, GOTWaypoint.Qarkash);
		registerRoad(id++, new int[]{2723, 2245}, new int[]{2687, 2231}, new int[]{2626, 2258}, GOTWaypoint.PortYhos);
		registerRoad(id++, new int[]{2723, 2245}, new int[]{2763, 2273}, new int[]{2834, 2268}, GOTWaypoint.Qarth);
		registerRoad(id++, new int[]{2995, 2293}, new int[]{2972, 2274}, new int[]{2931, 2262}, GOTWaypoint.Qarth);
		registerRoad(id++, new int[]{2995, 2293}, new int[]{3034, 2243}, new int[]{3081, 2240}, GOTWaypoint.Asabhad);
		registerRoad(id++, new int[]{3081, 2240}, new int[]{3088, 2202}, new int[]{3093, 2162}, GOTWaypoint.Eijiang);
		registerRoad(id++, new int[]{3634, 2281}, new int[]{3688, 2321}, new int[]{3756, 2321}, GOTWaypoint.Yunnan);
	}
