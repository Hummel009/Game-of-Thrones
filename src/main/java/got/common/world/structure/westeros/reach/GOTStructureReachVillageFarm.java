...
public abstract class GOTStructureReachVillageFarm extends GOTStructureReachBase {
	...
	public static class Animals extends GOTStructureReachVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < animals; ++l) {
				EntityAnimal animal = GOTStructureReachBarn.getRandomAnimal(world, random);
	...
	public static class Crops extends GOTStructureReachVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < farmhands; ++l) {
				GOTEntityReachFarmhand farmhand = new GOTEntityReachFarmhand(world);
	...
	public static class Tree extends GOTStructureReachVillageFarm {
