...
public class GOTStructureReachCity extends GOTVillageGen {
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTStructureReachCity village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void setupCastle(Random random) {
			...
			this.addStructure(new GOTStructureReachVillageFarm.Crops(false), -18, -21, 1);
			this.addStructure(new GOTStructureReachVillageFarm.Crops(false), 18, -21, 3);
