...
public class GOTStructureWesterlandsTavern extends GOTStructureWesterlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityWesterlandsBartender bartender = new GOTEntityWesterlandsBartender(world);
