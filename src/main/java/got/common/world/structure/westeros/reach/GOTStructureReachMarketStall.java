...
public abstract class GOTStructureReachMarketStall extends GOTStructureReachBase {
	...
	public abstract GOTEntityReachMan createTrader(World var1);
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setBlockAndMetadata(world, -1, 1, -1, GOTRegistry.tableReach, 0);
		setBlockAndMetadata(world, 1, 1, -1, Blocks.chest, 3);
		GOTEntityReachMan trader = createTrader(world);
