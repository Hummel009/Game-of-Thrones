...
public class GOTStructureRiverlandsTavern extends GOTStructureRiverlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityRiverlandsBartender bartender = new GOTEntityRiverlandsBartender(world);
