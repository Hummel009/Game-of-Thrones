...
public class GOTStructureStormlandsTower extends GOTStructureStormlandsBase {
	...
	public boolean generateAndHeight(World world, Random random, int i, int j, int k, int rotation, int height) {
		...
		if (generateRoom) {
			...
			setBlockAndMetadata(world, 1, doorBase + 1, -1, GOTRegistry.tableStormlands, 0);
			placeWallBanner(world, 2, doorBase + 4, -1, GOTItemBanner.BannerType.RENLY, 3);
		...
		respawner.setSpawnClass(GOTEntityStormlandsSoldierArcher.class);
