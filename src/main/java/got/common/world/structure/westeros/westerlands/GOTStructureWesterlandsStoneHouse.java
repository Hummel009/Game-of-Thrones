...
public class GOTStructureWesterlandsStoneHouse extends GOTStructureWesterlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 3, 5, GOTItemBanner.BannerType.LANNISTER, 2);
		...
		GOTEntityWesterlandsMan male = new GOTEntityWesterlandsMan(world);
		male.familyInfo.setMale(true);
		male.setCurrentItemOrArmor(4, new ItemStack(GOTRegistry.goldRing));
		spawnNPCAndSetHome(male, world, 0, 1, 0, 16);
		GOTEntityWesterlandsMan female = new GOTEntityWesterlandsMan(world);
		...
		GOTEntityWesterlandsMan child = new GOTEntityWesterlandsMan(world);
