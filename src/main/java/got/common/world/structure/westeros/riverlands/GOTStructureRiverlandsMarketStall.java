...
public abstract class GOTStructureRiverlandsMarketStall extends GOTStructureRiverlandsBase {
	...
	public GOTStructureRiverlandsMarketStall(boolean flag) {
		super(flag);
	}

	public abstract GOTEntityRiverlandsMan createTrader(World var1);
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setBlockAndMetadata(world, -1, 1, -1, GOTRegistry.tableRiverlands, 0);
		setBlockAndMetadata(world, 1, 1, -1, Blocks.chest, 3);
		GOTEntityRiverlandsMan trader = createTrader(world);
	...
	public static class Greengrocer extends GOTStructureRiverlandsMarketStall {
		...
		@Override
		public GOTEntityRiverlandsMan createTrader(World world) {
			return new GOTEntityRiverlandsGreengrocer(world);
		}
