...
public abstract class GOTStructureRiverlandsVillageFarm extends GOTStructureRiverlandsBase {
	...
	public static class Animals extends GOTStructureRiverlandsVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < animals; ++l) {
				EntityAnimal animal = GOTStructureRiverlandsBarn.getRandomAnimal(world, random);
	...
	public static class Crops extends GOTStructureRiverlandsVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < farmhands; ++l) {
				GOTEntityRiverlandsFarmhand farmhand = new GOTEntityRiverlandsFarmhand(world);
	...
	public static class Tree extends GOTStructureRiverlandsVillageFarm {
