...
public class GOTStructureDorneStoneHouse extends GOTStructureDorneBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 3, 5, GOTItemBanner.BannerType.MARTELL, 2);
		...
		for (int k13 : new int[] { -4, 5 }) {
			...
			setBlockAndMetadata(world, 0, 6, k13, GOTRegistry.brick3, 8);
		}
		...
		GOTEntityDorneMan child = new GOTEntityDorneMan(world);
