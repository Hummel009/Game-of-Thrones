...
public class GOTStructureReachSettlement extends GOTStructureBaseSettlement {
	...
	@Override
	public GOTStructureBaseSettlement.AbstractInstance<GOTStructureReachSettlement> createSettlementInstance(World world, int i, int k, Random random, LocationInfo loc, Runnable filler, Collection<GOTFixer.SpawnInfo> spawnInfos) {
	...
	public static class Instance extends GOTStructureBaseSettlement.AbstractInstance<GOTStructureReachSettlement> {
		...
		public Instance(GOTStructureReachSettlement settlement, World world, int i, int k, Random random, LocationInfo loc, Runnable filler, Collection<GOTFixer.SpawnInfo> spawnInfos, Type t, boolean b) {
