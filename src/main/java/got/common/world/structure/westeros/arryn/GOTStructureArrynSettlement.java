...
public class GOTStructureArrynSettlement extends GOTStructureBaseSettlement {
	...
	public GOTStructureArrynSettlement setIsCastle() {
		isCastle = true;
	...
	public GOTStructureArrynSettlement setIsTown() {
		isTown = true;
		settlementChunkRadius = 6;
		fixedSettlementChunkRadius = 6;
		return this;
	...
	public class Instance extends GOTStructureBaseSettlement.AbstractInstance<GOTStructureArrynSettlement> {
		public Type type;

		public Instance(GOTStructureArrynSettlement settlement, World world, int i, int k, Random random, LocationInfo loc) {
