...
import got.common.world.structure.westeros.ironborn.GOTStructureIronborn.*;
...
public class GOTStructureIronbornCity extends GOTVillageGen {
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public void setupCastle(Random random) {
			...
			this.addStructure(new GOTStructureIronbornVillageFarm.Crops(false), -18, -21, 1);
			this.addStructure(new GOTStructureIronbornVillageFarm.Crops(false), 18, -21, 3);
