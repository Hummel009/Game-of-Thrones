...
public class GOTStructureReachWatchfort extends GOTStructureReachBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 7, -5, GOTItemBanner.BannerType.TYRELL, 2);
		for (i1 = -1; i1 <= 1; ++i1) {
			for (k12 = -7; k12 <= -6; ++k12) {
		...
		this.placeBanner(world, -2, 14, 11, GOTItemBanner.BannerType.TYRELL, 3);
		this.placeBanner(world, 2, 14, 11, GOTItemBanner.BannerType.TYRELL, 1);
		this.placeBanner(world, -2, 14, 23, GOTItemBanner.BannerType.TYRELL, 3);
		this.placeBanner(world, 2, 14, 23, GOTItemBanner.BannerType.TYRELL, 1);
		...
		setBlockAndMetadata(world, 2, 14, 18, Blocks.torch, 3);
		GOTStructureReachTower beaconTower = new GOTStructureReachTower(notifyChanges);
		...
		setAir(world, 1, 12, 29);
		GOTEntityReachSoldier soldier = new GOTEntityReachSoldier(world);
		soldier.spawnRidingHorse = false;
		spawnNPCAndSetHome(soldier, world, 0, 2, -3, 32);
		GOTEntityReachCaptain captain = new GOTEntityReachCaptain(world);
		captain.spawnRidingHorse = false;
		spawnNPCAndSetHome(captain, world, 0, 15, 0, 8);
		GOTEntityNPCRespawner respawner = new GOTEntityNPCRespawner(world);
		respawner.setSpawnClasses(GOTEntityReachSoldier.class, GOTEntityReachSoldierArcher.class);
