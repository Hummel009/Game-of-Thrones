...
public class GOTStructureIronbornTavern extends GOTStructureIronbornBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityIronbornBartender bartender = new GOTEntityIronbornBartender(world);
		...
		for (int l = 0; l < men; ++l) {
			GOTEntityIronbornMan westerosman = new GOTEntityIronbornMan(world);
