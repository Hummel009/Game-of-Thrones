...
public class GOTStructureStormlandsSettlement extends GOTStructureBaseSettlement {
	...
	@Override
	public GOTStructureBaseSettlement.AbstractInstance<GOTStructureStormlandsSettlement> createSettlementInstance(World world, int i, int k, Random random, LocationInfo loc, Runnable filler, Collection<GOTFixer.SpawnInfo> spawnInfos, GOTStructureBase specialStructure) {
	...
	public static class Instance extends GOTStructureBaseSettlement.AbstractInstance<GOTStructureStormlandsSettlement> {
		...
		public Instance(GOTStructureStormlandsSettlement settlement, World world, int i, int k, Random random, LocationInfo loc, Runnable filler, Collection<GOTFixer.SpawnInfo> spawnInfos, GOTStructureBase specialStructure, Type t, boolean b) {
		...
		public GOTStructureBase getRandomFarm(Random random) {
			if (random.nextBoolean()) {
				...
				return new GOTStructureStormlandsVillageFarm.Crops(false);
			}
		...
		public void setupCastle(Random random) {
			...
			addStructure(new GOTStructureStormlandsFortress(false), 0, 12, 2, true);
			...
			addStructure(new GOTStructureStormlandsWatchtower(false), -23, -33, 2, true);
			addStructure(new GOTStructureStormlandsWatchtower(false), 23, -33, 2, true);
			...
			addStructure(new GOTStructureStormlandsWatchtower(false), -33, -23, 1, true);
			addStructure(new GOTStructureStormlandsWatchtower(false), -33, 23, 1, true);
			...
			addStructure(new GOTStructureStormlandsWatchtower(false), -23, 33, 0, true);
			addStructure(new GOTStructureStormlandsWatchtower(false), 23, 33, 0, true);
			...
			addStructure(new GOTStructureStormlandsWatchtower(false), 33, -23, 3, true);
			addStructure(new GOTStructureStormlandsWatchtower(false), 33, 23, 3, true);
			...
			addStructure(new GOTStructureStormlandsStables(false), -24, 2, 0);
			addStructure(new GOTStructureStormlandsStables(false), -24, -2, 2);
			addStructure(new GOTStructureStormlandsSmithy(false), 24, 1, 0);
			addStructure(new GOTStructureStormlandsSmithy(false), 24, -1, 2);
			addStructure(new GOTStructureStormlandsStoneHouse(false), -3, -25, 1);
			addStructure(new GOTStructureStormlandsStoneHouse(false), 3, -25, 3);
			addStructure(new GOTStructureStormlandsVillageFarm.Crops(false), -18, -21, 1);
			addStructure(new GOTStructureStormlandsVillageFarm.Crops(false), 18, -21, 3);
		...
		public void setupTown(Random random) {
			...
			for (int k1 = -1; k1 <= 1; ++k1) {
				...
				if (random.nextInt(3) != 0) {
					addStructure(GOTStructureStormlandsMarketStall.getRandomStall(random, false), -stallPos + 3, k2, 1, true);
				}
				if (random.nextInt(3) == 0) {
					continue;
				}
				addStructure(GOTStructureStormlandsMarketStall.getRandomStall(random, false), stallPos - 3, k2, 3, true);
			}
			if (random.nextInt(3) != 0) {
				addStructure(GOTStructureStormlandsMarketStall.getRandomStall(random, false), 0, stallPos - 3, 0, true);
			}
			if (random.nextInt(3) != 0) {
				addStructure(GOTStructureStormlandsMarketStall.getRandomStall(random, false), 0, -stallPos + 3, 2, true);
			}
			int flowerX = 12;
			int flowerZ = 18;
			...
			for (int k1 = -1; k1 <= 1; ++k1) {
				int houseZ = k1 * 12;
				if (k1 == 1) {
					addStructure(new GOTStructureStormlandsStoneHouse(false), -houseX, houseZ, 1, true);
					addStructure(new GOTStructureStormlandsStoneHouse(false), houseX, houseZ, 3, true);
				}
				if (k1 == 0) {
					continue;
				}
				addStructure(new GOTStructureStormlandsStoneHouse(false), houseZ, houseX, 0, true);
				addStructure(new GOTStructureStormlandsStoneHouse(false), houseZ, -houseX, 2, true);
			}
			addStructure(new GOTStructureStormlandsSmithy(false), 0, -26, 2, true);
			addStructure(new GOTStructureWesterosObelisk(false), 0, 27, 0, true);
			addStructure(new GOTStructureStormlandsTavern(false), -houseX, -5, 1, true);
			...
			addStructure(new GOTStructureStormlandsBath(false), houseX + 2, -6, 3, true);
			...
			for (int k1 = -4; k1 <= 4; ++k1) {
				...
				if (treepiece) {
					addStructure(new GOTStructureStormlandsVillageFarm.Tree(false), houseZ, -houseX - 2, 2, true);
				} else {
					addStructure(new GOTStructureStormlandsStoneHouse(false), houseZ, -houseX, 2, true);
				}
				if (Math.abs(k1) >= 2 && (!outerTavern || k1 <= 2)) {
					if (treepiece) {
						addStructure(new GOTStructureStormlandsVillageFarm.Tree(false), houseZ, houseX + 2, 0, true);
					} else {
						addStructure(new GOTStructureStormlandsStoneHouse(false), houseZ, houseX, 0, true);
					}
				}
			...
			if (outerTavern) {
				addStructure(new GOTStructureStormlandsTavern(false), 44, houseX, 0, true);
			}
			int gardenX = 42;
			int gardenZ = 48;
			addStructure(new GOTStructureStormlandsVillageFarm.Tree(false), -gardenX, -gardenZ, 1, true);
			addStructure(new GOTStructureStormlandsVillageFarm.Tree(false), -gardenX, gardenZ, 1, true);
			addStructure(new GOTStructureStormlandsVillageFarm.Tree(false), gardenX, -gardenZ, 3, true);
			addStructure(new GOTStructureStormlandsVillageFarm.Tree(false), gardenX, gardenZ, 3, true);
			int obeliskX = 62;
			int obeliskZ = 66;
			...
			addStructure(new GOTStructureStormlandsGatehouse(false), 0, 84, 2, true);
			addStructure(new GOTStructureWesterosLampPost(false), -4, 73, 0, true);
			addStructure(new GOTStructureWesterosLampPost(false), 4, 73, 0, true);
			int towerX = 78;
			int towerZ = 74;
			for (int i1 : new int[]{-towerX, towerX}) {
				addStructure(new GOTStructureStormlandsWatchtower(false), i1, -towerZ, 2, true);
				addStructure(new GOTStructureStormlandsWatchtower(false), i1, towerZ, 0, true);
			}
			int wallZ = 82;
			int wallEndX = 76;
			for (l = 0; l <= 3; ++l) {
		...
		public void setupVillage(Random random) {
			...
			addStructure(new GOTStructureStormlandsCottage(false), -21, 0, 1);
			addStructure(new GOTStructureStormlandsCottage(false), 0, -21, 2);
			addStructure(new GOTStructureStormlandsCottage(false), 21, 0, 3);
