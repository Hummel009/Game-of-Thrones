...
public class GOTStructureArrynWatchtower extends GOTStructureArrynBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setBlockAndMetadata(world, 3, 6, 0, GOTRegistry.brick1, 5);
		placeWallBanner(world, 0, 5, -3, GOTItemBanner.BannerType.ARRYN, 2);
		...
		this.placeBanner(world, 0, 14, 0, GOTItemBanner.BannerType.ARRYN, 2);
		...
		respawner.setSpawnClass(GOTEntityArrynSoldier.class);
