...
public class GOTStructureArrynStoneHouse extends GOTStructureArrynBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 3, 5, GOTItemBanner.BannerType.ARRYN, 2);
		...
		GOTEntityArrynMan child = new GOTEntityArrynMan(world);
