...
public class GOTStructureStormlandsSmithy extends GOTStructureStormlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setAir(world, -3, 5, 10);
		GOTEntityStormlandsBlacksmith blacksmith = new GOTEntityStormlandsBlacksmith(world);
