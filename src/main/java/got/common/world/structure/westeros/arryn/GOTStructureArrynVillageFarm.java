...
public abstract class GOTStructureArrynVillageFarm extends GOTStructureArrynBase {
	...
	public static class Animals extends GOTStructureArrynVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < animals; ++l) {
				EntityAnimal animal = GOTStructureArrynBarn.getRandomAnimal(world, random);
	...
	public static class Crops extends GOTStructureArrynVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < farmhands; ++l) {
				GOTEntityArrynFarmhand farmhand = new GOTEntityArrynFarmhand(world);
	...
	public static class Tree extends GOTStructureArrynVillageFarm {
