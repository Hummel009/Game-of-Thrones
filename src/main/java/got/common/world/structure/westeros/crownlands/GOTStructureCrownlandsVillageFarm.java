...
public abstract class GOTStructureCrownlandsVillageFarm extends GOTStructureCrownlandsBase {
	...
	public static class Animals extends GOTStructureCrownlandsVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < animals; ++l) {
				EntityAnimal animal = GOTStructureCrownlandsBarn.getRandomAnimal(world, random);
	...
	public static class Crops extends GOTStructureCrownlandsVillageFarm {
	...
	public static class Tree extends GOTStructureCrownlandsVillageFarm {
