...
public class GOTStructureReachTavern extends GOTStructureReachBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityReachBartender bartender = new GOTEntityReachBartender(world);
		...
		for (int l = 0; l < men; ++l) {
			GOTEntityReachMan westerosman = new GOTEntityReachMan(world);
