...
public class GOTStructureDorneFortress extends GOTStructureDorneBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int i11 : new int[] { -11, 11 }) {
			...
			for (int i13 : new int[] { -4, 3 }) {
				...
				for (int i14 = i13; i14 <= i13 + 1; i14++) {
					...
					setBlockAndMetadata(world, i12, 3, i14, GOTRegistry.brick3, 8);
				}
			}
			...
			for (int k2 = -1; k2 <= 1; k2++) {
				...
				setBlockAndMetadata(world, i12, 3, k2, GOTRegistry.brick3, 8);
			}
		}
		for (int i11 : new int[] { -11, 11 }) {
			...
			for (int i12 : new int[] { -4, 3 }) {
				...
				for (int i13 = i12; i13 <= i12 + 1; i13++) {
					...
					setBlockAndMetadata(world, i13, 3, k2, GOTRegistry.brick3, 8);
				}
			}
			if (i11 > 0) {
		...
		placeWallBanner(world, -2, 4, -11, GOTItemBanner.BannerType.MARTELL, 2);
		placeWallBanner(world, 2, 4, -11, GOTItemBanner.BannerType.MARTELL, 2);
		for (i8 = -2; i8 <= 2; i8++) {
		...
		setBlockAndMetadata(world, 0, 10, 0, GOTRegistry.brick3, 8);
		setBlockAndMetadata(world, 0, 11, 0, GOTRegistry.beacon, 0);
		placeWallBanner(world, 0, 9, 0, GOTItemBanner.BannerType.MARTELL, 0);
		placeWallBanner(world, 0, 9, 0, GOTItemBanner.BannerType.MARTELL, 1);
		placeWallBanner(world, 0, 9, 0, GOTItemBanner.BannerType.MARTELL, 2);
		placeWallBanner(world, 0, 9, 0, GOTItemBanner.BannerType.MARTELL, 3);
		...
		placeWallBanner(world, -2, 3, 9, GOTItemBanner.BannerType.MARTELL, 2);
		placeWallBanner(world, 2, 3, 9, GOTItemBanner.BannerType.MARTELL, 2);
		...
		GOTEntityDorneCaptain captain = new GOTEntityDorneCaptain(world);
		...
		respawner.setSpawnClasses(GOTEntityDorneSoldier.class, GOTEntityDorneSoldierArcher.class);
