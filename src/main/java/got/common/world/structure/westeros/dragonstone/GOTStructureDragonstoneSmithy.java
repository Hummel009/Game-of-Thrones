...
public class GOTStructureDragonstoneSmithy extends GOTStructureDragonstoneBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setAir(world, -3, 5, 10);
		GOTEntityDragonstoneBlacksmith blacksmith = new GOTEntityDragonstoneBlacksmith(world);
