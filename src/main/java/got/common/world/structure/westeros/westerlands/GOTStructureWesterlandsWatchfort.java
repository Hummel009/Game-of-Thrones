...
public class GOTStructureWesterlandsWatchfort extends GOTStructureWesterlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 7, -5, GOTItemBanner.BannerType.LANNISTER, 2);
		for (i1 = -1; i1 <= 1; ++i1) {
			for (k12 = -7; k12 <= -6; ++k12) {
		...
		this.placeBanner(world, -2, 14, 11, GOTItemBanner.BannerType.LANNISTER, 3);
		this.placeBanner(world, 2, 14, 11, GOTItemBanner.BannerType.LANNISTER, 1);
		this.placeBanner(world, -2, 14, 23, GOTItemBanner.BannerType.LANNISTER, 3);
		this.placeBanner(world, 2, 14, 23, GOTItemBanner.BannerType.LANNISTER, 1);
		...
		setBlockAndMetadata(world, 2, 14, 18, Blocks.torch, 3);
		GOTStructureWesterlandsTower beaconTower = new GOTStructureWesterlandsTower(notifyChanges);
		...
		GOTEntityWesterlandsCaptain captain = new GOTEntityWesterlandsCaptain(world);
		captain.spawnRidingHorse = false;
		spawnNPCAndSetHome(captain, world, 0, 15, 0, 8);
		GOTEntityNPCRespawner respawner = new GOTEntityNPCRespawner(world);
		respawner.setSpawnClasses(GOTEntityWesterlandsSoldier.class, GOTEntityWesterlandsSoldierArcher.class);
