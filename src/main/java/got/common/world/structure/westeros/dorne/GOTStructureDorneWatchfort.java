...
public class GOTStructureDorneWatchfort extends GOTStructureDorneBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 7, -5, GOTItemBanner.BannerType.MARTELL, 2);
		for (i1 = -1; i1 <= 1; ++i1) {
			for (k12 = -7; k12 <= -6; ++k12) {
		...
		this.placeBanner(world, -2, 14, 11, GOTItemBanner.BannerType.MARTELL, 3);
		this.placeBanner(world, 2, 14, 11, GOTItemBanner.BannerType.MARTELL, 1);
		this.placeBanner(world, -2, 14, 23, GOTItemBanner.BannerType.MARTELL, 3);
		this.placeBanner(world, 2, 14, 23, GOTItemBanner.BannerType.MARTELL, 1);
		...
		setBlockAndMetadata(world, 2, 14, 18, Blocks.torch, 3);
		GOTStructureDorneTower beaconTower = new GOTStructureDorneTower(notifyChanges);
