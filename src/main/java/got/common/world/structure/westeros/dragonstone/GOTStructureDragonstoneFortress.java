...
public class GOTStructureDragonstoneFortress extends GOTStructureDragonstoneBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, -2, 4, -11, GOTItemBanner.BannerType.STANNIS, 2);
		placeWallBanner(world, 2, 4, -11, GOTItemBanner.BannerType.STANNIS, 2);
		for (i8 = -2; i8 <= 2; i8++) {
		...
		placeWallBanner(world, 0, 9, 0, GOTItemBanner.BannerType.STANNIS, 0);
		placeWallBanner(world, 0, 9, 0, GOTItemBanner.BannerType.STANNIS, 1);
		placeWallBanner(world, 0, 9, 0, GOTItemBanner.BannerType.STANNIS, 2);
		placeWallBanner(world, 0, 9, 0, GOTItemBanner.BannerType.STANNIS, 3);
		...
		placeWallBanner(world, -2, 3, 9, GOTItemBanner.BannerType.STANNIS, 2);
		placeWallBanner(world, 2, 3, 9, GOTItemBanner.BannerType.STANNIS, 2);
