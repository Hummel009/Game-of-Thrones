...
public class GOTStructureNorthTower extends GOTStructureNorthBase {
	...
	public boolean generateAndHeight(World world, Random random, int i, int j, int k, int rotation, int height) {
		...
		if (generateRoom) {
			...
			setBlockAndMetadata(world, 4, 1, 0, GOTRegistry.tableNorth, 0);
			placeWallBanner(world, 2, doorBase + 4, -1, GOTItemBanner.BannerType.ROBB, 3);
		...
		respawner.setSpawnClass(GOTEntityNorthSoldierArcher.class);
