...
public abstract class GOTStructureStormlandsVillageFarm extends GOTStructureStormlandsBase {
	...
	public static class Animals extends GOTStructureStormlandsVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < animals; ++l) {
				EntityAnimal animal = GOTStructureStormlandsBarn.getRandomAnimal(world, random);
	...
	public static class Crops extends GOTStructureStormlandsVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < farmhands; ++l) {
				GOTEntityStormlandsFarmhand farmhand = new GOTEntityStormlandsFarmhand(world);
	...
	public static class Tree extends GOTStructureStormlandsVillageFarm {
