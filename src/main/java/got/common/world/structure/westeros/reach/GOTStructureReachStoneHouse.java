...
public class GOTStructureReachStoneHouse extends GOTStructureReachBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 3, 5, GOTItemBanner.BannerType.TYRELL, 2);
		...
		GOTEntityReachMan child = new GOTEntityReachMan(world);
