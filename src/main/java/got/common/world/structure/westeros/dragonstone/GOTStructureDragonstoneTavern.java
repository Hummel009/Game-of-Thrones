...
public class GOTStructureDragonstoneTavern extends GOTStructureDragonstoneBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityDragonstoneBartender bartender = new GOTEntityDragonstoneBartender(world);
		...
		for (int l = 0; l < men; ++l) {
			GOTEntityDragonstoneMan westerosman = new GOTEntityDragonstoneMan(world);
