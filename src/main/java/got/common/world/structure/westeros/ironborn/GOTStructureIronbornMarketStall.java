...
public abstract class GOTStructureIronbornMarketStall extends GOTStructureIronbornBase {
	...
	public abstract GOTEntityIronbornMan createTrader(World var1);
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setBlockAndMetadata(world, -1, 1, -1, GOTRegistry.tableIronborn, 0);
		setBlockAndMetadata(world, 1, 1, -1, Blocks.chest, 3);
		GOTEntityIronbornMan trader = createTrader(world);
