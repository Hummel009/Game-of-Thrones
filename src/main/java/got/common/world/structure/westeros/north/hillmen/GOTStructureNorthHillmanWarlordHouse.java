...
import got.common.entity.westeros.north.hillmen.GOTEntityNorthHillmanWarlord;
...
public class GOTStructureNorthHillmanWarlordHouse extends GOTStructureBase {

	public GOTStructureNorthHillmanWarlordHouse(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		spawnNPCAndSetHome(new GOTEntityNorthHillmanWarlord(world), world, 0, 1, 0, 8);
		return true;
	}
}