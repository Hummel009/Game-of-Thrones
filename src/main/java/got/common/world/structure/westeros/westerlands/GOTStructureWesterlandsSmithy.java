...
public class GOTStructureWesterlandsSmithy extends GOTStructureWesterlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setAir(world, -3, 5, 10);
		GOTEntityWesterlandsBlacksmith blacksmith = new GOTEntityWesterlandsBlacksmith(world);
