...
public class GOTStructureArrynTavern extends GOTStructureArrynBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityArrynBartender bartender = new GOTEntityArrynBartender(world);
		...
		for (int l = 0; l < men; ++l) {
			GOTEntityArrynMan westerosman = new GOTEntityArrynMan(world);
