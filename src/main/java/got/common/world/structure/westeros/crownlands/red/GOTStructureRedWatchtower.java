...
public class GOTStructureRedWatchtower extends GOTStructureRedBase {
	public GOTStructureRedWatchtower(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		int j1;
		for (j1 = 1; j1 <= 2; j1++) {
			setBlockAndMetadata(world, -1, j1, -3, GOTRegistry.brick3, 1);
			setBlockAndMetadata(world, 1, j1, -3, GOTRegistry.brick3, 1);
		}
