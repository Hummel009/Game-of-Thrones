...
import got.common.world.structure.westeros.basis.GOTStructureWesterosVillageSign;
import got.common.world.structure.westeros.market.GOTStructureDorneMarketStall;
import got.common.world.structure.westeros.storage.GOTStructureDorne.*;
...
public class GOTStructureDorneCity extends GOTVillageGen {
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public GOTStructureDorneTownWall centre(boolean flag) {
		...
		public GOTStructureDorneTownWall left(boolean flag) {
			return new GOTStructureDorneTownWall(flag, -9, 6);
		}

		public GOTStructureDorneTownWall leftEnd(boolean flag) {
			return new GOTStructureDorneTownWall(flag, -6, 6, -5, 6);
		}

		public GOTStructureDorneTownWall leftEndShort(boolean flag) {
			return new GOTStructureDorneTownWall(flag, -5, 6);
		}

		public GOTStructureDorneTownWall right(boolean flag) {
			return new GOTStructureDorneTownWall(flag, -6, 9);
		}

		public GOTStructureDorneTownWall rightEnd(boolean flag) {
			return new GOTStructureDorneTownWall(flag, -6, 6, -6, 5);
		}

		public GOTStructureDorneTownWall rightEndShort(boolean flag) {
		...
		public void setupTown(Random random) {
			...
			for (l = 0; l <= 3; ++l) {
				wallX = 12 + l * 16;
				this.addStructure(left(false), -wallX, wallZ, 2, true);
				this.addStructure(right(false), wallX, wallZ, 2, true);
			}
			this.addStructure(leftEndShort(false), -wallEndX, wallZ, 2, true);
			this.addStructure(rightEndShort(false), wallEndX, wallZ, 2, true);
			this.addStructure(centre(false), -wallZ, 0, 3, true);
			this.addStructure(centre(false), wallZ, 0, 1, true);
			this.addStructure(centre(false), 0, -wallZ, 0, true);
			for (l = 0; l <= 3; ++l) {
				wallX = 12 + l * 16;
				this.addStructure(left(false), -wallZ, -wallX, 3, true);
				this.addStructure(right(false), -wallZ, wallX, 3, true);
				this.addStructure(left(false), wallZ, wallX, 1, true);
				this.addStructure(right(false), wallZ, -wallX, 1, true);
				this.addStructure(left(false), wallX, -wallZ, 0, true);
				this.addStructure(right(false), -wallX, -wallZ, 0, true);
			}
			this.addStructure(leftEnd(false), -wallZ, -wallEndX, 3, true);
			this.addStructure(rightEnd(false), -wallZ, wallEndX, 3, true);
			this.addStructure(leftEnd(false), wallZ, wallEndX, 1, true);
			this.addStructure(rightEnd(false), wallZ, -wallEndX, 1, true);
			this.addStructure(leftEndShort(false), wallEndX, -wallZ, 0, true);
			this.addStructure(rightEndShort(false), -wallEndX, -wallZ, 0, true);
		}
