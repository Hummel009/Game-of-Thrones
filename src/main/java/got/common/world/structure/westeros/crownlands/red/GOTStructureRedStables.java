...
public class GOTStructureRedStables extends GOTStructureRedBase {
	public GOTStructureRedStables(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setBlockAndMetadata(world, 0, 2, 5, GOTRegistry.brick3, 1);
