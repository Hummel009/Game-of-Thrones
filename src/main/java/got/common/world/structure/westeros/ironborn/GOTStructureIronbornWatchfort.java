...
public class GOTStructureIronbornWatchfort extends GOTStructureIronbornBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 7, -5, GOTItemBanner.BannerType.GREYJOY, 2);
		for (i1 = -1; i1 <= 1; ++i1) {
			for (k12 = -7; k12 <= -6; ++k12) {
		...
		this.placeBanner(world, -2, 14, 11, GOTItemBanner.BannerType.GREYJOY, 3);
		this.placeBanner(world, 2, 14, 11, GOTItemBanner.BannerType.GREYJOY, 1);
		this.placeBanner(world, -2, 14, 23, GOTItemBanner.BannerType.GREYJOY, 3);
		this.placeBanner(world, 2, 14, 23, GOTItemBanner.BannerType.GREYJOY, 1);
		...
		setBlockAndMetadata(world, 2, 14, 18, Blocks.torch, 3);
		GOTStructureIronbornTower beaconTower = new GOTStructureIronbornTower(notifyChanges);
		...
		setAir(world, 1, 12, 29);
		GOTEntityIronbornSoldier soldier = new GOTEntityIronbornSoldier(world);
		soldier.spawnRidingHorse = false;
		spawnNPCAndSetHome(soldier, world, 0, 2, -3, 32);
		GOTEntityIronbornCaptain captain = new GOTEntityIronbornCaptain(world);
