...
public class GOTStructureRiverlandsTower extends GOTStructureRiverlandsBase {
	...
	public boolean generateAndHeight(World world, Random random, int i, int j, int k, int rotation, int height) {
		...
		if (generateRoom) {
			...
			setBlockAndMetadata(world, 1, doorBase + 1, -1, GOTRegistry.tableRiverlands, 0);
			placeWallBanner(world, 2, doorBase + 4, -1, GOTItemBanner.BannerType.TULLY, 3);
		...
		respawner.setSpawnClass(GOTEntityRiverlandsSoldierArcher.class);
