...
import got.common.world.structure.westeros.westerlands.GOTStructureWesterlands.*;
...
public class GOTStructureWesterlandsCity extends GOTVillageGen {
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public void setupCastle(Random random) {
			...
			this.addStructure(new GOTStructureWesterlandsVillageFarm.Crops(false), -18, -21, 1);
			this.addStructure(new GOTStructureWesterlandsVillageFarm.Crops(false), 18, -21, 3);
