...
public class GOTStructureWesterlandsCity extends GOTVillageGen {
	...
	@Override
	public GOTVillageGen.AbstractInstance<GOTStructureWesterlandsCity> createVillageInstance(World world, int i, int k, Random random, LocationInfo loc) {
	...
	public class Instance extends GOTVillageGen.AbstractInstance<GOTStructureWesterlandsCity> {
		...
		public void setupCastle(Random random) {
			...
			addStructure(new GOTStructureWesterlandsFortress(false), 0, 12, 2, true);
			...
			addStructure(new GOTStructureWesterlandsWatchtower(false), -23, -33, 2, true);
			addStructure(new GOTStructureWesterlandsWatchtower(false), 23, -33, 2, true);
			...
			addStructure(new GOTStructureWesterlandsWatchtower(false), -33, -23, 1, true);
			addStructure(new GOTStructureWesterlandsWatchtower(false), -33, 23, 1, true);
			...
			addStructure(new GOTStructureWesterlandsWatchtower(false), -23, 33, 0, true);
			addStructure(new GOTStructureWesterlandsWatchtower(false), 23, 33, 0, true);
			...
			addStructure(new GOTStructureWesterlandsWatchtower(false), 33, -23, 3, true);
			addStructure(new GOTStructureWesterlandsWatchtower(false), 33, 23, 3, true);
			...
			addStructure(new GOTStructureWesterlandsStables(false), -24, 2, 0);
		...
		public void setupTown(Random random) {
			...
			for (int k1 = -1; k1 <= 1; ++k1) {
				...
				if (random.nextInt(3) != 0) {
					addStructure(GOTStructureWesterlandsMarketStall.getRandomStall(random, false), -stallPos + 3, k2, 1, true);
				}
				if (random.nextInt(3) == 0) {
					continue;
				}
				addStructure(GOTStructureWesterlandsMarketStall.getRandomStall(random, false), stallPos - 3, k2, 3, true);
			}
			if (random.nextInt(3) != 0) {
				addStructure(GOTStructureWesterlandsMarketStall.getRandomStall(random, false), 0, stallPos - 3, 0, true);
			}
			if (random.nextInt(3) != 0) {
				addStructure(GOTStructureWesterlandsMarketStall.getRandomStall(random, false), 0, -stallPos + 3, 2, true);
			}
			int flowerX = 12;
			int flowerZ = 18;
			...
			addStructure(new GOTStructureWesterlandsTavern(false), -houseX, -5, 1, true);
			...
			addStructure(new GOTStructureWesterlandsBath(false), houseX + 2, -6, 3, true);
			...
			if (outerTavern) {
				addStructure(new GOTStructureWesterlandsTavern(false), 44, houseX, 0, true);
			}
			int gardenX = 42;
			int gardenZ = 48;
			addStructure(new GOTStructureWesterlandsVillageFarm.Tree(false), -gardenX, -gardenZ, 1, true);
			addStructure(new GOTStructureWesterlandsVillageFarm.Tree(false), -gardenX, gardenZ, 1, true);
			addStructure(new GOTStructureWesterlandsVillageFarm.Tree(false), gardenX, -gardenZ, 3, true);
			addStructure(new GOTStructureWesterlandsVillageFarm.Tree(false), gardenX, gardenZ, 3, true);
			int obeliskX = 62;
			int obeliskZ = 66;
			...
			addStructure(new GOTStructureWesterlandsGatehouse(false), 0, 84, 2, true);
			addStructure(new GOTStructureWesterosLampPost(false), -4, 73, 0, true);
			addStructure(new GOTStructureWesterosLampPost(false), 4, 73, 0, true);
			int towerX = 78;
			int towerZ = 74;
			for (int i1 : new int[]{-towerX, towerX}) {
				addStructure(new GOTStructureWesterlandsWatchtower(false), i1, -towerZ, 2, true);
				addStructure(new GOTStructureWesterlandsWatchtower(false), i1, towerZ, 0, true);
			}
			int wallZ = 82;
			int wallEndX = 76;
			for (l = 0; l <= 3; ++l) {
