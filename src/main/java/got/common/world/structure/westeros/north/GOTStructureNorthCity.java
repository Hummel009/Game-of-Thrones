...
import got.common.world.structure.westeros.north.GOTStructureNorth.*;
...
public class GOTStructureNorthCity extends GOTVillageGen {
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public void setupCastle(Random random) {
			...
			this.addStructure(new GOTStructureNorthVillageFarm.Crops(false), -18, -21, 1);
			this.addStructure(new GOTStructureNorthVillageFarm.Crops(false), 18, -21, 3);
