...
public class GOTStructureWesterlandsGatehouse extends GOTStructureWesterlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setBlockAndMetadata(world, -2, 10, 2, Blocks.torch, 2);
		setBlockAndMetadata(world, 2, 10, 2, Blocks.torch, 1);
		placeWallBanner(world, 1, 10, -3, GOTItemBanner.BannerType.LANNISTER, 0);
		placeWallBanner(world, -1, 10, -3, GOTItemBanner.BannerType.LANNISTER, 0);
		setBlockAndMetadata(world, -3, 12, -3, Blocks.torch, 3);
		setBlockAndMetadata(world, 3, 12, -3, Blocks.torch, 3);
		setBlockAndMetadata(world, -3, 12, 3, Blocks.torch, 4);
		setBlockAndMetadata(world, 3, 12, 3, Blocks.torch, 4);
		placeWallBanner(world, -3, 7, -3, GOTItemBanner.BannerType.LANNISTER, 2);
		placeWallBanner(world, 3, 7, -3, GOTItemBanner.BannerType.LANNISTER, 2);
		placeWallBanner(world, 3, 7, 3, GOTItemBanner.BannerType.LANNISTER, 0);
		placeWallBanner(world, -3, 7, 3, GOTItemBanner.BannerType.LANNISTER, 0);
		for (i1 = -5; i1 <= 5; ++i1) {
			i22 = Math.abs(i1);
			if (i22 >= 4) {
