...
public class GOTStructureRiverlandsSmithy extends GOTStructureRiverlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setAir(world, -3, 5, 10);
		GOTEntityRiverlandsBlacksmith blacksmith = new GOTEntityRiverlandsBlacksmith(world);
