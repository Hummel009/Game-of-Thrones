...
public class GOTStructureRedStoneHouse extends GOTStructureRedBase {
	public GOTStructureRedStoneHouse(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int k13 : new int[] { -4, 5 }) {
			...
			setBlockAndMetadata(world, 0, 6, k13, GOTRegistry.brick3, 1);
		}
