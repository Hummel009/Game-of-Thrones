...
public class GOTStructureDragonstoneStoneHouse extends GOTStructureDragonstoneBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 3, 5, GOTItemBanner.BannerType.STANNIS, 2);
		...
		GOTEntityDragonstoneMan male = new GOTEntityDragonstoneMan(world);
		male.familyInfo.setMale(true);
		male.setCurrentItemOrArmor(4, new ItemStack(GOTRegistry.goldRing));
		spawnNPCAndSetHome(male, world, 0, 1, 0, 16);
		GOTEntityDragonstoneMan female = new GOTEntityDragonstoneMan(world);
		...
		GOTEntityDragonstoneMan child = new GOTEntityDragonstoneMan(world);
