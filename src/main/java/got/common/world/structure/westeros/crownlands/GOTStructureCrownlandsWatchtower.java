...
public class GOTStructureCrownlandsWatchtower extends GOTStructureCrownlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setBlockAndMetadata(world, 3, 6, 0, GOTRegistry.brick1, 5);
		placeWallBanner(world, 0, 5, -3, GOTItemBanner.BannerType.ROBERT, 2);
		for (j1 = 1; j1 <= 9; j1++) {
		...
		placeBanner(world, 0, 14, 0, GOTItemBanner.BannerType.ROBERT, 2);
