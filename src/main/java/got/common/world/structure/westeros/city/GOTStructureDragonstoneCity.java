...
import got.common.world.structure.westeros.market.GOTStructureDragonstoneMarketStall;
import got.common.world.structure.westeros.storage.GOTStructureDragonstone.*;
...
public class GOTStructureDragonstoneCity extends GOTVillageGen {
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTStructureDragonstoneCity village, World world, int i, int k, Random random, LocationInfo loc) {
		...
		public GOTStructureBase getRandomFarm(Random random) {
			if (random.nextBoolean()) {
				...
				return new GOTStructureDragonstoneVillageFarmCrops(false);
			}
		...
		public void setupCastle(Random random) {
			...
			this.addStructure(new GOTStructureDragonstoneVillageFarmCrops(false), -18, -21, 1);
			this.addStructure(new GOTStructureDragonstoneVillageFarmCrops(false), 18, -21, 3);
		...
		public void setupTown(Random random) {
			...
			for (int k1 = -1; k1 <= 1; ++k1) {
				...
				if (random.nextInt(3) != 0) {
					this.addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), -stallPos + 3, k2, 1, true);
				}
				if (random.nextInt(3) == 0) {
					continue;
				}
				this.addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), stallPos - 3, k2, 3, true);
			}
			if (random.nextInt(3) != 0) {
				this.addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), 0, stallPos - 3, 0, true);
			}
			if (random.nextInt(3) != 0) {
				this.addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), 0, -stallPos + 3, 2, true);
			}
			int flowerX = 12;
			int flowerZ = 18;
			...
			for (int k1 = -1; k1 <= 1; ++k1) {
				int houseZ = k1 * 12;
				if (k1 == 1) {
					this.addStructure(new GOTStructureDragonstoneStoneHouse(false), -houseX, houseZ, 1, true);
					this.addStructure(new GOTStructureDragonstoneStoneHouse(false), houseX, houseZ, 3, true);
				}
				if (k1 == 0) {
					continue;
				}
				this.addStructure(new GOTStructureDragonstoneStoneHouse(false), houseZ, houseX, 0, true);
				this.addStructure(new GOTStructureDragonstoneStoneHouse(false), houseZ, -houseX, 2, true);
			}
			this.addStructure(new GOTStructureDragonstoneSmithy(false), 0, -26, 2, true);
			...
			this.addStructure(new GOTStructureDragonstoneBath(false), houseX + 2, -6, 3, true);
			...
			for (int k1 = -4; k1 <= 4; ++k1) {
				...
				if (treepiece) {
					this.addStructure(new GOTStructureDragonstoneVillageFarm.Tree(false), -houseX - 2, houseZ, 1, true);
					this.addStructure(new GOTStructureDragonstoneVillageFarm.Tree(false), houseX + 2, houseZ, 3, true);
				} else {
					this.addStructure(new GOTStructureDragonstoneStoneHouse(false), -houseX, houseZ, 1, true);
					this.addStructure(new GOTStructureDragonstoneStoneHouse(false), houseX, houseZ, 3, true);
				}
				if (treepiece) {
					this.addStructure(new GOTStructureDragonstoneVillageFarm.Tree(false), houseZ, -houseX - 2, 2, true);
				} else {
					this.addStructure(new GOTStructureDragonstoneStoneHouse(false), houseZ, -houseX, 2, true);
				}
				if (Math.abs(k1) >= 2 && (!outerTavern || k1 <= 2)) {
					if (treepiece) {
						this.addStructure(new GOTStructureDragonstoneVillageFarm.Tree(false), houseZ, houseX + 2, 0, true);
					} else {
						this.addStructure(new GOTStructureDragonstoneStoneHouse(false), houseZ, houseX, 0, true);
					}
				}
			...
			if (outerTavern) {
				this.addStructure(new GOTStructureDragonstoneTavern(false), 44, houseX, 0, true);
			}
			int gardenX = 42;
			int gardenZ = 48;
			this.addStructure(new GOTStructureDragonstoneVillageFarm.Tree(false), -gardenX, -gardenZ, 1, true);
			this.addStructure(new GOTStructureDragonstoneVillageFarm.Tree(false), -gardenX, gardenZ, 1, true);
			this.addStructure(new GOTStructureDragonstoneVillageFarm.Tree(false), gardenX, -gardenZ, 3, true);
			this.addStructure(new GOTStructureDragonstoneVillageFarm.Tree(false), gardenX, gardenZ, 3, true);
			int obeliskX = 62;
			int obeliskZ = 66;
			...
			this.addStructure(new GOTStructureDragonstoneGatehouse(false), 0, 84, 2, true);
		...
		public void setupVillage(Random random) {
			...
			this.addStructure(new GOTStructureDragonstoneCottage(false), -21, 0, 1);
			this.addStructure(new GOTStructureDragonstoneCottage(false), 0, -21, 2);
			this.addStructure(new GOTStructureDragonstoneCottage(false), 21, 0, 3);
			this.addStructure(new GOTStructureDragonstoneTavern(false), 0, 21, 0);
			if (random.nextBoolean()) {
				if (random.nextInt(3) == 0) {
					this.addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), -9, -12, 1);
				}
				if (random.nextInt(3) == 0) {
					this.addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), 9, -12, 3);
				}
				if (random.nextInt(3) == 0) {
					this.addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), -9, 12, 1);
				}
