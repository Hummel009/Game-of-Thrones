...
public class GOTStructureStormlandsTavern extends GOTStructureStormlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityStormlandsBartender bartender = new GOTEntityStormlandsBartender(world);
		...
		for (int l = 0; l < men; ++l) {
			GOTEntityStormlandsMan westerosman = new GOTEntityStormlandsMan(world);
