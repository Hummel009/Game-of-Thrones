...
public class GOTStructureRiverlandsWatchfort extends GOTStructureRiverlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 7, -5, GOTItemBanner.BannerType.TULLY, 2);
		for (i1 = -1; i1 <= 1; ++i1) {
			for (k12 = -7; k12 <= -6; ++k12) {
		...
		this.placeBanner(world, -2, 14, 11, GOTItemBanner.BannerType.TULLY, 3);
		this.placeBanner(world, 2, 14, 11, GOTItemBanner.BannerType.TULLY, 1);
		this.placeBanner(world, -2, 14, 23, GOTItemBanner.BannerType.TULLY, 3);
		this.placeBanner(world, 2, 14, 23, GOTItemBanner.BannerType.TULLY, 1);
		...
		setBlockAndMetadata(world, 2, 14, 18, Blocks.torch, 3);
		GOTStructureRiverlandsTower beaconTower = new GOTStructureRiverlandsTower(notifyChanges);
		...
		setAir(world, 1, 12, 29);
		GOTEntityRiverlandsSoldier soldier = new GOTEntityRiverlandsSoldier(world);
		soldier.spawnRidingHorse = false;
		spawnNPCAndSetHome(soldier, world, 0, 2, -3, 32);
		GOTEntityRiverlandsCaptain captain = new GOTEntityRiverlandsCaptain(world);
		captain.spawnRidingHorse = false;
		spawnNPCAndSetHome(captain, world, 0, 15, 0, 8);
		GOTEntityNPCRespawner respawner = new GOTEntityNPCRespawner(world);
		respawner.setSpawnClasses(GOTEntityRiverlandsSoldier.class, GOTEntityRiverlandsSoldierArcher.class);
