...
public class GOTStructureCrownlandsStoneHouse extends GOTStructureCrownlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 3, 5, GOTItemBanner.BannerType.ROBERT, 2);
		...
		GOTEntityCrownlandsMan male = new GOTEntityCrownlandsMan(world);
		male.familyInfo.setMale(true);
		male.setCurrentItemOrArmor(4, new ItemStack(GOTRegistry.goldRing));
		spawnNPCAndSetHome(male, world, 0, 1, 0, 16);
		GOTEntityCrownlandsMan female = new GOTEntityCrownlandsMan(world);
		...
		GOTEntityCrownlandsMan child = new GOTEntityCrownlandsMan(world);
