...
public class GOTStructureNorthWatchtower extends GOTStructureNorthBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setBlockAndMetadata(world, 3, 6, 0, GOTRegistry.brick1, 5);
		placeWallBanner(world, 0, 5, -3, GOTItemBanner.BannerType.ROBB, 2);
		for (j1 = 1; j1 <= 9; ++j1) {
		...
		this.placeBanner(world, 0, 14, 0, GOTItemBanner.BannerType.ROBB, 2);
		...
		respawner.setSpawnClass(GOTEntityNorthSoldier.class);
