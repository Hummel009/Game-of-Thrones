...
public class GOTStructureStormlandsStoneHouse extends GOTStructureStormlandsBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 3, 5, GOTItemBanner.BannerType.RENLY, 2);
		...
		GOTEntityStormlandsMan male = new GOTEntityStormlandsMan(world);
		male.familyInfo.setMale(true);
		male.setCurrentItemOrArmor(4, new ItemStack(GOTRegistry.goldRing));
		spawnNPCAndSetHome(male, world, 0, 1, 0, 16);
		GOTEntityStormlandsMan female = new GOTEntityStormlandsMan(world);
		...
		GOTEntityStormlandsMan child = new GOTEntityStormlandsMan(world);
