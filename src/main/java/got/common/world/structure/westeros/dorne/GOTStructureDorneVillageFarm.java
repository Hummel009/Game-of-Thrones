...
public abstract class GOTStructureDorneVillageFarm extends GOTStructureDorneBase {
	...
	public static class Animals extends GOTStructureDorneVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < animals; ++l) {
				EntityAnimal animal = GOTStructureDorneBarn.getRandomAnimal(world, random);
	...
	public static class Crops extends GOTStructureDorneVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < farmhands; ++l) {
				GOTEntityDorneFarmhand farmhand = new GOTEntityDorneFarmhand(world);
	...
	public static class Tree extends GOTStructureDorneVillageFarm {
