...
public abstract class GOTStructureIronbornVillageFarm extends GOTStructureIronbornBase {
	...
	public static class Animals extends GOTStructureIronbornVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < animals; ++l) {
				EntityAnimal animal = GOTStructureIronbornBarn.getRandomAnimal(world, random);
	...
	public static class Crops extends GOTStructureIronbornVillageFarm {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < farmhands; ++l) {
				GOTEntityIronbornFarmhand farmhand = new GOTEntityIronbornFarmhand(world);
	...
	public static class Tree extends GOTStructureIronbornVillageFarm {
