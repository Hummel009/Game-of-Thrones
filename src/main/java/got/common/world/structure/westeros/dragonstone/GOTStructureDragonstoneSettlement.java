...
public class GOTStructureDragonstoneSettlement extends GOTStructureBaseSettlement {
	...
	@Override
	public GOTStructureBaseSettlement.AbstractInstance<GOTStructureDragonstoneSettlement> createSettlementInstance(World world, int i, int k, Random random, LocationInfo loc) {
		return new Instance(this, world, i, k, random, loc);
	}

	public GOTStructureDragonstoneSettlement setIsCastle() {
		isCastle = true;
	...
	public GOTStructureDragonstoneSettlement setIsTown() {
		isTown = true;
		settlementChunkRadius = 6;
		fixedSettlementChunkRadius = 6;
		return this;
	...
	public class Instance extends GOTStructureBaseSettlement.AbstractInstance<GOTStructureDragonstoneSettlement> {
		public Type type;

		public Instance(GOTStructureDragonstoneSettlement settlement, World world, int i, int k, Random random, LocationInfo loc) {
		...
		public void setupCastle(Random random) {
			...
			addStructure(new GOTStructureDragonstoneWatchtower(false), -23, -33, 2, true);
			addStructure(new GOTStructureDragonstoneWatchtower(false), 23, -33, 2, true);
			...
			addStructure(new GOTStructureDragonstoneWatchtower(false), -33, -23, 1, true);
			addStructure(new GOTStructureDragonstoneWatchtower(false), -33, 23, 1, true);
			...
			addStructure(new GOTStructureDragonstoneWatchtower(false), -23, 33, 0, true);
			addStructure(new GOTStructureDragonstoneWatchtower(false), 23, 33, 0, true);
			...
			addStructure(new GOTStructureDragonstoneWatchtower(false), 33, -23, 3, true);
			addStructure(new GOTStructureDragonstoneWatchtower(false), 33, 23, 3, true);
			...
			addStructure(new GOTStructureDragonstoneStables(false), -24, 2, 0);
		...
		public void setupTown(Random random) {
			...
			for (int k1 = -1; k1 <= 1; ++k1) {
				...
				if (random.nextInt(3) != 0) {
					addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), -stallPos + 3, k2, 1, true);
				}
				if (random.nextInt(3) == 0) {
					continue;
				}
				addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), stallPos - 3, k2, 3, true);
			}
			if (random.nextInt(3) != 0) {
				addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), 0, stallPos - 3, 0, true);
			}
			if (random.nextInt(3) != 0) {
				addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), 0, -stallPos + 3, 2, true);
			}
			int flowerX = 12;
			int flowerZ = 18;
			...
			addStructure(new GOTStructureDragonstoneBath(false), houseX + 2, -6, 3, true);
			...
			if (outerTavern) {
				addStructure(new GOTStructureDragonstoneTavern(false), 44, houseX, 0, true);
			}
			int gardenX = 42;
			int gardenZ = 48;
			addStructure(new GOTStructureDragonstoneVillageFarm.Tree(false), -gardenX, -gardenZ, 1, true);
			addStructure(new GOTStructureDragonstoneVillageFarm.Tree(false), -gardenX, gardenZ, 1, true);
			addStructure(new GOTStructureDragonstoneVillageFarm.Tree(false), gardenX, -gardenZ, 3, true);
			addStructure(new GOTStructureDragonstoneVillageFarm.Tree(false), gardenX, gardenZ, 3, true);
			int obeliskX = 62;
			int obeliskZ = 66;
			...
			addStructure(new GOTStructureDragonstoneGatehouse(false), 0, 84, 2, true);
		...
		public void setupVillage(Random random) {
			...
			if (random.nextBoolean()) {
				if (random.nextInt(3) == 0) {
					addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), -9, -12, 1);
				}
				if (random.nextInt(3) == 0) {
					addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), 9, -12, 3);
				}
				if (random.nextInt(3) == 0) {
					addStructure(GOTStructureDragonstoneMarketStall.getRandomStall(random, false), -9, 12, 1);
				}
