...
public abstract class GOTStructureNorvosBase extends GOTStructureBase {
	...
	public GOTStructureNorvosBase(boolean flag) {
		super(flag);
	}
	...
	public void setupRandomBlocks(Random random) {
		...
		tableBlock = GOTRegistry.tableNorvos;
		...
		bannerType = GOTItemBanner.BannerType.NORVOS;
	}
}
