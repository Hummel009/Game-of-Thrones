...
public class GOTStructureVolantisStables extends GOTStructureVolantisBase {
	public GOTStructureVolantisStables(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < numnpc; ++l) {
			GOTEntityVolantisMan npc = new GOTEntityVolantisMan(world);
