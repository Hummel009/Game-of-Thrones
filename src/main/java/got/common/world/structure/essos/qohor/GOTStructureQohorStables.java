...
public class GOTStructureQohorStables extends GOTStructureQohorBase {
	public GOTStructureQohorStables(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < numnpc; ++l) {
			GOTEntityQohorMan npc = new GOTEntityQohorMan(world);
