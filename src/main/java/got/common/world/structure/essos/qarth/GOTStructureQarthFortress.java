...
public class GOTStructureQarthFortress extends GOTStructureQarthBase {
	public GOTStructureQarthFortress(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < warriors; ++l) {
			GOTEntityQarthLevyman warrior = new GOTEntityQarthLevyman(world);
		...
		GOTEntityQarthGuardCaptain captain = new GOTEntityQarthGuardCaptain(world);
		captain.spawnRidingHorse = false;
		spawnNPCAndSetHome(captain, world, 0, 1, 4, 8);
		GOTEntityNPCRespawner respawner = new GOTEntityNPCRespawner(world);
		respawner.setSpawnClasses(GOTEntityQarthLevyman.class, GOTEntityQarthLevymanArcher.class);
