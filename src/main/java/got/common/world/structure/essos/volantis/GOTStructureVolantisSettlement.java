...
public class GOTStructureVolantisSettlement extends GOTStructureBaseSettlement {
	...
	public GOTStructureVolantisSettlement setIsTown() {
		isTown = true;
	...
	public class Instance extends GOTStructureBaseSettlement.AbstractInstance<GOTStructureVolantisSettlement> {
		public Type type;

		public Instance(GOTStructureVolantisSettlement settlement, World world, int i, int k, Random random, LocationInfo loc) {
