...
public class GOTStructureLysFortress extends GOTStructureLysBase {
	public GOTStructureLysFortress(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityLysGeneral captain = new GOTEntityLysGeneral(world);
