...
public class GOTStructureVolantisFarm extends GOTStructureVolantisBase {
	public Block crop1Block;
	public Item seed1;
	public Block crop2Block;
	public Item seed2;

	public GOTStructureVolantisFarm(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		this.placeSkull(world, random, 4, 4, 0);
		GOTEntityVolantisSlaver farmer = new GOTEntityVolantisSlaver(world);
