...
public abstract class GOTStructureLysBase extends GOTStructureBase {
	...
	public GOTStructureLysBase(boolean flag) {
		super(flag);
	}
	...
	public void setupRandomBlocks(Random random) {
		...
		tableBlock = GOTRegistry.tableLys;
		...
		bannerType = GOTItemBanner.BannerType.LYS;
	}
}
