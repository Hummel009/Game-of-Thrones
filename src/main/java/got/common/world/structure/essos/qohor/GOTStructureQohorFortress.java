...
public class GOTStructureQohorFortress extends GOTStructureQohorBase {
	public GOTStructureQohorFortress(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < warriors; ++l) {
			GOTEntityQohorUnsullied warrior = new GOTEntityQohorUnsullied(world);
		...
		GOTEntityQohorGuardCaptain captain = new GOTEntityQohorGuardCaptain(world);
		captain.spawnRidingHorse = false;
		spawnNPCAndSetHome(captain, world, 0, 1, 4, 8);
		GOTEntityNPCRespawner respawner = new GOTEntityNPCRespawner(world);
		respawner.setSpawnClasses(GOTEntityQohorUnsullied.class, GOTEntityQohorLevymanArcher.class);
