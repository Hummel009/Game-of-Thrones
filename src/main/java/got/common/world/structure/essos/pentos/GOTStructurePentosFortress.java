...
public class GOTStructurePentosFortress extends GOTStructurePentosBase {
	public GOTStructurePentosFortress(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < warriors; ++l) {
			GOTEntityPentosLevyman warrior = new GOTEntityPentosLevyman(world);
		...
		GOTEntityPentosGuardCaptain captain = new GOTEntityPentosGuardCaptain(world);
		captain.spawnRidingHorse = false;
		spawnNPCAndSetHome(captain, world, 0, 1, 4, 8);
		GOTEntityNPCRespawner respawner = new GOTEntityNPCRespawner(world);
		respawner.setSpawnClasses(GOTEntityPentosLevyman.class, GOTEntityPentosLevymanArcher.class);
