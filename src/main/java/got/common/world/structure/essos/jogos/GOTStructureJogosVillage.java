...
public class GOTStructureJogosVillage extends GOTVillageGen {
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTStructureJogosVillage village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void setupVillage(Random random) {
			if (villageType == VillageType.SMALL) {
				...
				this.addStructure(new GOTStructureJogosTentLarge(false), 0, -8, 0, true);
			...
			while (turn < 1.0f) {
				...
				this.addStructure(new GOTStructureJogosTent(false), i, k, r);
			}
		}
