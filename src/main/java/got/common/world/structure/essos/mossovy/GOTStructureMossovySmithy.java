...
public class GOTStructureMossovySmithy extends GOTStructureMossovyBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		this.placeChest(world, random, 7, 1, 2, 5, GOTChestContents.MOSSOVY);
		...
		this.placeChest(world, random, 1, 1, 2, 5, GOTChestContents.MOSSOVY);
		...
		GOTEntityMossovyWitcher witcher = new GOTEntityMossovyWitcher(world);
		spawnNPCAndSetHome(witcher, world, 0, 1, 0, 8);
		return true;
	}
}
