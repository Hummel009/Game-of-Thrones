...
public class GOTStructureTyroshSettlement extends GOTStructureBaseSettlement {
	...
	@Override
	public GOTStructureBaseSettlement.AbstractInstance<GOTStructureTyroshSettlement> createSettlementInstance(World world, int i, int k, Random random, LocationInfo loc, Runnable filler, Collection<GOTFixer.SpawnInfo> spawnInfos) {
	...
	public static class Instance extends GOTStructureBaseSettlement.AbstractInstance<GOTStructureTyroshSettlement> {
		...
		public Instance(GOTStructureTyroshSettlement settlement, World world, int i, int k, Random random, LocationInfo loc, Runnable filler, Collection<GOTFixer.SpawnInfo> spawnInfos, Type t, boolean b) {
