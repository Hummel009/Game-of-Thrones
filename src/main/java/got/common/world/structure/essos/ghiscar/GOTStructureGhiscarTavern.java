...
public class GOTStructureGhiscarTavern extends GOTStructureGhiscarBase {
	public GOTStructureGhiscarTavern(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < npc; ++l) {
			GOTEntityGhiscarMan npc1 = new GOTEntityGhiscarMan(world);
