...
public class GOTStructureBraavosCity extends GOTVillageGen {
	...
	@Override
	public GOTVillageGen.AbstractInstance<GOTStructureBraavosCity> createVillageInstance(World world, int i, int k, Random random, LocationInfo loc) {
	...
	public class Instance extends GOTVillageGen.AbstractInstance<GOTStructureBraavosCity> {
		public VillageType villageType;

		public Instance(GOTStructureBraavosCity village, World world, int i, int k, Random random, LocationInfo loc) {
		...
		public GOTStructureBase getBazaar(Random random) {
			return new GOTStructureBraavosBazaar(false);
		}
		...
		public GOTStructureBase getFortGate(Random random) {
			return new GOTStructureBraavosFortGate(false);
		}

		public GOTStructureBase getFortress(Random random) {
			return new GOTStructureBraavosFortress(false);
		}
		...
		public GOTStructureBase getMansion(Random random) {
			return new GOTStructureBraavosMansion(false);
		}
		...
		public GOTStructureBase getTavern(Random random) {
			return new GOTStructureBraavosTavern(false);
		}

		public GOTStructureBase getTower(Random random) {
			return new GOTStructureBraavosTower(false);
		}

		public GOTStructureBraavosTownGate getTownGate(Random random) {
			return new GOTStructureBraavosTownGate(false);
		}
