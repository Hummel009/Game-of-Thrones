...
public class GOTStructurePentosBazaar extends GOTStructurePentosBase {
	...
	public static class Brewer extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			this.placeMug(world, random, 2, 2, 0, 1, GOTFoods.ESSOS_DRINK);
			GOTEntityPentosBrewer trader = new GOTEntityPentosBrewer(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Florist extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityPentosFlorist trader = new GOTEntityPentosFlorist(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Lumber extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityPentosLumberman trader = new GOTEntityPentosLumberman(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Mason extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityPentosMason trader = new GOTEntityPentosMason(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Miner extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			placeWeaponRack(world, 1, 2, 1, 2, new ItemStack(GOTRegistry.bronzePickaxe));
			GOTEntityPentosMiner trader = new GOTEntityPentosMiner(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
