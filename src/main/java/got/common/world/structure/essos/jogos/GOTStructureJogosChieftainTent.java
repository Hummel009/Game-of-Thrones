...
import got.common.entity.essos.jogos.GOTEntityJogosChieftain;
...
public class GOTStructureJogosChieftainTent extends GOTStructureJogosBase {
	public GOTStructureJogosChieftainTent(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setBlockAndMetadata(world, 1, 4, -9, Blocks.skull, 2);
		GOTEntityNPC chief = new GOTEntityJogosChieftain(world);
