...
public class GOTStructureVolantisMansion extends GOTStructureVolantisBase {
	public GOTStructureVolantisMansion(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		this.placeChest(world, random, -3, 1, 3, GOTRegistry.chestBasket, 2, GOTChestContents.ESSOS);
		...
		placeFlowerPot(world, 9, 6, 3, new ItemStack(GOTRegistry.sapling3, 1, 2));
		GOTEntityVolantisMan male = new GOTEntityVolantisMan(world);
		male.familyInfo.setMale(true);
		male.setCurrentItemOrArmor(4, new ItemStack(GOTRegistry.goldRing));
		spawnNPCAndSetHome(male, world, 0, 1, 0, 16);
		GOTEntityVolantisMan female = new GOTEntityVolantisMan(world);
		...
		GOTEntityVolantisMan child = new GOTEntityVolantisMan(world);
