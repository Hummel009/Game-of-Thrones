...
public class GOTStructureVolantisCity extends GOTVillageGen {
	...
	@Override
	public GOTVillageGen.AbstractInstance<GOTStructureVolantisCity> createVillageInstance(World world, int i, int k, Random random, LocationInfo loc) {
	...
	public class Instance extends GOTVillageGen.AbstractInstance<GOTStructureVolantisCity> {
		public VillageType villageType;

		public Instance(GOTStructureVolantisCity village, World world, int i, int k, Random random, LocationInfo loc) {
		...
		public GOTStructureBase getBarracks(Random random) {
			return new GOTStructureVolantisBarracks(false);
		}

		public GOTStructureBase getBazaar(Random random) {
			return new GOTStructureVolantisBazaar(false);
		}

		public GOTStructureBase getFlowers(Random random) {
			return new GOTStructureVolantisTownFlowers(false);
		}

		public GOTStructureBase getFortCorner(Random random) {
			return new GOTStructureVolantisFortCorner(false);
		}

		public GOTStructureBase getFortGate(Random random) {
			return new GOTStructureVolantisFortGate(false);
		}

		public GOTStructureBase getFortress(Random random) {
			return new GOTStructureVolantisFortress(false);
		}

		public GOTStructureBase getFortWallLong(Random random) {
			return new GOTStructureVolantisFortWall.Long(false);
		}

		public GOTStructureBase getFortWallShort(Random random) {
			return new GOTStructureVolantisFortWall.Short(false);
		}
		...
		public GOTStructureBase getLamp(Random random) {
			return new GOTStructureVolantisLamp(false);
		}

		public GOTStructureBase getMansion(Random random) {
			return new GOTStructureVolantisMansion(false);
		}
		...
		public GOTStructureBase getStatue(Random random) {
			return new GOTStructureVolantisStatue(false);
		}

		public GOTStructureBase getTavern(Random random) {
			return new GOTStructureVolantisTavern(false);
		}

		public GOTStructureBase getTower(Random random) {
			return new GOTStructureVolantisTower(false);
		}

		public GOTStructureVolantisTownGate getTownGate(Random random) {
			return new GOTStructureVolantisTownGate(false);
		}

		public GOTStructureBase getTownWallCorner(Random random) {
			return new GOTStructureVolantisTownCorner(false);
		}

		public GOTStructureBase getTownWallExtra(Random random) {
			return new GOTStructureVolantisTownWall.Extra(false);
		}

		public GOTStructureBase getTownWallLong(Random random) {
			return new GOTStructureVolantisTownWall.Long(false);
		}

		public GOTStructureBase getTownWallShort(Random random) {
			return new GOTStructureVolantisTownWall.Short(false);
		}

		public GOTStructureBase getTownWallSideMid(Random random) {
			return new GOTStructureVolantisTownWall.SideMid(false);
		}

		public GOTStructureBase getTraining(Random random) {
			return new GOTStructureVolantisTraining(false);
		}

		public GOTStructureBase getTree(Random random) {
			return new GOTStructureVolantisTownTree(false);
		}

		public GOTStructureBase getWell(Random random) {
			return new GOTStructureVolantisWell(false);
		}
