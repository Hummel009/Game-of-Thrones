...
public class GOTStructurePentosCity extends GOTVillageGen {
	...
	@Override
	public GOTVillageGen.AbstractInstance<GOTStructurePentosCity> createVillageInstance(World world, int i, int k, Random random, LocationInfo loc) {
		return new Instance(this, world, i, k, random, loc);
	}

	public GOTStructurePentosCity setIsTown() {
		isTown = true;
		return this;
	}
	...
	public class Instance extends GOTVillageGen.AbstractInstance<GOTStructurePentosCity> {
		public VillageType villageType;

		public Instance(GOTStructurePentosCity village, World world, int i, int k, Random random, LocationInfo loc) {
		...
		public GOTStructureBase getBarracks(Random random) {
			return new GOTStructurePentosBarracks(false);
		}

		public GOTStructureBase getBazaar(Random random) {
			return new GOTStructurePentosBazaar(false);
		}

		public GOTStructureBase getFlowers(Random random) {
			return new GOTStructurePentosTownFlowers(false);
		}

		public GOTStructureBase getFortCorner(Random random) {
			return new GOTStructurePentosFortCorner(false);
		}

		public GOTStructureBase getFortGate(Random random) {
			return new GOTStructurePentosFortGate(false);
		}

		public GOTStructureBase getFortress(Random random) {
			return new GOTStructurePentosFortress(false);
		}

		public GOTStructureBase getFortWallLong(Random random) {
			return new GOTStructurePentosFortWall.Long(false);
		}

		public GOTStructureBase getFortWallShort(Random random) {
			return new GOTStructurePentosFortWall.Short(false);
		}
		...
		public GOTStructureBase getLamp(Random random) {
			return new GOTStructurePentosLamp(false);
		}

		public GOTStructureBase getMansion(Random random) {
			return new GOTStructurePentosMansion(false);
		}
		...
		public void setCivilianSpawnClass(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClass(GOTEntityPentosMan.class);
		}
