...
public class GOTStructureVolantisSmithy extends GOTStructureVolantisBase {
	public GOTStructureVolantisSmithy(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityVolantisBlacksmith npc = new GOTEntityVolantisBlacksmith(world);
