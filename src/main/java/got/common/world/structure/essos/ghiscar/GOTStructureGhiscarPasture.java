...
public class GOTStructureGhiscarPasture extends GOTStructureGhiscarBase {
	public GOTStructureGhiscarPasture(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < animals; ++l) {
			EntityAnimal animal = GOTStructureGhiscarPasture.getRandomAnimal(world, random);
