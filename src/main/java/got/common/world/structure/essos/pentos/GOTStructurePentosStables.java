...
public class GOTStructurePentosStables extends GOTStructurePentosBase {
	public GOTStructurePentosStables(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < numnpc; ++l) {
			GOTEntityPentosMan npc = new GOTEntityPentosMan(world);
