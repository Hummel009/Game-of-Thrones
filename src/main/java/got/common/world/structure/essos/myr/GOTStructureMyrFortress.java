...
public class GOTStructureMyrFortress extends GOTStructureMyrBase {
	public GOTStructureMyrFortress(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < warriors; ++l) {
			GOTEntityMyrLevyman warrior = new GOTEntityMyrLevyman(world);
		...
		GOTEntityMyrGeneral captain = new GOTEntityMyrGeneral(world);
		captain.spawnRidingHorse = false;
		spawnNPCAndSetHome(captain, world, 0, 1, 4, 8);
		GOTEntityNPCRespawner respawner = new GOTEntityNPCRespawner(world);
		respawner.setSpawnClasses(GOTEntityMyrLevyman.class, GOTEntityMyrLevymanArcher.class);
