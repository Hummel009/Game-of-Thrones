...
public abstract class GOTStructureVolantisBase extends GOTStructureBase {
	...
	public GOTStructureVolantisBase(boolean flag) {
		super(flag);
	}
	...
	public void setupRandomBlocks(Random random) {
		...
		tableBlock = GOTRegistry.tableVolantis;
