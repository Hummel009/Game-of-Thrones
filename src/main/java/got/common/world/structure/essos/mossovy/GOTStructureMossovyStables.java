...
public class GOTStructureMossovyStables extends GOTStructureMossovyBase {
	public GOTStructureMossovyStables(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		this.placeChest(world, random, -2, 1, 3, 2, GOTChestContents.MOSSOVY);
		...
		this.placeChest(world, random, -3, 5, 5, 4, GOTChestContents.MOSSOVY);
