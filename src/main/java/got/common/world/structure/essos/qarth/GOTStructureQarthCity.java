...
public class GOTStructureQarthCity extends GOTVillageGen {
	...
	@Override
	public GOTVillageGen.AbstractInstance<GOTStructureQarthCity> createVillageInstance(World world, int i, int k, Random random, LocationInfo loc) {
	...
	public class Instance extends GOTVillageGen.AbstractInstance<GOTStructureQarthCity> {
		public VillageType villageType;

		public Instance(GOTStructureQarthCity village, World world, int i, int k, Random random, LocationInfo loc) {
		...
		public GOTStructureBase getBarracks(Random random) {
			return new GOTStructureQarthBarracks(false);
		}

		public GOTStructureBase getBazaar(Random random) {
			return new GOTStructureQarthBazaar(false);
		}
		...
		public GOTStructureBase getFortGate(Random random) {
			return new GOTStructureQarthFortGate(false);
		}

		public GOTStructureBase getFortress(Random random) {
			return new GOTStructureQarthFortress(false);
		}
		...
		public GOTStructureBase getMansion(Random random) {
			return new GOTStructureQarthMansion(false);
		}
		...
		public GOTStructureBase getTavern(Random random) {
			return new GOTStructureQarthTavern(false);
		}

		public GOTStructureBase getTower(Random random) {
			return new GOTStructureQarthTower(false);
		}

		public GOTStructureQarthTownGate getTownGate(Random random) {
			return new GOTStructureQarthTownGate(false);
		}
		...
		public void setCivilianSpawnClass(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClass(GOTEntityQarthMan.class);
		}
