...
public class GOTStructureLorathMansion extends GOTStructureLorathBase {
	public GOTStructureLorathMansion(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeFlowerPot(world, 9, 6, 3, new ItemStack(GOTRegistry.sapling3, 1, 2));
		GOTEntityLorathMan male = new GOTEntityLorathMan(world);
		male.familyInfo.setMale(true);
		male.setCurrentItemOrArmor(4, new ItemStack(GOTRegistry.goldRing));
		spawnNPCAndSetHome(male, world, 0, 1, 0, 16);
		GOTEntityLorathMan female = new GOTEntityLorathMan(world);
		...
		GOTEntityLorathMan child = new GOTEntityLorathMan(world);
