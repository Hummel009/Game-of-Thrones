...
public class GOTStructureBraavosStables extends GOTStructureBraavosBase {
	public GOTStructureBraavosStables(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < numnpc; ++l) {
			GOTEntityBraavosMan npc = new GOTEntityBraavosMan(world);
