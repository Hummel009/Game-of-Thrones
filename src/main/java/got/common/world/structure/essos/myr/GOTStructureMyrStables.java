...
public class GOTStructureMyrStables extends GOTStructureMyrBase {
	public GOTStructureMyrStables(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < numnpc; ++l) {
			GOTEntityMyrMan npc = new GOTEntityMyrMan(world);
