...
public class GOTStructureMyrMansion extends GOTStructureMyrBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityMyrMan child = new GOTEntityMyrMan(world);
