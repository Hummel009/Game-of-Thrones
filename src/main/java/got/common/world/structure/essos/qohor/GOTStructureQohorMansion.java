...
public class GOTStructureQohorMansion extends GOTStructureQohorBase {
	public GOTStructureQohorMansion(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityQohorMan child = new GOTEntityQohorMan(world);
