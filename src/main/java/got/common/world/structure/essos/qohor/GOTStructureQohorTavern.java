...
public class GOTStructureQohorTavern extends GOTStructureQohorBase {
	public GOTStructureQohorTavern(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 2, 5, -15, bannerType, 0);
		GOTEntityQohorBartender bartender = new GOTEntityQohorBartender(world);
		spawnNPCAndSetHome(bartender, world, -2, 1, 8, 4);
		int npc = 4 + random.nextInt(10);
		for (int l = 0; l < npc; ++l) {
			GOTEntityQohorMan npc1 = new GOTEntityQohorMan(world);
