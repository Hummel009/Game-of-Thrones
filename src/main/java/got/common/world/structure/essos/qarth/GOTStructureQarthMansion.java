...
public class GOTStructureQarthMansion extends GOTStructureQarthBase {
	public GOTStructureQarthMansion(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityQarthMan child = new GOTEntityQarthMan(world);
