...
public class GOTStructureBraavosFarm extends GOTStructureBraavosBase {
	public Block crop1Block;
	public Item seed1;
	public Block crop2Block;
	public Item seed2;

	public GOTStructureBraavosFarm(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		if (random.nextInt(4) == 0) {
			GOTEntityBraavosFarmer farmer = new GOTEntityBraavosFarmer(world);
