...
public class GOTStructureNorvosSettlement extends GOTStructureBaseSettlement {
	...
	@Override
	public GOTStructureBaseSettlement.AbstractInstance<GOTStructureNorvosSettlement> createSettlementInstance(World world, int i, int k, Random random, LocationInfo loc, Runnable filler, Collection<GOTFixer.SpawnInfo> spawnInfos, GOTStructureBase specialStructure) {
	...
	public static class Instance extends GOTStructureBaseSettlement.AbstractInstance<GOTStructureNorvosSettlement> {
		...
		public Instance(GOTStructureNorvosSettlement settlement, World world, int i, int k, Random random, LocationInfo loc, Runnable filler, Collection<GOTFixer.SpawnInfo> spawnInfos, GOTStructureBase specialStructure, Type t, boolean b) {
