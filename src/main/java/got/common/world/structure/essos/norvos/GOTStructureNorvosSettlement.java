...
public class GOTStructureNorvosSettlement extends GOTStructureBaseSettlement {
	...
	@Override
	public GOTStructureBaseSettlement.AbstractInstance<GOTStructureNorvosSettlement> createSettlementInstance(World world, int i, int k, Random random, LocationInfo loc) {
		return new Instance(this, world, i, k, random, loc);
	}

	public GOTStructureNorvosSettlement setIsTown() {
		isTown = true;
	...
	public class Instance extends GOTStructureBaseSettlement.AbstractInstance<GOTStructureNorvosSettlement> {
		public Type type;

		public Instance(GOTStructureNorvosSettlement settlement, World world, int i, int k, Random random, LocationInfo loc) {
		...
		public GOTStructureBase getBarracks(Random random) {
			return new GOTStructureNorvosBarracks(false);
		}
		...
		public GOTStructureBase getFlowers(Random random) {
			return new GOTStructureNorvosTownFlowers(false);
		}

		public GOTStructureBase getFortCorner(Random random) {
			return new GOTStructureNorvosFortCorner(false);
		}

		public GOTStructureBase getFortGate(Random random) {
			return new GOTStructureNorvosFortGate(false);
		}

		public GOTStructureBase getFortress(Random random) {
			return new GOTStructureNorvosFortress(false);
		}

		public GOTStructureBase getFortWallLong(Random random) {
			return new GOTStructureNorvosFortWall.Long(false);
		}

		public GOTStructureBase getFortWallShort(Random random) {
			return new GOTStructureNorvosFortWall.Short(false);
		}
		...
		public GOTStructureBase getLamp(Random random) {
			return new GOTStructureNorvosLamp(false);
		}
