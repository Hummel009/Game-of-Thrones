...
public class GOTStructureTyroshCity extends GOTVillageGen {
	...
	public GOTStructureTyroshCity(GOTBiome biome, float f) {
		super(biome);
		spawnChance = f;
	...
	@Override
	public GOTVillageGen.AbstractInstance<GOTStructureTyroshCity> createVillageInstance(World world, int i, int k, Random random, LocationInfo loc) {
		return new Instance(this, world, i, k, random, loc);
	}

	public GOTStructureTyroshCity setIsTown() {
		isTown = true;
	...
	public class Instance extends GOTVillageGen.AbstractInstance<GOTStructureTyroshCity> {
		public VillageType villageType;

		public Instance(GOTStructureTyroshCity village, World world, int i, int k, Random random, LocationInfo loc) {
