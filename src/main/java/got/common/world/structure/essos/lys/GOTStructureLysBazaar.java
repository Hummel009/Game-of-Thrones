...
public class GOTStructureLysBazaar extends GOTStructureLysBase {
	...
	public static class Blacksmith extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			placeWeaponRack(world, -2, 2, 0, 1, new GOTStructureLysBazaar(false).getRandomWeapon(random));
			placeWeaponRack(world, 2, 2, 0, 3, new GOTStructureLysBazaar(false).getRandomWeapon(random));
