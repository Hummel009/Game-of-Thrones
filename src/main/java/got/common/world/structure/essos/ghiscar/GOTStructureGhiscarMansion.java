...
public class GOTStructureGhiscarMansion extends GOTStructureGhiscarBase {
	public GOTStructureGhiscarMansion(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeFlowerPot(world, 9, 6, 3, new ItemStack(GOTRegistry.sapling3, 1, 2));
		GOTEntityGhiscarMan male = new GOTEntityGhiscarMan(world);
		male.familyInfo.setMale(true);
		male.setCurrentItemOrArmor(4, new ItemStack(GOTRegistry.goldRing));
		spawnNPCAndSetHome(male, world, 0, 1, 0, 16);
		GOTEntityGhiscarMan female = new GOTEntityGhiscarMan(world);
		...
		GOTEntityGhiscarMan child = new GOTEntityGhiscarMan(world);
