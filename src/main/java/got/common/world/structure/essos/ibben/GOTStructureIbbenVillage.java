...
public class GOTStructureIbbenVillage extends GOTVillageGen {
	...
	@Override
	public GOTVillageGen.AbstractInstance<GOTStructureIbbenVillage> createVillageInstance(World world, int i, int k, Random random, LocationInfo loc) {
	...
	public static class Instance extends GOTVillageGen.AbstractInstance<GOTStructureIbbenVillage> {
