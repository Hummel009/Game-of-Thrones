...
public class GOTStructureLorathStables extends GOTStructureLorathBase {
	public GOTStructureLorathStables(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < numnpc; ++l) {
			GOTEntityLorathMan npc = new GOTEntityLorathMan(world);
