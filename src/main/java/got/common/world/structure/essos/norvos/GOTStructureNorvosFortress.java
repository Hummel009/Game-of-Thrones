...
public class GOTStructureNorvosFortress extends GOTStructureNorvosBase {
	public GOTStructureNorvosFortress(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < warriors; ++l) {
			GOTEntityNorvosLevyman warrior = new GOTEntityNorvosLevyman(world);
		...
		GOTEntityNorvosGuardCaptain captain = new GOTEntityNorvosGuardCaptain(world);
		captain.spawnRidingHorse = false;
		spawnNPCAndSetHome(captain, world, 0, 1, 4, 8);
		GOTEntityNPCRespawner respawner = new GOTEntityNPCRespawner(world);
		respawner.setSpawnClasses(GOTEntityNorvosLevyman.class, GOTEntityNorvosLevymanArcher.class);
