...
public class GOTStructureBraavosPasture extends GOTStructureBraavosBase {
	public GOTStructureBraavosPasture(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < animals; ++l) {
			EntityAnimal animal = GOTStructureBraavosPasture.getRandomAnimal(world, random);
