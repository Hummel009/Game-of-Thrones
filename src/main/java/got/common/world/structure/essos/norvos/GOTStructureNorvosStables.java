...
public class GOTStructureNorvosStables extends GOTStructureNorvosBase {
	public GOTStructureNorvosStables(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < numnpc; ++l) {
			GOTEntityNorvosMan npc = new GOTEntityNorvosMan(world);
