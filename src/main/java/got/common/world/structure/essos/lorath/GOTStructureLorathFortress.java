...
public class GOTStructureLorathFortress extends GOTStructureLorathBase {
	public GOTStructureLorathFortress(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < warriors; ++l) {
			GOTEntityLorathLevyman warrior = new GOTEntityLorathLevyman(world);
		...
		GOTEntityLorathGeneral captain = new GOTEntityLorathGeneral(world);
		captain.spawnRidingHorse = false;
		spawnNPCAndSetHome(captain, world, 0, 1, 4, 8);
		GOTEntityNPCRespawner respawner = new GOTEntityNPCRespawner(world);
		respawner.setSpawnClasses(GOTEntityLorathLevyman.class, GOTEntityLorathLevymanArcher.class);
