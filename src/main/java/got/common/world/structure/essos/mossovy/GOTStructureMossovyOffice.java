...
public class GOTStructureMossovyOffice extends GOTStructureMossovyBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placePlate(world, random, -6, 6, -2, GOTRegistry.plateBlock, GOTFoods.WESTEROS);
		placePlate(world, random, 5, 6, 1, GOTRegistry.ceramicPlateBlock, GOTFoods.WESTEROS);
		...
		setBlockAndMetadata(world, 6, 1, -1, GOTRegistry.strawBed, 2);
		setBlockAndMetadata(world, 6, 1, -2, GOTRegistry.strawBed, 10);
		setBlockAndMetadata(world, 6, 1, 1, GOTRegistry.strawBed, 0);
		setBlockAndMetadata(world, 6, 1, 2, GOTRegistry.strawBed, 8);
		...
		setBlockAndMetadata(world, -5, 9, 0, GOTRegistry.strawBed, 3);
		setBlockAndMetadata(world, -6, 9, 0, GOTRegistry.strawBed, 11);
