...
public class GOTStructureMyrSettlement extends GOTStructureBaseSettlement {
	...
	@Override
	public GOTStructureBaseSettlement.AbstractInstance<GOTStructureMyrSettlement> createSettlementInstance(World world, int i, int k, Random random, LocationInfo loc) {
		return new Instance(this, world, i, k, random, loc);
	}

	public GOTStructureMyrSettlement setIsTown() {
		isTown = true;
	...
	public class Instance extends GOTStructureBaseSettlement.AbstractInstance<GOTStructureMyrSettlement> {
		public Type type;

		public Instance(GOTStructureMyrSettlement settlement, World world, int i, int k, Random random, LocationInfo loc) {
