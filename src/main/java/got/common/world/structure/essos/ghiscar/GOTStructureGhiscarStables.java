...
public class GOTStructureGhiscarStables extends GOTStructureGhiscarBase {
	public GOTStructureGhiscarStables(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < numnpc; ++l) {
			GOTEntityGhiscarMan npc = new GOTEntityGhiscarMan(world);
