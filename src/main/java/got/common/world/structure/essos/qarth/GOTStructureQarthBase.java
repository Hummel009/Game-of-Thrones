...
public abstract class GOTStructureQarthBase extends GOTStructureBase {
	...
	public GOTStructureQarthBase(boolean flag) {
		super(flag);
	}
	...
	public void setupRandomBlocks(Random random) {
		...
		tableBlock = GOTRegistry.tableQarth;
		...
		bannerType = GOTItemBanner.BannerType.QARTH;
	}
}
