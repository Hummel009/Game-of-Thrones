...
public class GOTStructureBraavosMansion extends GOTStructureBraavosBase {
	public GOTStructureBraavosMansion(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeFlowerPot(world, 9, 6, 3, new ItemStack(GOTRegistry.sapling3, 1, 2));
		GOTEntityBraavosMan male = new GOTEntityBraavosMan(world);
		male.familyInfo.setMale(true);
		male.setCurrentItemOrArmor(4, new ItemStack(GOTRegistry.goldRing));
		spawnNPCAndSetHome(male, world, 0, 1, 0, 16);
		GOTEntityBraavosMan female = new GOTEntityBraavosMan(world);
		...
		GOTEntityBraavosMan child = new GOTEntityBraavosMan(world);
