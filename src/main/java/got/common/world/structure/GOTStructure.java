...
public class GOTStructure {
	...
	public static void onInit() {
		...
		GOTStructureRegistry.register(id++, new GOTStructureIronbornSettlement(GOTBiome.ironborn, 1.0f), "IronbornCityLittle", GOTFaction.IRONBORN, (GOTStructureRegistry.ISettlementProperties<GOTStructureIronbornSettlement.Instance>) instance -> instance.setType(GOTStructureIronbornSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureIronbornSettlement(GOTBiome.ironborn, 1.0f), "IronbornCityBig", GOTFaction.IRONBORN, (GOTStructureRegistry.ISettlementProperties<GOTStructureIronbornSettlement.Instance>) instance -> instance.setType(GOTStructureIronbornSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureIronbornSettlement(GOTBiome.ironborn, 1.0f), "IronbornCityMedium", GOTFaction.IRONBORN, (GOTStructureRegistry.ISettlementProperties<GOTStructureIronbornSettlement.Instance>) instance -> instance.setType(GOTStructureIronbornSettlement.Type.FORT));
