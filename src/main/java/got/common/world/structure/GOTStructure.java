...
public class GOTStructure {
	...
	public static void onInit() {
		...
		GOTStructureRegistry.register(id++, new GOTStructureWildlingSettlement(GOTBiome.hauntedForest, 1.0f), "WildlingVillage", GOTFaction.WILDLING, (GOTStructureRegistry.ISettlementProperties<GOTStructureWildlingSettlement.Instance>) instance -> instance.setType(GOTStructureWildlingSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureWildlingSettlement(GOTBiome.thennLand, 1.0f), "ThennVillage", GOTFaction.WILDLING, (GOTStructureRegistry.ISettlementProperties<GOTStructureWildlingSettlement.Instance>) instance -> instance.setType(GOTStructureWildlingSettlement.Type.THENN));

		GOTStructureRegistry.register(id++, new GOTStructureGiftSettlement(GOTBiome.giftNew, 1.0f), "GiftVillage", GOTFaction.NIGHT_WATCH, (GOTStructureRegistry.ISettlementProperties<GOTStructureGiftSettlement.Instance>) instance -> instance.setType(GOTStructureGiftSettlement.Type.VILLAGE));

		GOTStructureRegistry.register(id++, new GOTStructureNorthSettlement(GOTBiome.skagos, 1.0f), "NorthHillmanVillage", GOTFaction.NORTH, (GOTStructureRegistry.ISettlementProperties<GOTStructureNorthSettlement.Instance>) instance -> instance.setType(GOTStructureNorthSettlement.Type.HILLMAN));
		GOTStructureRegistry.register(id++, new GOTStructureNorthSettlement(GOTBiome.north, 1.0f), "NorthVillage", GOTFaction.NORTH, (GOTStructureRegistry.ISettlementProperties<GOTStructureNorthSettlement.Instance>) instance -> instance.setType(GOTStructureNorthSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureNorthSettlement(GOTBiome.north, 1.0f), "NorthTown", GOTFaction.NORTH, (GOTStructureRegistry.ISettlementProperties<GOTStructureNorthSettlement.Instance>) instance -> instance.setType(GOTStructureNorthSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureNorthSettlement(GOTBiome.north, 1.0f), "NorthFortVillage", GOTFaction.NORTH, (GOTStructureRegistry.ISettlementProperties<GOTStructureNorthSettlement.Instance>) instance -> instance.setType(GOTStructureNorthSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureIronbornSettlement(GOTBiome.ironIslands, 1.0f), "IronbornCityLittle", GOTFaction.IRONBORN, (GOTStructureRegistry.ISettlementProperties<GOTStructureIronbornSettlement.Instance>) instance -> instance.setType(GOTStructureIronbornSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureIronbornSettlement(GOTBiome.ironIslands, 1.0f), "IronbornCityBig", GOTFaction.IRONBORN, (GOTStructureRegistry.ISettlementProperties<GOTStructureIronbornSettlement.Instance>) instance -> instance.setType(GOTStructureIronbornSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureIronbornSettlement(GOTBiome.ironIslands, 1.0f), "IronbornCityMedium", GOTFaction.IRONBORN, (GOTStructureRegistry.ISettlementProperties<GOTStructureIronbornSettlement.Instance>) instance -> instance.setType(GOTStructureIronbornSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureWesterlandsSettlement(GOTBiome.westerlands, 1.0f), "WesterlandsCityLittle", GOTFaction.WESTERLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureWesterlandsSettlement.Instance>) instance -> instance.setType(GOTStructureWesterlandsSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureWesterlandsSettlement(GOTBiome.westerlands, 1.0f), "WesterlandsCityBig", GOTFaction.WESTERLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureWesterlandsSettlement.Instance>) instance -> instance.setType(GOTStructureWesterlandsSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureWesterlandsSettlement(GOTBiome.westerlands, 1.0f), "WesterlandsCityMedium", GOTFaction.WESTERLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureWesterlandsSettlement.Instance>) instance -> instance.setType(GOTStructureWesterlandsSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureRiverlandsSettlement(GOTBiome.riverlands, 1.0f), "RiverlandsCityLittle", GOTFaction.RIVERLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureRiverlandsSettlement.Instance>) instance -> instance.setType(GOTStructureRiverlandsSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureRiverlandsSettlement(GOTBiome.riverlands, 1.0f), "RiverlandsCityBig", GOTFaction.RIVERLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureRiverlandsSettlement.Instance>) instance -> instance.setType(GOTStructureRiverlandsSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureRiverlandsSettlement(GOTBiome.riverlands, 1.0f), "RiverlandsCityMedium", GOTFaction.RIVERLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureRiverlandsSettlement.Instance>) instance -> instance.setType(GOTStructureRiverlandsSettlement.Type.FORT));
		...
		GOTStructureRegistry.register(id++, new GOTStructureArrynSettlement(GOTBiome.arryn, 1.0f), "ArrynCityLittle", GOTFaction.ARRYN, (GOTStructureRegistry.ISettlementProperties<GOTStructureArrynSettlement.Instance>) instance -> instance.setType(GOTStructureArrynSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureArrynSettlement(GOTBiome.arryn, 1.0f), "ArrynCityBig", GOTFaction.ARRYN, (GOTStructureRegistry.ISettlementProperties<GOTStructureArrynSettlement.Instance>) instance -> instance.setType(GOTStructureArrynSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureArrynSettlement(GOTBiome.arryn, 1.0f), "ArrynCityMedium", GOTFaction.ARRYN, (GOTStructureRegistry.ISettlementProperties<GOTStructureArrynSettlement.Instance>) instance -> instance.setType(GOTStructureArrynSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureDragonstoneSettlement(GOTBiome.dragonstone, 1.0f), "DragonstoneCityLittle", GOTFaction.DRAGONSTONE, (GOTStructureRegistry.ISettlementProperties<GOTStructureDragonstoneSettlement.Instance>) instance -> instance.setType(GOTStructureDragonstoneSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureDragonstoneSettlement(GOTBiome.dragonstone, 1.0f), "DragonstoneCityBig", GOTFaction.DRAGONSTONE, (GOTStructureRegistry.ISettlementProperties<GOTStructureDragonstoneSettlement.Instance>) instance -> instance.setType(GOTStructureDragonstoneSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureDragonstoneSettlement(GOTBiome.dragonstone, 1.0f), "DragonstoneCityMedium", GOTFaction.DRAGONSTONE, (GOTStructureRegistry.ISettlementProperties<GOTStructureDragonstoneSettlement.Instance>) instance -> instance.setType(GOTStructureDragonstoneSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureCrownlandsSettlement(GOTBiome.crownlands, 1.0f), "CrownlandsCityLittle", GOTFaction.CROWNLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureCrownlandsSettlement.Instance>) instance -> instance.setType(GOTStructureCrownlandsSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureCrownlandsSettlement(GOTBiome.crownlands, 1.0f), "CrownlandsCityBig", GOTFaction.CROWNLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureCrownlandsSettlement.Instance>) instance -> instance.setType(GOTStructureCrownlandsSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureCrownlandsSettlement(GOTBiome.crownlands, 1.0f), "CrownlandsCityMedium", GOTFaction.CROWNLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureCrownlandsSettlement.Instance>) instance -> instance.setType(GOTStructureCrownlandsSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureStormlandsSettlement(GOTBiome.stormlands, 1.0f), "StormlandsCityLittle", GOTFaction.STORMLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureStormlandsSettlement.Instance>) instance -> instance.setType(GOTStructureStormlandsSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureStormlandsSettlement(GOTBiome.stormlands, 1.0f), "StormlandsCityBig", GOTFaction.STORMLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureStormlandsSettlement.Instance>) instance -> instance.setType(GOTStructureStormlandsSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureStormlandsSettlement(GOTBiome.stormlands, 1.0f), "StormlandsCityMedium", GOTFaction.STORMLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureStormlandsSettlement.Instance>) instance -> instance.setType(GOTStructureStormlandsSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureReachSettlement(GOTBiome.reach, 1.0f), "ReachCityLittle", GOTFaction.REACH, (GOTStructureRegistry.ISettlementProperties<GOTStructureReachSettlement.Instance>) instance -> instance.setType(GOTStructureReachSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureReachSettlement(GOTBiome.reach, 1.0f), "ReachCityBig", GOTFaction.REACH, (GOTStructureRegistry.ISettlementProperties<GOTStructureReachSettlement.Instance>) instance -> instance.setType(GOTStructureReachSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureReachSettlement(GOTBiome.reach, 1.0f), "ReachCityMedium", GOTFaction.REACH, (GOTStructureRegistry.ISettlementProperties<GOTStructureReachSettlement.Instance>) instance -> instance.setType(GOTStructureReachSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureDorneSettlement(GOTBiome.dorne, 1.0f), "DorneCityLittle", GOTFaction.DORNE, (GOTStructureRegistry.ISettlementProperties<GOTStructureDorneSettlement.Instance>) instance -> instance.setType(GOTStructureDorneSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureDorneSettlement(GOTBiome.dorne, 1.0f), "DorneCityBig", GOTFaction.DORNE, (GOTStructureRegistry.ISettlementProperties<GOTStructureDorneSettlement.Instance>) instance -> instance.setType(GOTStructureDorneSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureDorneSettlement(GOTBiome.dorne, 1.0f), "DorneCityMedium", GOTFaction.DORNE, (GOTStructureRegistry.ISettlementProperties<GOTStructureDorneSettlement.Instance>) instance -> instance.setType(GOTStructureDorneSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureBraavosSettlement(GOTBiome.braavos, 1.0f), "BraavosCityLittle", GOTFaction.BRAAVOS, (GOTStructureRegistry.ISettlementProperties<GOTStructureBraavosSettlement.Instance>) instance -> instance.setType(GOTStructureBraavosSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureBraavosSettlement(GOTBiome.braavos, 1.0f), "BraavosCityMedium", GOTFaction.BRAAVOS, (GOTStructureRegistry.ISettlementProperties<GOTStructureBraavosSettlement.Instance>) instance -> instance.setType(GOTStructureBraavosSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureBraavosSettlement(GOTBiome.braavos, 1.0f), "BraavosCityBig", GOTFaction.BRAAVOS, (GOTStructureRegistry.ISettlementProperties<GOTStructureBraavosSettlement.Instance>) instance -> instance.setType(GOTStructureBraavosSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureVolantisSettlement(GOTBiome.volantis, 1.0f), "VolantisCityLittle", GOTFaction.VOLANTIS, (GOTStructureRegistry.ISettlementProperties<GOTStructureVolantisSettlement.Instance>) instance -> instance.setType(GOTStructureVolantisSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureVolantisSettlement(GOTBiome.volantis, 1.0f), "VolantisCityMedium", GOTFaction.VOLANTIS, (GOTStructureRegistry.ISettlementProperties<GOTStructureVolantisSettlement.Instance>) instance -> instance.setType(GOTStructureVolantisSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureVolantisSettlement(GOTBiome.volantis, 1.0f), "VolantisCityBig", GOTFaction.VOLANTIS, (GOTStructureRegistry.ISettlementProperties<GOTStructureVolantisSettlement.Instance>) instance -> instance.setType(GOTStructureVolantisSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructurePentosSettlement(GOTBiome.pentos, 1.0f), "PentosCityLittle", GOTFaction.PENTOS, (GOTStructureRegistry.ISettlementProperties<GOTStructurePentosSettlement.Instance>) instance -> instance.setType(GOTStructurePentosSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructurePentosSettlement(GOTBiome.pentos, 1.0f), "PentosCityMedium", GOTFaction.PENTOS, (GOTStructureRegistry.ISettlementProperties<GOTStructurePentosSettlement.Instance>) instance -> instance.setType(GOTStructurePentosSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructurePentosSettlement(GOTBiome.pentos, 1.0f), "PentosCityBig", GOTFaction.PENTOS, (GOTStructureRegistry.ISettlementProperties<GOTStructurePentosSettlement.Instance>) instance -> instance.setType(GOTStructurePentosSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureNorvosSettlement(GOTBiome.norvos, 1.0f), "NorvosCityLittle", GOTFaction.NORVOS, (GOTStructureRegistry.ISettlementProperties<GOTStructureNorvosSettlement.Instance>) instance -> instance.setType(GOTStructureNorvosSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureNorvosSettlement(GOTBiome.norvos, 1.0f), "NorvosCityMedium", GOTFaction.NORVOS, (GOTStructureRegistry.ISettlementProperties<GOTStructureNorvosSettlement.Instance>) instance -> instance.setType(GOTStructureNorvosSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureNorvosSettlement(GOTBiome.norvos, 1.0f), "NorvosCityBig", GOTFaction.NORVOS, (GOTStructureRegistry.ISettlementProperties<GOTStructureNorvosSettlement.Instance>) instance -> instance.setType(GOTStructureNorvosSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureLorathSettlement(GOTBiome.lorath, 1.0f), "LorathCityLittle", GOTFaction.LORATH, (GOTStructureRegistry.ISettlementProperties<GOTStructureLorathSettlement.Instance>) instance -> instance.setType(GOTStructureLorathSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureLorathSettlement(GOTBiome.lorath, 1.0f), "LorathCityMedium", GOTFaction.LORATH, (GOTStructureRegistry.ISettlementProperties<GOTStructureLorathSettlement.Instance>) instance -> instance.setType(GOTStructureLorathSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureLorathSettlement(GOTBiome.lorath, 1.0f), "LorathCityBig", GOTFaction.LORATH, (GOTStructureRegistry.ISettlementProperties<GOTStructureLorathSettlement.Instance>) instance -> instance.setType(GOTStructureLorathSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureQohorSettlement(GOTBiome.qohor, 1.0f), "QohorCityLittle", GOTFaction.QOHOR, (GOTStructureRegistry.ISettlementProperties<GOTStructureQohorSettlement.Instance>) instance -> instance.setType(GOTStructureQohorSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureQohorSettlement(GOTBiome.qohor, 1.0f), "QohorCityMedium", GOTFaction.QOHOR, (GOTStructureRegistry.ISettlementProperties<GOTStructureQohorSettlement.Instance>) instance -> instance.setType(GOTStructureQohorSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureQohorSettlement(GOTBiome.qohor, 1.0f), "QohorCityBig", GOTFaction.QOHOR, (GOTStructureRegistry.ISettlementProperties<GOTStructureQohorSettlement.Instance>) instance -> instance.setType(GOTStructureQohorSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureLysSettlement(GOTBiome.lys, 1.0f), "LysCityLittle", GOTFaction.LYS, (GOTStructureRegistry.ISettlementProperties<GOTStructureLysSettlement.Instance>) instance -> instance.setType(GOTStructureLysSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureLysSettlement(GOTBiome.lys, 1.0f), "LysCityMedium", GOTFaction.LYS, (GOTStructureRegistry.ISettlementProperties<GOTStructureLysSettlement.Instance>) instance -> instance.setType(GOTStructureLysSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureLysSettlement(GOTBiome.lys, 1.0f), "LysCityBig", GOTFaction.LYS, (GOTStructureRegistry.ISettlementProperties<GOTStructureLysSettlement.Instance>) instance -> instance.setType(GOTStructureLysSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureMyrSettlement(GOTBiome.myr, 1.0f), "MyrCityLittle", GOTFaction.MYR, (GOTStructureRegistry.ISettlementProperties<GOTStructureMyrSettlement.Instance>) instance -> instance.setType(GOTStructureMyrSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureMyrSettlement(GOTBiome.myr, 1.0f), "MyrCityMedium", GOTFaction.MYR, (GOTStructureRegistry.ISettlementProperties<GOTStructureMyrSettlement.Instance>) instance -> instance.setType(GOTStructureMyrSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureMyrSettlement(GOTBiome.myr, 1.0f), "MyrCityBig", GOTFaction.MYR, (GOTStructureRegistry.ISettlementProperties<GOTStructureMyrSettlement.Instance>) instance -> instance.setType(GOTStructureMyrSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureTyroshSettlement(GOTBiome.tyrosh, 1.0f), "TyroshCityLittle", GOTFaction.TYROSH, (GOTStructureRegistry.ISettlementProperties<GOTStructureTyroshSettlement.Instance>) instance -> instance.setType(GOTStructureTyroshSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureTyroshSettlement(GOTBiome.tyrosh, 1.0f), "TyroshCityMedium", GOTFaction.TYROSH, (GOTStructureRegistry.ISettlementProperties<GOTStructureTyroshSettlement.Instance>) instance -> instance.setType(GOTStructureTyroshSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureTyroshSettlement(GOTBiome.tyrosh, 1.0f), "TyroshCityBig", GOTFaction.TYROSH, (GOTStructureRegistry.ISettlementProperties<GOTStructureTyroshSettlement.Instance>) instance -> instance.setType(GOTStructureTyroshSettlement.Type.FORT));
		...
		GOTStructureRegistry.register(id++, new GOTStructureGhiscarSettlement(GOTBiome.ghiscar, 1.0f), "GhiscarCityLittle", GOTFaction.GHISCAR, (GOTStructureRegistry.ISettlementProperties<GOTStructureGhiscarSettlement.Instance>) instance -> instance.setType(GOTStructureGhiscarSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureGhiscarSettlement(GOTBiome.ghiscar, 1.0f), "GhiscarCityMedium", GOTFaction.GHISCAR, (GOTStructureRegistry.ISettlementProperties<GOTStructureGhiscarSettlement.Instance>) instance -> instance.setType(GOTStructureGhiscarSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureGhiscarSettlement(GOTBiome.ghiscar, 1.0f), "GhiscarCityBig", GOTFaction.GHISCAR, (GOTStructureRegistry.ISettlementProperties<GOTStructureGhiscarSettlement.Instance>) instance -> instance.setType(GOTStructureGhiscarSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureQarthSettlement(GOTBiome.qarth, 1.0f), "QarthCityLittle", GOTFaction.QARTH, (GOTStructureRegistry.ISettlementProperties<GOTStructureQarthSettlement.Instance>) instance -> instance.setType(GOTStructureQarthSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureQarthSettlement(GOTBiome.qarth, 1.0f), "QarthCityMedium", GOTFaction.QARTH, (GOTStructureRegistry.ISettlementProperties<GOTStructureQarthSettlement.Instance>) instance -> instance.setType(GOTStructureQarthSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureQarthSettlement(GOTBiome.qarth, 1.0f), "QarthCityBig", GOTFaction.QARTH, (GOTStructureRegistry.ISettlementProperties<GOTStructureQarthSettlement.Instance>) instance -> instance.setType(GOTStructureQarthSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureLhazarSettlement(GOTBiome.lhazar, 1.0f), "LhazarCityLittle", GOTFaction.LHAZAR, (GOTStructureRegistry.ISettlementProperties<GOTStructureLhazarSettlement.Instance>) instance -> instance.setType(GOTStructureLhazarSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureLhazarSettlement(GOTBiome.lhazar, 1.0f), "LhazarCityMedium", GOTFaction.LHAZAR, (GOTStructureRegistry.ISettlementProperties<GOTStructureLhazarSettlement.Instance>) instance -> instance.setType(GOTStructureLhazarSettlement.Type.FORT));
		GOTStructureRegistry.register(id++, new GOTStructureLhazarSettlement(GOTBiome.lhazar, 1.0f), "LhazarCityBig", GOTFaction.LHAZAR, (GOTStructureRegistry.ISettlementProperties<GOTStructureLhazarSettlement.Instance>) instance -> instance.setType(GOTStructureLhazarSettlement.Type.TOWN));

		GOTStructureRegistry.register(id++, new GOTStructureDothrakiSettlement(GOTBiome.dothrakiSea, 1.0f), "DothrakiVillageLittle", GOTFaction.DOTHRAKI, (GOTStructureRegistry.ISettlementProperties<GOTStructureDothrakiSettlement.Instance>) instance -> instance.setType(GOTStructureDothrakiSettlement.Type.SMALL));
		GOTStructureRegistry.register(id++, new GOTStructureDothrakiSettlement(GOTBiome.dothrakiSea, 1.0f), "DothrakiVillageBig", GOTFaction.DOTHRAKI, (GOTStructureRegistry.ISettlementProperties<GOTStructureDothrakiSettlement.Instance>) instance -> instance.setType(GOTStructureDothrakiSettlement.Type.BIG));

		GOTStructureRegistry.register(id++, new GOTStructureIbbenSettlement(GOTBiome.ibben, 1.0f), "IbbenVillage", GOTFaction.IBBEN, (GOTStructureRegistry.ISettlementProperties<GOTStructureIbbenSettlement.Instance>) instance -> instance.setType(GOTStructureIbbenSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureIbbenSettlement(GOTBiome.ibben, 1.0f), "IbbenFortVillage", GOTFaction.IBBEN, (GOTStructureRegistry.ISettlementProperties<GOTStructureIbbenSettlement.Instance>) instance -> instance.setType(GOTStructureIbbenSettlement.Type.FORT));

		GOTStructureRegistry.register(id++, new GOTStructureJogosSettlement(GOTBiome.jogosNhai, 1.0f), "JogosVillageLittle", GOTFaction.JOGOS, (GOTStructureRegistry.ISettlementProperties<GOTStructureJogosSettlement.Instance>) instance -> instance.setType(GOTStructureJogosSettlement.Type.SMALL));
		GOTStructureRegistry.register(id++, new GOTStructureJogosSettlement(GOTBiome.jogosNhai, 1.0f), "JogosVillageBig", GOTFaction.JOGOS, (GOTStructureRegistry.ISettlementProperties<GOTStructureJogosSettlement.Instance>) instance -> instance.setType(GOTStructureJogosSettlement.Type.BIG));
		...
		GOTStructureRegistry.register(id++, new GOTStructureYiTiSettlement(GOTBiome.yiTi, 1.0f), "YiTiVillage", GOTFaction.YI_TI, (GOTStructureRegistry.ISettlementProperties<GOTStructureYiTiSettlement.Instance>) instance -> instance.setType(GOTStructureYiTiSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureYiTiSettlement(GOTBiome.yiTi, 1.0f), "YiTiTown", GOTFaction.YI_TI, (GOTStructureRegistry.ISettlementProperties<GOTStructureYiTiSettlement.Instance>) instance -> instance.setType(GOTStructureYiTiSettlement.Type.TOWN));
		GOTStructureRegistry.register(id++, new GOTStructureYiTiSettlement(GOTBiome.yiTi, 1.0f), "YiTiFortVillage", GOTFaction.YI_TI, (GOTStructureRegistry.ISettlementProperties<GOTStructureYiTiSettlement.Instance>) instance -> instance.setType(GOTStructureYiTiSettlement.Type.FORT));
		...
		GOTStructureRegistry.register(id++, new GOTStructureSummerSettlement(GOTBiome.summerIslands, 1.0f), "SummerVillage", GOTFaction.SUMMER_ISLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureSummerSettlement.Instance>) instance -> instance.setType(GOTStructureSummerSettlement.Type.VILLAGE));
		GOTStructureRegistry.register(id++, new GOTStructureSummerSettlement(GOTBiome.summerIslands, 1.0f), "SummerFortVillage", GOTFaction.SUMMER_ISLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureSummerSettlement.Instance>) instance -> instance.setType(GOTStructureSummerSettlement.Type.FORT));
		GOTStructureRegistry.register(id++, new GOTStructureSummerSettlement(GOTBiome.summerIslands, 1.0f), "SummerVillageRuined", GOTFaction.SUMMER_ISLANDS, (GOTStructureRegistry.ISettlementProperties<GOTStructureSummerSettlement.Instance>) instance -> instance.setType(GOTStructureSummerSettlement.Type.RUINED_VILLAGE));
