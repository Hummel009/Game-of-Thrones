...
public class GOTStructure {
	...
	public static void onInit() {
		...
		GOTStructureRegistry.register(id++, new GOTStructureWildlingVillage(GOTBiome.hauntedForest, 1.0f), "WildlingVillage", GOTFaction.WILDLING, (IVillageProperties<got.common.world.structure.westeros.wildling.GOTStructureWildlingVillage.Instance>) instance -> {
		});

		GOTStructureRegistry.register(id++, new GOTStructureThennVillage(GOTBiome.thenn, 1.0f), "ThennVillage", GOTFaction.WILDLING, (IVillageProperties<got.common.world.structure.westeros.wildling.thenn.GOTStructureThennVillage.Instance>) instance -> {
		});

		GOTStructureRegistry.register(id++, new GOTStructureGiftVillage(GOTBiome.giftNew, 1.0f), "GiftVillage", GOTFaction.NIGHT_WATCH, (IVillageProperties<got.common.world.structure.westeros.gift.GOTStructureGiftVillage.Instance>) instance -> {
		});

		GOTStructureRegistry.register(id++, new GOTStructureNorthHillmanVillage(GOTBiome.skagos, 1.0f), "NorthHillmanVillage", GOTFaction.NORTH, (IVillageProperties<got.common.world.structure.westeros.north.hillmen.GOTStructureNorthHillmanVillage.Instance>) instance -> {
		});

		GOTStructureRegistry.register(id++, new GOTStructureNorthCity(GOTBiome.north, 1.0f), "NorthVillage", GOTFaction.NORTH, (IVillageProperties<got.common.world.structure.westeros.north.GOTStructureNorthCity.Instance>) instance -> instance.villageType = GOTStructureNorthCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureNorthCity(GOTBiome.north, 1.0f), "NorthTown", GOTFaction.NORTH, (IVillageProperties<got.common.world.structure.westeros.north.GOTStructureNorthCity.Instance>) instance -> instance.villageType = GOTStructureNorthCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureNorthCity(GOTBiome.north, 1.0f), "NorthFortVillage", GOTFaction.NORTH, (IVillageProperties<got.common.world.structure.westeros.north.GOTStructureNorthCity.Instance>) instance -> instance.villageType = GOTStructureNorthCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureIronbornCity(GOTBiome.ironborn, 1.0f), "IronbornCityLittle", GOTFaction.IRONBORN, (IVillageProperties<got.common.world.structure.westeros.ironborn.GOTStructureIronbornCity.Instance>) instance -> instance.villageType = GOTStructureIronbornCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureIronbornCity(GOTBiome.ironborn, 1.0f), "IronbornCityBig", GOTFaction.IRONBORN, (IVillageProperties<got.common.world.structure.westeros.ironborn.GOTStructureIronbornCity.Instance>) instance -> instance.villageType = GOTStructureIronbornCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureIronbornCity(GOTBiome.ironborn, 1.0f), "IronbornCityMedium", GOTFaction.IRONBORN, (IVillageProperties<got.common.world.structure.westeros.ironborn.GOTStructureIronbornCity.Instance>) instance -> instance.villageType = GOTStructureIronbornCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureWesterlandsCity(GOTBiome.westerlands, 1.0f), "WesterlandsCityLittle", GOTFaction.WESTERLANDS, (IVillageProperties<got.common.world.structure.westeros.westerlands.GOTStructureWesterlandsCity.Instance>) instance -> instance.villageType = GOTStructureWesterlandsCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureWesterlandsCity(GOTBiome.westerlands, 1.0f), "WesterlandsCityBig", GOTFaction.WESTERLANDS, (IVillageProperties<got.common.world.structure.westeros.westerlands.GOTStructureWesterlandsCity.Instance>) instance -> instance.villageType = GOTStructureWesterlandsCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureWesterlandsCity(GOTBiome.westerlands, 1.0f), "WesterlandsCityMedium", GOTFaction.WESTERLANDS, (IVillageProperties<got.common.world.structure.westeros.westerlands.GOTStructureWesterlandsCity.Instance>) instance -> instance.villageType = GOTStructureWesterlandsCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureRiverlandsCity(GOTBiome.riverlands, 1.0f), "RiverlandsCityLittle", GOTFaction.RIVERLANDS, (IVillageProperties<got.common.world.structure.westeros.riverlands.GOTStructureRiverlandsCity.Instance>) instance -> instance.villageType = GOTStructureRiverlandsCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureRiverlandsCity(GOTBiome.riverlands, 1.0f), "RiverlandsCityBig", GOTFaction.RIVERLANDS, (IVillageProperties<got.common.world.structure.westeros.riverlands.GOTStructureRiverlandsCity.Instance>) instance -> instance.villageType = GOTStructureRiverlandsCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureRiverlandsCity(GOTBiome.riverlands, 1.0f), "RiverlandsCityMedium", GOTFaction.RIVERLANDS, (IVillageProperties<got.common.world.structure.westeros.riverlands.GOTStructureRiverlandsCity.Instance>) instance -> instance.villageType = GOTStructureRiverlandsCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureHillmanVillage(GOTBiome.sothoryosJungle, 1.0f), "HillmanVillage", GOTFaction.HILL_TRIBES, (IVillageProperties<got.common.world.structure.westeros.hillmen.GOTStructureHillmanVillage.Instance>) instance -> {
		});

		GOTStructureRegistry.register(id++, new GOTStructureArrynCity(GOTBiome.arryn, 1.0f), "ArrynCityLittle", GOTFaction.ARRYN, (IVillageProperties<got.common.world.structure.westeros.arryn.GOTStructureArrynCity.Instance>) instance -> instance.villageType = GOTStructureArrynCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureArrynCity(GOTBiome.arryn, 1.0f), "ArrynCityBig", GOTFaction.ARRYN, (IVillageProperties<got.common.world.structure.westeros.arryn.GOTStructureArrynCity.Instance>) instance -> instance.villageType = GOTStructureArrynCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureArrynCity(GOTBiome.arryn, 1.0f), "ArrynCityMedium", GOTFaction.ARRYN, (IVillageProperties<got.common.world.structure.westeros.arryn.GOTStructureArrynCity.Instance>) instance -> instance.villageType = GOTStructureArrynCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureDragonstoneCity(GOTBiome.dragonstone, 1.0f), "DragonstoneCityLittle", GOTFaction.DRAGONSTONE, (IVillageProperties<got.common.world.structure.westeros.dragonstone.GOTStructureDragonstoneCity.Instance>) instance -> instance.villageType = GOTStructureDragonstoneCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureDragonstoneCity(GOTBiome.dragonstone, 1.0f), "DragonstoneCityBig", GOTFaction.DRAGONSTONE, (IVillageProperties<got.common.world.structure.westeros.dragonstone.GOTStructureDragonstoneCity.Instance>) instance -> instance.villageType = GOTStructureDragonstoneCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureDragonstoneCity(GOTBiome.dragonstone, 1.0f), "DragonstoneCityMedium", GOTFaction.DRAGONSTONE, (IVillageProperties<got.common.world.structure.westeros.dragonstone.GOTStructureDragonstoneCity.Instance>) instance -> instance.villageType = GOTStructureDragonstoneCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureCrownlandsCity(GOTBiome.crownlands, 1.0f), "CrownlandsCityLittle", GOTFaction.CROWNLANDS, (IVillageProperties<got.common.world.structure.westeros.crownlands.GOTStructureCrownlandsCity.Instance>) instance -> instance.villageType = GOTStructureCrownlandsCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureCrownlandsCity(GOTBiome.crownlands, 1.0f), "CrownlandsCityBig", GOTFaction.CROWNLANDS, (IVillageProperties<got.common.world.structure.westeros.crownlands.GOTStructureCrownlandsCity.Instance>) instance -> instance.villageType = GOTStructureCrownlandsCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureCrownlandsCity(GOTBiome.crownlands, 1.0f), "CrownlandsCityMedium", GOTFaction.CROWNLANDS, (IVillageProperties<got.common.world.structure.westeros.crownlands.GOTStructureCrownlandsCity.Instance>) instance -> instance.villageType = GOTStructureCrownlandsCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureStormlandsCity(GOTBiome.stormlands, 1.0f), "StormlandsCityLittle", GOTFaction.STORMLANDS, (IVillageProperties<got.common.world.structure.westeros.stormlands.GOTStructureStormlandsCity.Instance>) instance -> instance.villageType = GOTStructureStormlandsCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureStormlandsCity(GOTBiome.stormlands, 1.0f), "StormlandsCityBig", GOTFaction.STORMLANDS, (IVillageProperties<got.common.world.structure.westeros.stormlands.GOTStructureStormlandsCity.Instance>) instance -> instance.villageType = GOTStructureStormlandsCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureStormlandsCity(GOTBiome.stormlands, 1.0f), "StormlandsCityMedium", GOTFaction.STORMLANDS, (IVillageProperties<got.common.world.structure.westeros.stormlands.GOTStructureStormlandsCity.Instance>) instance -> instance.villageType = GOTStructureStormlandsCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureReachCity(GOTBiome.reach, 1.0f), "ReachCityLittle", GOTFaction.REACH, (IVillageProperties<got.common.world.structure.westeros.reach.GOTStructureReachCity.Instance>) instance -> instance.villageType = GOTStructureReachCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureReachCity(GOTBiome.reach, 1.0f), "ReachCityBig", GOTFaction.REACH, (IVillageProperties<got.common.world.structure.westeros.reach.GOTStructureReachCity.Instance>) instance -> instance.villageType = GOTStructureReachCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureReachCity(GOTBiome.reach, 1.0f), "ReachCityMedium", GOTFaction.REACH, (IVillageProperties<got.common.world.structure.westeros.reach.GOTStructureReachCity.Instance>) instance -> instance.villageType = GOTStructureReachCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureDorneCity(GOTBiome.dorne, 1.0f), "DorneCityLittle", GOTFaction.DORNE, (IVillageProperties<got.common.world.structure.westeros.dorne.GOTStructureDorneCity.Instance>) instance -> instance.villageType = GOTStructureDorneCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureDorneCity(GOTBiome.dorne, 1.0f), "DorneCityBig", GOTFaction.DORNE, (IVillageProperties<got.common.world.structure.westeros.dorne.GOTStructureDorneCity.Instance>) instance -> instance.villageType = GOTStructureDorneCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureDorneCity(GOTBiome.dorne, 1.0f), "DorneCityMedium", GOTFaction.DORNE, (IVillageProperties<got.common.world.structure.westeros.dorne.GOTStructureDorneCity.Instance>) instance -> instance.villageType = GOTStructureDorneCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureBraavosCity(GOTBiome.braavos, 1.0f), "BraavosCityLittle", GOTFaction.BRAAVOS, (IVillageProperties<got.common.world.structure.essos.braavos.GOTStructureBraavosCity.Instance>) instance -> instance.villageType = GOTStructureBraavosCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureBraavosCity(GOTBiome.braavos, 1.0f), "BraavosCityMedium", GOTFaction.BRAAVOS, (IVillageProperties<got.common.world.structure.essos.braavos.GOTStructureBraavosCity.Instance>) instance -> instance.villageType = GOTStructureBraavosCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureBraavosCity(GOTBiome.braavos, 1.0f), "BraavosCityBig", GOTFaction.BRAAVOS, (IVillageProperties<got.common.world.structure.essos.braavos.GOTStructureBraavosCity.Instance>) instance -> instance.villageType = GOTStructureBraavosCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureVolantisCity(GOTBiome.volantis, 1.0f), "VolantisCityLittle", GOTFaction.VOLANTIS, (IVillageProperties<got.common.world.structure.essos.volantis.GOTStructureVolantisCity.Instance>) instance -> instance.villageType = GOTStructureVolantisCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureVolantisCity(GOTBiome.volantis, 1.0f), "VolantisCityMedium", GOTFaction.VOLANTIS, (IVillageProperties<got.common.world.structure.essos.volantis.GOTStructureVolantisCity.Instance>) instance -> instance.villageType = GOTStructureVolantisCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureVolantisCity(GOTBiome.volantis, 1.0f), "VolantisCityBig", GOTFaction.VOLANTIS, (IVillageProperties<got.common.world.structure.essos.volantis.GOTStructureVolantisCity.Instance>) instance -> instance.villageType = GOTStructureVolantisCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructurePentosCity(GOTBiome.pentos, 1.0f), "PentosCityLittle", GOTFaction.PENTOS, (IVillageProperties<got.common.world.structure.essos.pentos.GOTStructurePentosCity.Instance>) instance -> instance.villageType = GOTStructurePentosCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructurePentosCity(GOTBiome.pentos, 1.0f), "PentosCityMedium", GOTFaction.PENTOS, (IVillageProperties<got.common.world.structure.essos.pentos.GOTStructurePentosCity.Instance>) instance -> instance.villageType = GOTStructurePentosCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructurePentosCity(GOTBiome.pentos, 1.0f), "PentosCityBig", GOTFaction.PENTOS, (IVillageProperties<got.common.world.structure.essos.pentos.GOTStructurePentosCity.Instance>) instance -> instance.villageType = GOTStructurePentosCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureNorvosCity(GOTBiome.norvos, 1.0f), "NorvosCityLittle", GOTFaction.NORVOS, (IVillageProperties<got.common.world.structure.essos.norvos.GOTStructureNorvosCity.Instance>) instance -> instance.villageType = GOTStructureNorvosCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureNorvosCity(GOTBiome.norvos, 1.0f), "NorvosCityMedium", GOTFaction.NORVOS, (IVillageProperties<got.common.world.structure.essos.norvos.GOTStructureNorvosCity.Instance>) instance -> instance.villageType = GOTStructureNorvosCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureNorvosCity(GOTBiome.norvos, 1.0f), "NorvosCityBig", GOTFaction.NORVOS, (IVillageProperties<got.common.world.structure.essos.norvos.GOTStructureNorvosCity.Instance>) instance -> instance.villageType = GOTStructureNorvosCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureLorathCity(GOTBiome.lorath, 1.0f), "LorathCityLittle", GOTFaction.LORATH, (IVillageProperties<got.common.world.structure.essos.lorath.GOTStructureLorathCity.Instance>) instance -> instance.villageType = GOTStructureLorathCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureLorathCity(GOTBiome.lorath, 1.0f), "LorathCityMedium", GOTFaction.LORATH, (IVillageProperties<got.common.world.structure.essos.lorath.GOTStructureLorathCity.Instance>) instance -> instance.villageType = GOTStructureLorathCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureLorathCity(GOTBiome.lorath, 1.0f), "LorathCityBig", GOTFaction.LORATH, (IVillageProperties<got.common.world.structure.essos.lorath.GOTStructureLorathCity.Instance>) instance -> instance.villageType = GOTStructureLorathCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureQohorCity(GOTBiome.qohor, 1.0f), "QohorCityLittle", GOTFaction.QOHOR, (IVillageProperties<got.common.world.structure.essos.qohor.GOTStructureQohorCity.Instance>) instance -> instance.villageType = GOTStructureQohorCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureQohorCity(GOTBiome.qohor, 1.0f), "QohorCityMedium", GOTFaction.QOHOR, (IVillageProperties<got.common.world.structure.essos.qohor.GOTStructureQohorCity.Instance>) instance -> instance.villageType = GOTStructureQohorCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureQohorCity(GOTBiome.qohor, 1.0f), "QohorCityBig", GOTFaction.QOHOR, (IVillageProperties<got.common.world.structure.essos.qohor.GOTStructureQohorCity.Instance>) instance -> instance.villageType = GOTStructureQohorCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureLysCity(GOTBiome.lys, 1.0f), "LysCityLittle", GOTFaction.LYS, (IVillageProperties<got.common.world.structure.essos.lys.GOTStructureLysCity.Instance>) instance -> instance.villageType = GOTStructureLysCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureLysCity(GOTBiome.lys, 1.0f), "LysCityMedium", GOTFaction.LYS, (IVillageProperties<got.common.world.structure.essos.lys.GOTStructureLysCity.Instance>) instance -> instance.villageType = GOTStructureLysCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureLysCity(GOTBiome.lys, 1.0f), "LysCityBig", GOTFaction.LYS, (IVillageProperties<got.common.world.structure.essos.lys.GOTStructureLysCity.Instance>) instance -> instance.villageType = GOTStructureLysCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureMyrCity(GOTBiome.myr, 1.0f), "MyrCityLittle", GOTFaction.MYR, (IVillageProperties<got.common.world.structure.essos.myr.GOTStructureMyrCity.Instance>) instance -> instance.villageType = GOTStructureMyrCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureMyrCity(GOTBiome.myr, 1.0f), "MyrCityMedium", GOTFaction.MYR, (IVillageProperties<got.common.world.structure.essos.myr.GOTStructureMyrCity.Instance>) instance -> instance.villageType = GOTStructureMyrCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureMyrCity(GOTBiome.myr, 1.0f), "MyrCityBig", GOTFaction.MYR, (IVillageProperties<got.common.world.structure.essos.myr.GOTStructureMyrCity.Instance>) instance -> instance.villageType = GOTStructureMyrCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureTyroshCity(GOTBiome.tyrosh, 1.0f), "TyroshCityLittle", GOTFaction.TYROSH, (IVillageProperties<got.common.world.structure.essos.tyrosh.GOTStructureTyroshCity.Instance>) instance -> instance.villageType = GOTStructureTyroshCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureTyroshCity(GOTBiome.tyrosh, 1.0f), "TyroshCityMedium", GOTFaction.TYROSH, (IVillageProperties<got.common.world.structure.essos.tyrosh.GOTStructureTyroshCity.Instance>) instance -> instance.villageType = GOTStructureTyroshCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureTyroshCity(GOTBiome.tyrosh, 1.0f), "TyroshCityBig", GOTFaction.TYROSH, (IVillageProperties<got.common.world.structure.essos.tyrosh.GOTStructureTyroshCity.Instance>) instance -> instance.villageType = GOTStructureTyroshCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureGoldenCamp(GOTBiome.essos, 1.0f), "GoldenCamp", 0xffd700, (IVillageProperties<got.common.world.structure.essos.gold.GOTStructureGoldenCamp.Instance>) instance -> {
		});

		GOTStructureRegistry.register(id++, new GOTStructureGhiscarCity(GOTBiome.ghiscar, 1.0f), "GhiscarCityLittle", GOTFaction.GHISCAR, (IVillageProperties<got.common.world.structure.essos.ghiscar.GOTStructureGhiscarCity.Instance>) instance -> instance.villageType = GOTStructureGhiscarCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureGhiscarCity(GOTBiome.ghiscar, 1.0f), "GhiscarCityMedium", GOTFaction.GHISCAR, (IVillageProperties<got.common.world.structure.essos.ghiscar.GOTStructureGhiscarCity.Instance>) instance -> instance.villageType = GOTStructureGhiscarCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureGhiscarCity(GOTBiome.ghiscar, 1.0f), "GhiscarCityBig", GOTFaction.GHISCAR, (IVillageProperties<got.common.world.structure.essos.ghiscar.GOTStructureGhiscarCity.Instance>) instance -> instance.villageType = GOTStructureGhiscarCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureQarthCity(GOTBiome.qarth, 1.0f), "QarthCityLittle", GOTFaction.QARTH, (IVillageProperties<got.common.world.structure.essos.qarth.GOTStructureQarthCity.Instance>) instance -> instance.villageType = GOTStructureQarthCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureQarthCity(GOTBiome.qarth, 1.0f), "QarthCityMedium", GOTFaction.QARTH, (IVillageProperties<got.common.world.structure.essos.qarth.GOTStructureQarthCity.Instance>) instance -> instance.villageType = GOTStructureQarthCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureQarthCity(GOTBiome.qarth, 1.0f), "QarthCityBig", GOTFaction.QARTH, (IVillageProperties<got.common.world.structure.essos.qarth.GOTStructureQarthCity.Instance>) instance -> instance.villageType = GOTStructureQarthCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureLhazarVillage(GOTBiome.lhazar, 1.0f), "LhazarCityLittle", GOTFaction.LHAZAR, (IVillageProperties<got.common.world.structure.essos.lhazar.GOTStructureLhazarVillage.Instance>) instance -> instance.villageType = GOTStructureLhazarVillage.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureLhazarVillage(GOTBiome.lhazar, 1.0f), "LhazarCityMedium", GOTFaction.LHAZAR, (IVillageProperties<got.common.world.structure.essos.lhazar.GOTStructureLhazarVillage.Instance>) instance -> instance.villageType = GOTStructureLhazarVillage.VillageType.FORT);
		GOTStructureRegistry.register(id++, new GOTStructureLhazarVillage(GOTBiome.lhazar, 1.0f), "LhazarCityBig", GOTFaction.LHAZAR, (IVillageProperties<got.common.world.structure.essos.lhazar.GOTStructureLhazarVillage.Instance>) instance -> instance.villageType = GOTStructureLhazarVillage.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureDothrakiVillage(GOTBiome.dothrakiSea, 1.0f), "DothrakiVillageLittle", GOTFaction.DOTHRAKI, (IVillageProperties<got.common.world.structure.essos.dothraki.GOTStructureDothrakiVillage.Instance>) instance -> instance.villageType = GOTStructureDothrakiVillage.VillageType.SMALL);
		GOTStructureRegistry.register(id++, new GOTStructureDothrakiVillage(GOTBiome.dothrakiSea, 1.0f), "DothrakiVillageBig", GOTFaction.DOTHRAKI, (IVillageProperties<got.common.world.structure.essos.dothraki.GOTStructureDothrakiVillage.Instance>) instance -> instance.villageType = GOTStructureDothrakiVillage.VillageType.BIG);

		GOTStructureRegistry.register(id++, new GOTStructureIbbenVillage(GOTBiome.ibben, 1.0f), "IbbenVillage", GOTFaction.IBBEN, (IVillageProperties<got.common.world.structure.essos.ibben.GOTStructureIbbenVillage.Instance>) instance -> instance.villageType = GOTStructureIbbenVillage.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureIbbenVillage(GOTBiome.ibben, 1.0f), "IbbenFortVillage", GOTFaction.IBBEN, (IVillageProperties<got.common.world.structure.essos.ibben.GOTStructureIbbenVillage.Instance>) instance -> instance.villageType = GOTStructureIbbenVillage.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureJogosVillage(GOTBiome.jogosNhai, 1.0f), "JogosVillageLittle", GOTFaction.JOGOS, (IVillageProperties<got.common.world.structure.essos.jogos.GOTStructureJogosVillage.Instance>) instance -> instance.villageType = GOTStructureJogosVillage.VillageType.SMALL);
		GOTStructureRegistry.register(id++, new GOTStructureJogosVillage(GOTBiome.jogosNhai, 1.0f), "JogosVillageBig", GOTFaction.JOGOS, (IVillageProperties<got.common.world.structure.essos.jogos.GOTStructureJogosVillage.Instance>) instance -> instance.villageType = GOTStructureJogosVillage.VillageType.BIG);

		GOTStructureRegistry.register(id++, new GOTStructureMossovyVillage(GOTBiome.mossovy, 1.0f), "MossovyVillage", GOTFaction.MOSSOVY, (IVillageProperties<got.common.world.structure.essos.mossovy.GOTStructureMossovyVillage.Instance>) instance -> {
		});

		GOTStructureRegistry.register(id++, new GOTStructureYiTiCity(GOTBiome.yiTi, 1.0f), "YiTiVillage", GOTFaction.YI_TI, (IVillageProperties<got.common.world.structure.essos.yiti.GOTStructureYiTiCity.Instance>) instance -> instance.villageType = GOTStructureYiTiCity.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureYiTiCity(GOTBiome.yiTi, 1.0f), "YiTiTown", GOTFaction.YI_TI, (IVillageProperties<got.common.world.structure.essos.yiti.GOTStructureYiTiCity.Instance>) instance -> instance.villageType = GOTStructureYiTiCity.VillageType.TOWN);
		GOTStructureRegistry.register(id++, new GOTStructureYiTiCity(GOTBiome.yiTi, 1.0f), "YiTiFortVillage", GOTFaction.YI_TI, (IVillageProperties<got.common.world.structure.essos.yiti.GOTStructureYiTiCity.Instance>) instance -> instance.villageType = GOTStructureYiTiCity.VillageType.FORT);

		GOTStructureRegistry.register(id++, new GOTStructureAsshaiCity(GOTBiome.shadowTown, 1.0f), "AsshaiCity", GOTFaction.ASSHAI, (IVillageProperties<got.common.world.structure.essos.asshai.GOTStructureAsshaiCity.Instance>) instance -> instance.villageType = GOTStructureAsshaiCity.VillageType.TOWN);

		GOTStructureRegistry.register(id++, new GOTStructureSummerVillage(GOTBiome.summerIslands, 1.0f), "SummerVillage", GOTFaction.SUMMER_ISLANDS, (IVillageProperties<got.common.world.structure.sothoryos.summer.GOTStructureSummerVillage.Instance>) instance -> instance.villageType = GOTStructureSummerVillage.VillageType.VILLAGE);
		GOTStructureRegistry.register(id++, new GOTStructureSummerVillage(GOTBiome.summerIslands, 1.0f), "SummerFortVillage", GOTFaction.SUMMER_ISLANDS, (IVillageProperties<got.common.world.structure.sothoryos.summer.GOTStructureSummerVillage.Instance>) instance -> instance.villageType = GOTStructureSummerVillage.VillageType.FORTRESS);
		GOTStructureRegistry.register(id++, new GOTStructureSummerVillage(GOTBiome.summerIslands, 1.0f).setRuined(), "SummerVillageRuined", GOTFaction.SUMMER_ISLANDS, (IVillageProperties<got.common.world.structure.sothoryos.summer.GOTStructureSummerVillage.Instance>) instance -> instance.villageType = GOTStructureSummerVillage.VillageType.VILLAGE);
