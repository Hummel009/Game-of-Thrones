...
public class GOTStructure {
	...
	public static void onInit() {
		...
		GOTStructureRegistry.register(id++, new GOTStructureLhazarSettlement(GOTBiome.ocean, 1.0f), "LhazarSettleLarge", GOTFaction.LHAZAR, (GOTStructureRegistry.ISettlementProperties<GOTStructureLhazarSettlement.Instance>) instance -> instance.setType(GOTStructureLhazarSettlement.Type.FORT));
		GOTStructureRegistry.register(id++, new GOTStructureLhazarSettlement(GOTBiome.ocean, 1.0f), "LhazarSettleForted", GOTFaction.LHAZAR, (GOTStructureRegistry.ISettlementProperties<GOTStructureLhazarSettlement.Instance>) instance -> instance.setType(GOTStructureLhazarSettlement.Type.TOWN));
