...
public class GOTFixer {
	...
	public static void affixWaypointLocations(GOTBiome biome) {
		...
		f[3].affix(GOTWaypoint.BarterBeach, GOTWaypoint.Gogossos, GOTWaypoint.Gorosh);
		...
		f[6].affix(GOTWaypoint.Astapor, -2, 0, 0);
		f[6].affix(GOTWaypoint.NewGhis, -2, 0, 0);
		f[6].affix(GOTWaypoint.Yunkai, -2, 0, 0);
		...
		f[10].affix(GOTWaypoint.FiveForts1, GOTWaypoint.FiveForts2, GOTWaypoint.FiveForts3, GOTWaypoint.FiveForts4);
		f[10].affix(GOTWaypoint.FiveForts5, 0, 0, 3);
		f[11].affix(GOTWaypoint.Asabhad, -1, 0, 0);
		f[11].affix(GOTWaypoint.Baoji, 0, 1, 2);
		f[11].affix(GOTWaypoint.Eijiang, 0, 1, 2);
		f[11].affix(GOTWaypoint.Jinqi, -1, 0, 3);
		f[11].affix(GOTWaypoint.Lizhao, 1, 0, 0);
		f[11].affix(GOTWaypoint.Manjin, 1, 0, 3);
		f[11].affix(GOTWaypoint.SiQo, 1, 0, 0);
		f[11].affix(GOTWaypoint.Tiqui, 0, -1, 0);
		f[11].affix(GOTWaypoint.TraderTown, 0, -1, 0);
		f[11].affix(GOTWaypoint.Vaibei, 0, -1, 0);
		f[11].affix(GOTWaypoint.Yibin, -1, 0, 3);
		f[11].affix(GOTWaypoint.Yin, 0, 1, 2);
		f[11].affix(GOTWaypoint.Yunnan, 1, 0, 1);
		f[11].affix(GOTWaypoint.Zabhad, GOTWaypoint.Turrani, GOTWaypoint.Vahar, GOTWaypoint.Faros, GOTWaypoint.Huiji, GOTWaypoint.LengMa, GOTWaypoint.LengYi, GOTWaypoint.LesserMoraq, GOTWaypoint.Marahai, GOTWaypoint.PortMoraq);
		f[12].affix(GOTWaypoint.Elyria, GOTWaypoint.Tolos);
		f[12].affix(GOTWaypoint.LittleValyria, 0, 1, 0);
		...
		f[12].affix(GOTWaypoint.VolonTherys, 0, 1, 0);
		...
		f[21].affix(GOTWaypoint.PortYhos, 0, 1, 0);
		f[21].affix(GOTWaypoint.Qarkash, 0, 0, 0);
		f[21].affix(GOTWaypoint.Qarth, 0, 1, 0);
		f[22].affix(GOTWaypoint.Qohor, 0, -1, 2);
		f[23].affix(GOTWaypoint.Asshai, 0, 0, 2);
		...
		f[34].affix(GOTWaypoint.Blackmont, GOTWaypoint.GhostHill, GOTWaypoint.Godsgrace, GOTWaypoint.Hellholt, GOTWaypoint.HighHermitage, GOTWaypoint.Tor, GOTWaypoint.Vaith, GOTWaypoint.WaterGardens, GOTWaypoint.Spottswood, GOTWaypoint.Lemonwood, GOTWaypoint.Saltshore, GOTWaypoint.Sandstone);
		f[34].affix(GOTWaypoint.Kingsgrave, -1, 0, 0);
		f[34].affix(GOTWaypoint.SkyReach, 0, 1, 0);
		f[34].affix(GOTWaypoint.Starfall, 0, -1, 0);
		f[34].affix(GOTWaypoint.Wyl, 0, -1, 0);
		f[34].affix(GOTWaypoint.Yronwood, 1, 0, 0);
		...
		f[40].affix(GOTWaypoint.Highgarden, 0, -1, 0);
		f[41].affix(GOTWaypoint.Kayce, 0, 0, 3);
		f[41].affix(GOTWaypoint.Lannisport, -1, 0, 3);
		f[42].affix(GOTWaypoint.Oxcross);
		f[43].affix(GOTWaypoint.CasterlyRock, -1, 0, 0);
		f[43].affix(GOTWaypoint.Crakehall, -1, 0, 0);
		f[43].affix(GOTWaypoint.GoldenTooth, 0, 1, 0);
		f[43].affix(GOTWaypoint.Kayce, 1, 0, 0);
		f[43].affix(GOTWaypoint.Sarsfield, 0, -1, 0);
		f[43].affix(GOTWaypoint.Silverhill, GOTWaypoint.Wyndhall, GOTWaypoint.Plumwood, GOTWaypoint.Riverspring, GOTWaypoint.Greenfield, GOTWaypoint.Hornvale, GOTWaypoint.DeepDen, GOTWaypoint.Faircastle, GOTWaypoint.Feastfires, GOTWaypoint.CleganesKeep, GOTWaypoint.Cornfield, GOTWaypoint.Crag, GOTWaypoint.Ashemark, GOTWaypoint.Banefort);
		f[44].affix(GOTWaypoint.Blackhaven, -1, 0, 0);
		f[44].affix(GOTWaypoint.Bronzegate, 1, 0, 0);
		f[44].affix(GOTWaypoint.DeatsHear, GOTWaypoint.EvenfallHall, GOTWaypoint.Fawntown, GOTWaypoint.Amberly, GOTWaypoint.BlackHeart, GOTWaypoint.BroadArch, GOTWaypoint.Parchments, GOTWaypoint.Poddingfield, GOTWaypoint.RainHouse, GOTWaypoint.SeaworthCastle, GOTWaypoint.Stonehelm, GOTWaypoint.StormsEnd, GOTWaypoint.TudburyHoll, GOTWaypoint.Gallowsgrey, GOTWaypoint.Grandview, GOTWaypoint.Greenstone, GOTWaypoint.HarvestHall, GOTWaypoint.HaystackHall, GOTWaypoint.Mistwood);
		f[44].affix(GOTWaypoint.Felwood, 0, 1, 0);
		f[44].affix(GOTWaypoint.Nightsong, 0, 1, 0);
		...
		f[47].affix(GOTWaypoint.Darry, 1, 0, 0);
		f[47].affix(GOTWaypoint.Maidenpool, 1, 0, 0);
		f[47].affix(GOTWaypoint.PinkmaidenCastle, GOTWaypoint.RaventreeHall, GOTWaypoint.WayfarerRest, GOTWaypoint.AcornHall, GOTWaypoint.Atranta);
		f[47].affix(GOTWaypoint.Riverrun, 1, 0, 0);
		f[47].affix(GOTWaypoint.Seagard, 0, -1, 0);
		f[47].affix(GOTWaypoint.StoneHedge, 0, 1, 0);
		f[48].affix(GOTWaypoint.Maidenpool, -1, 0, 3);
		f[48].affix(GOTWaypoint.Saltpans, GOTWaypoint.StoneySept);
		...
		f[52].affix(GOTWaypoint.Appleton, 0, -1, 0);
		f[52].affix(GOTWaypoint.Ashford, 0, 1, 0);
		f[52].affix(GOTWaypoint.Bandallon, GOTWaypoint.Goldengrove, GOTWaypoint.GrassyVale, GOTWaypoint.Greenshield, GOTWaypoint.Grimston, GOTWaypoint.Hammerhal, GOTWaypoint.RedLake, GOTWaypoint.Ring, GOTWaypoint.Southshield, GOTWaypoint.Uplands, GOTWaypoint.Holyhall, GOTWaypoint.Honeyholt, GOTWaypoint.HornHill, GOTWaypoint.IvyHall, GOTWaypoint.Longtable, GOTWaypoint.NewBarrel, GOTWaypoint.Blackcrown, GOTWaypoint.BrightwaterKeep, GOTWaypoint.CiderHall, GOTWaypoint.Coldmoat, GOTWaypoint.DarkDell, GOTWaypoint.Dunstonbury);
		f[52].affix(GOTWaypoint.Bitterbridge, 0, 1, 0);
		f[52].affix(GOTWaypoint.GarnetGrove, -1, 0, 0);
		f[52].affix(GOTWaypoint.HewettTown, 0, -1, 0);
		f[52].affix(GOTWaypoint.OldOak, -1, 0, 0);
		f[52].affix(GOTWaypoint.SunHouse, 0, -1, 0);
		f[52].affix(GOTWaypoint.Whitegrove, -1, 0, 0);
		f[53].affix(GOTWaypoint.Appleton, 0, 1, 2);
		f[53].affix(GOTWaypoint.Ashford, 0, -1, 0);
		f[53].affix(GOTWaypoint.HewettTown, 0, 1, 0);
		f[53].affix(GOTWaypoint.Smithyton, 0, 1, 2);
		f[53].affix(GOTWaypoint.StarfishHarbor, GOTWaypoint.Vinetown, GOTWaypoint.Ryamsport);
		f[53].affix(GOTWaypoint.Tumbleton, 0, -1, 0);
		f[54].affix(GOTWaypoint.ThreeTowers, -1, -1, 1);
		f[54].affix(GOTWaypoint.ThreeTowers, -1, 0, 1);
		f[54].affix(GOTWaypoint.ThreeTowers, -1, 1, 1);
		f[54].affix(GOTWaypoint.TowerOfGlimmering, GOTWaypoint.BaelishKeep, GOTWaypoint.HightowerLitehouse, GOTWaypoint.RamseyTower, GOTWaypoint.Standfast);
		f[54].affix(GOTWaypoint.TwinsLeft, 1, 0, 1);
		f[54].affix(GOTWaypoint.TwinsRight, -2, 0, 3);
		f[55].affix(GOTWaypoint.WhiteHarbour, 0, 0, 1);
		f[56].affix(GOTWaypoint.Barrowtown, 0, 1, 2);
		f[57].affix(GOTWaypoint.BlackPool, GOTWaypoint.DeepwoodMotte, GOTWaypoint.Dreadfort, GOTWaypoint.FlintsFinger, GOTWaypoint.Highpoint, GOTWaypoint.TorhensSquare, GOTWaypoint.WidowsWatch, GOTWaypoint.Hornwood, GOTWaypoint.Ironrath, GOTWaypoint.Karhold, GOTWaypoint.LastHearth, GOTWaypoint.MoatKailin, GOTWaypoint.MormontsKeep, GOTWaypoint.OldCastle, GOTWaypoint.RamsGate, GOTWaypoint.RillwaterCrossing);
		f[57].affix(GOTWaypoint.Goldgrass, 0, 1, 0);
		f[57].affix(GOTWaypoint.RisvellsCastle, 0, 1, 0);
		f[57].affix(GOTWaypoint.ServinsCastle, -1, 0, 0);
		f[57].affix(GOTWaypoint.Winterfell, 0, 0, 1);
		...
		f[68].affix(GOTWaypoint.CastleBlack, 0, -1, 0);
