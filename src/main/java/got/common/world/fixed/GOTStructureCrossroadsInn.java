...
import got.common.world.structure.westeros.riverlands.GOTStructureRiverlandsBase;
import net.minecraft.init.Blocks;
import net.minecraft.world.World;

public class GOTStructureCrossroadsInn extends GOTVillageGen {
	public GOTStructureCrossroadsInn(GOTBiome biome, float f) {
		super(biome);
		gridScale = 10;
	...
	public static class Instance extends GOTVillageGen.AbstractInstance {
		public Instance(GOTStructureCrossroadsInn village, World world, int i, int k, Random random, GOTLocationInfo loc) {
			super(village, world, i, k, random, loc);
		}

		@Override
		public void addVillageStructures(Random random) {
			this.addStructure(new Tavern(false), -10, 30, 0, true);
		}
	...
	public static class Tavern extends GOTStructureRiverlandsBase {
		public String[] tavernName;
		public String[] tavernNameSign;

		public Tavern(boolean flag) {
			super(flag);
		}
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			this.placeChest(world, random, -3, 0, 8, 5, GOTChestContents.WESTEROS);
			for (k12 = 6; k12 <= 8; ++k12) {
			...
			GOTEntityHotPie bartender = new GOTEntityHotPie(world);
			...
			for (int l = 0; l < men; ++l) {
				GOTEntityRiverlandsMan westerosman = new GOTEntityRiverlandsMan(world);
				spawnNPCAndSetHome(westerosman, world, 2, 1, 7, 16);
			}
			spawnLegendaryNPC(new GOTEntityVargoHoat(world), world, 2, 1, 7);
			return true;
		}
