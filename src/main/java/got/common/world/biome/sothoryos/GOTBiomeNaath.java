...
public class GOTBiomeNaath extends GOTBiome {
	...
	public GOTBiomeNaath(int i, boolean major) {
		...
		spawnableGOTAmbientList.add(new BiomeGenBase.SpawnListEntry(GOTEntityButterfly.class, 15, 8, 8));
		...
		c1[0] = GOTBiomeSpawnList.entry(GOTSpawnList.GHISCAR_CORSAIR, 10).setSpawnChance(GOTBiome.CONQUEST_SPAWN);
