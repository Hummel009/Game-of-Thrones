...
public class GOTBiomeSothoryosDesert extends GOTBiome implements GOTBiome.Desert {
	...
	public GOTBiomeSothoryosDesert(int i, boolean major) {
		...
		c1.add(GOTBiomeSpawnList.entry(GOTSpawnList.DESERT_SCORPION, 1).setSpawnChance(GOTBiome.SPAWN));
