...
public class GOTBiomeYiTiFlat extends GOTBiomeYiTi {
	public GOTBiomeYiTiFlat(int i, boolean major) {
		...
		town.affix(GOTWaypoint.Manjin, 1, 0);
		town.affix(GOTWaypoint.Lizhao, 1, 0);
		town.affix(GOTWaypoint.Baoji, 0, 1);
		town.affix(GOTWaypoint.Yibin, -1, 0);
		town.affix(GOTWaypoint.Yunnan, 1, 0);
		town.affix(GOTWaypoint.Eijiang, 0, 1);
