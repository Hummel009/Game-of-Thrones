...
public class GOTBiomePentos extends GOTBiomeEssos {
	public GOTBiomePentos(int i, boolean major) {
		...
		c0[0] = GOTBiomeSpawnList.entry(GOTSpawnList.PENTOS_CIVILIAN, 10).setSpawnChance(GOTBiome.SPAWN);
		c0[1] = GOTBiomeSpawnList.entry(GOTSpawnList.PENTOS_MILITARY, 4).setSpawnChance(GOTBiome.SPAWN);
