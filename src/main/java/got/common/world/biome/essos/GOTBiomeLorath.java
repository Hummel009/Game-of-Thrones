...
public class GOTBiomeLorath extends GOTBiomeEssos {
	public GOTBiomeLorath(int i, boolean major) {
		...
		c1[0] = GOTBiomeSpawnList.entry(GOTSpawnList.IBBEN_CONQUEST, 10).setSpawnChance(GOTBiome.CONQUEST_SPAWN);
		npcSpawnList.newFactionList(0).add(c1);
		SpawnListContainer[] c0 = new SpawnListContainer[2];
		c0[0] = GOTBiomeSpawnList.entry(GOTSpawnList.LORATH_CIVILIAN, 10).setSpawnChance(GOTBiome.SPAWN);
		c0[1] = GOTBiomeSpawnList.entry(GOTSpawnList.LORATH_MILITARY, 4).setSpawnChance(GOTBiome.SPAWN);
