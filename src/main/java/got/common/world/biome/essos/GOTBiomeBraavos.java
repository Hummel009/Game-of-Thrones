...
public class GOTBiomeBraavos extends GOTBiomeEssos {
	public GOTBiomeBraavos(int i, boolean major) {
		...
		c0[0] = GOTBiomeSpawnList.entry(GOTSpawnList.BRAAVOS_CIVILIAN, 10).setSpawnChance(GOTBiome.SPAWN);
		c0[1] = GOTBiomeSpawnList.entry(GOTSpawnList.BRAAVOS_MILITARY, 4).setSpawnChance(GOTBiome.SPAWN);
