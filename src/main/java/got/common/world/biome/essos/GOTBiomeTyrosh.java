...
public class GOTBiomeTyrosh extends GOTBiomeEssos {
	public GOTBiomeTyrosh(int i, boolean major) {
		...
		c0[0] = GOTBiomeSpawnList.entry(GOTSpawnList.TYROSH_CIVILIAN, 10).setSpawnChance(GOTBiome.SPAWN);
		c0[1] = GOTBiomeSpawnList.entry(GOTSpawnList.TYROSH_MILITARY, 4).setSpawnChance(GOTBiome.SPAWN);
