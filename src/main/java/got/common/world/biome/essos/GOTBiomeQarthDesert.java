...
public class GOTBiomeQarthDesert extends GOTBiome implements GOTBiome.Desert {
	...
	public WorldGenerator boulderGenSandstone = new GOTWorldGenBoulder(GOTRegistry.redSandstone, 0, 1, 3);
