...
public abstract class GOTBiome extends BiomeGenBase {
	...
	public static Object essosMarshes;
	public static Object yiTiMarshes;
	...
	public static void preInit() {
		...
		arrynMountains = new GOTBiomeArrynMountains(6, true).setIsSeasonalWinterAZ().setMinMaxHeight(2.0f, 2.0f).setColor(0xC9DAE2).setBiomeName("arrynMountains");
		arrynTown = new GOTBiomeArrynTown(7, true).setIsSeasonalWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0x89BC5C).setBiomeName("arrynTown");
		...
		crownlandsTown = new GOTBiomeCrownlandsTown(22, true).setIsSeasonalWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0x83bc5a).setBiomeName("crownlandsTown");
		deathDesert = new GOTBiomeCannibalSands(23, true).setIsNeverWinter().setMinMaxHeight(0.2f, 0.1f).setColor(0xCCBC82).setBiomeName("deathDesert");
		...
		dorneMountains = new GOTBiomeDorneMountains(27, true).setIsNeverWinterAZ().setMinMaxHeight(2.0f, 2.0f).setColor(0xE8E7E1).setBiomeName("dorneMountains");
		...
		fireField = new GOTBiomeFireField(38, true).setIsNeverWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0xA3CC61).setBiomeName("fireField");
		...
		isleOfFaces = new GOTBiomeIsleOfFaces(56, true).setIsSeasonalWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0x788046).setBiomeName("isleOfFaces");
		...
		lhazar = new GOTBiomeLhazar(61, true).setIsNeverWinter().setMinMaxHeight(0.1f, 0.15f).setColor(0xAEB355).setBiomeName("lhazar");
		...
		mossovy = new GOTBiomeMossovy(71, true).setIsLongWinter().setMinMaxHeight(0.1f, 0.15f).setColor(0x92A351).setBiomeName("mossovy");
		kanduuBet = new GOTBiomeKanduuBet(72, true).setIsLongWinter().setMinMaxHeight(0.1f, 0.15f).setColor(0x72873B).setBiomeName("kanduuBet");
		suudanKorkuu = new GOTBiomeSuudanKorkuu(73, true).setIsLongWinter().setMinMaxHeight(0.0f, 0.1f).setColor(0x749975).setBiomeName("suudanKorkuu");
		kuurulgan = new GOTBiomeKuurulgan(75, true).setIsLongWinterAZ().setMinMaxHeight(2.0f, 2.0f).setColor(0xD3D3D3).setBiomeName("kuurulgan");
		...
		northTown = new GOTBiomeNorthTown(87, true).setIsLongWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0xA6BD64).setBiomeName("northTown");
		...
		reachTown = new GOTBiomeReachTown(104, true).setIsNeverWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0xA2C964).setBiomeName("reachTown");
		...
		stormlandsTown = new GOTBiomeStormlands(135, true).setIsNeverWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0x91C94C).setBiomeName("stormlandsTown");
		...
		westerlandsTown = new GOTBiomeWesterlandsTown(155, true).setIsSeasonalWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0xbfc962).setBiomeName("westerlandsTown");
		...
		wetwood = new GOTBiomeWetwood(157, true).setIsSeasonalWinter().setMinMaxHeight(0.0f, 0.1f).setColor(0x578C54).setBiomeName("wetwood");
		...
		yiTiWasteland = new GOTBiomeYiTiWasteland(163, true).setIsNeverWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0xaaae56).setBiomeName("yiTi");
