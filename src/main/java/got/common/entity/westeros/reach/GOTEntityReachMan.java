...
public class GOTEntityReachMan extends GOTEntityHumanBase implements IPickpocketable {
	...
	public GOTEntityReachMan(World world) {
		...
		tasks.addTask(2, createReachAttackAI());
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeReach) {
			f += 20.0f;
		}
		return f;
	}
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		...
		if (isFriendly(entityplayer)) {
			return "westeros/reach/man/friendly";
		}
		return "westeros/reach/man/hostile";
	}
