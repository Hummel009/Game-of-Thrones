...
public class GOTEntityDragonstoneMan extends GOTEntityHumanBase {
	...
	public GOTEntityDragonstoneMan(World world) {
		...
		tasks.addTask(2, createDragonstoneAttackAI());
	...
	protected EntityAIBase createDragonstoneAttackAI() {
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeDragonstone) {
			f += 20.0f;
		}
		return f;
	}
