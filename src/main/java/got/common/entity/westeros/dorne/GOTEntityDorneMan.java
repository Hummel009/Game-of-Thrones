...
public class GOTEntityDorneMan extends GOTEntityHumanBase {
	...
	public GOTEntityDorneMan(World world) {
		...
		tasks.addTask(2, createDorneAttackAI());
	...
	protected EntityAIBase createDorneAttackAI() {
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeDorne) {
			f += 20.0f;
		}
		return f;
	}
