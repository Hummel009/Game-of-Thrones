...
public class GOTEntityDorneBlacksmith extends GOTEntityDorneMan implements GOTTradeable.Smith {
	public GOTEntityDorneBlacksmith(World world) {
		super(world);
		canBeMarried = false;
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (isFriendly(entityplayer)) {
			if (canTradeWith(entityplayer)) {
				return "westeros/dorne/blacksmith/friendly";
			}
			return "westeros/dorne/blacksmith/neutral";
		}
		return "westeros/dorne/blacksmith/hostile";
	}
