...
public class GOTEntityStormlandsFarmer extends GOTEntityStormlandsMan implements GOTTradeable, GOTUnitTradeable {
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (isFriendly(entityplayer)) {
			return "westeros/stormlands/farmer/friendly";
		}
		return "westeros/stormlands/farmer/hostile";
	}

	@Override
	public GOTUnitTradeEntries getUnits() {
		return GOTUnitTradeEntries.STORMLANDS_FARMER;
	}
