...
public class GOTEntityCrownlandsBlacksmith extends GOTEntityCrownlandsMan implements GOTTradeable.Smith {
	public GOTEntityCrownlandsBlacksmith(World world) {
		super(world);
		canBeMarried = false;
