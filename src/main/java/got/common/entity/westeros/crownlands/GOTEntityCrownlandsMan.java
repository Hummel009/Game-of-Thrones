...
public class GOTEntityCrownlandsMan extends GOTEntityHumanBase {
	...
	public GOTEntityCrownlandsMan(World world) {
		...
		tasks.addTask(2, createCrownlandsAttackAI());
	...
	protected EntityAIBase createCrownlandsAttackAI() {
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeCrownlands) {
			f += 20.0f;
		}
		return f;
	}
