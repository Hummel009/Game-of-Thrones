...
public class GOTEntityMatthosSeaworth extends GOTEntityHumanBase {
	public GOTEntityMatthosSeaworth(World world) {
		super(world);
		canBeMarried = false;
		addTargetTasks(true);
		setIsLegendaryNPC();
		...
		tasks.addTask(7, new GOTEntityAINPCFollowNPC(this, GOTEntitySelyseBaratheon.class));
