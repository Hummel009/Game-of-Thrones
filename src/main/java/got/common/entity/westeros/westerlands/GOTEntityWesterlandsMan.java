...
public class GOTEntityWesterlandsMan extends GOTEntityHumanBase implements IPickpocketable {
	...
	public GOTEntityWesterlandsMan(World world) {
		...
		tasks.addTask(2, createWesterlandsAttackAI());
	...
	public EntityAIBase createWesterlandsAttackAI() {
		return new GOTEntityAIAttackOnCollide(this, 1.3, false);
	}
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeWesterlands) {
			f += 20.0f;
		}
		return f;
	}
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		...
		if (isFriendly(entityplayer)) {
			return "westeros/westerlands/man/friendly";
		}
		return "westeros/westerlands/man/hostile";
	}
