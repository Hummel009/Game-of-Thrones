...
public class GOTEntityRiverlandsSoldier extends GOTEntityRiverlandsLevyman {
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
		...
		setCurrentItemOrArmor(1, new ItemStack(GOTRegistry.riverlandsBoots));
		setCurrentItemOrArmor(2, new ItemStack(GOTRegistry.riverlandsLeggings));
		setCurrentItemOrArmor(3, new ItemStack(GOTRegistry.riverlandsChestplate));
		setCurrentItemOrArmor(4, new ItemStack(GOTRegistry.riverlandsHelmet));
		return data;
	}
}
