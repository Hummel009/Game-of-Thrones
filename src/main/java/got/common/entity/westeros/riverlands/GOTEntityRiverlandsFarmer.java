...
public class GOTEntityRiverlandsFarmer extends GOTEntityRiverlandsMan implements GOTTradeable, GOTUnitTradeable {
	public GOTEntityRiverlandsFarmer(World world) {
		super(world);
		canBeMarried = false;
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (isFriendly(entityplayer)) {
			return "westeros/riverlands/farmer/friendly";
		}
		return "westeros/riverlands/farmer/hostile";
	}
