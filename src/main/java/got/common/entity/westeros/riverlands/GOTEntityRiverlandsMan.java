...
public class GOTEntityRiverlandsMan extends GOTEntityHumanBase {
	...
	public GOTEntityRiverlandsMan(World world) {
		...
		tasks.addTask(2, createRiverlandsAttackAI());
	...
	protected EntityAIBase createRiverlandsAttackAI() {
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeRiverlands) {
			f += 20.0f;
		}
		return f;
	}
