...
public class GOTEntityRiverlandsBlacksmith extends GOTEntityRiverlandsMan implements GOTTradeable.Smith {
	@SuppressWarnings({"WeakerAccess", "unused"})
	public GOTEntityRiverlandsBlacksmith(World world) {
		super(world);
