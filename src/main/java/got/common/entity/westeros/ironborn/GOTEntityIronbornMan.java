...
public class GOTEntityIronbornMan extends GOTEntityHumanBase implements IPickpocketable {
	...
	public GOTEntityIronbornMan(World world) {
		...
		tasks.addTask(2, createIronbornAttackAI());
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		...
		if (isFriendly(entityplayer)) {
			return "westeros/ironborn/man/friendly";
		}
		return "westeros/ironborn/man/hostile";
	}
