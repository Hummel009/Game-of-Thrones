...
public class GOTEntityNorvosBartender extends GOTEntityNorvosMan implements GOTTradeable.Bartender {
	public GOTEntityNorvosBartender(World world) {
		super(world);
		canBeMarried = false;
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (isFriendly(entityplayer)) {
			return "essos/norvos/bartender/friendly";
		}
		return "essos/norvos/bartender/hostile";
	}
