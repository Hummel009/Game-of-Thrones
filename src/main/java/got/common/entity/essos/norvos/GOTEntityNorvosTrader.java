...
public abstract class GOTEntityNorvosTrader extends GOTEntityNorvosMan implements GOTTradeable {
	public GOTEntityNorvosTrader(World world) {
		super(world);
		canBeMarried = false;
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (isFriendly(entityplayer)) {
			return "essos/norvos/bazaarTrader/friendly";
		}
		return "essos/norvos/bazaarTrader/hostile";
	}
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
		...
		setCurrentItemOrArmor(4, GOTEntityNorvosTrader.createTraderTurban(rand));
		return data;
	}
