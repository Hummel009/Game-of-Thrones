...
public class GOTEntityNorvosMan extends GOTEntityHumanBase {
	...
	public GOTMiniQuest createMiniQuest() {
		return GOTMiniQuestFactory.NORVOS.createQuest(this);
	}
	...
	protected EntityAIBase createNorvosAttackAI() {
