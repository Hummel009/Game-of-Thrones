...
public abstract class GOTEntityBraavosTrader extends GOTEntityBraavosMan implements GOTTradeable {
	public GOTEntityBraavosTrader(World world) {
		super(world);
		canBeMarried = false;
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (isFriendly(entityplayer)) {
			return "essos/braavos/bazaarTrader/friendly";
		}
		return "essos/braavos/bazaarTrader/hostile";
	}
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
		...
		setCurrentItemOrArmor(4, GOTEntityBraavosTrader.createTraderTurban(rand));
		return data;
	}
