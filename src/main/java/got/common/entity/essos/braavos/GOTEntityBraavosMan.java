...
public class GOTEntityBraavosMan extends GOTEntityHumanBase implements IPickpocketable {
	public GOTEntityBraavosMan(World world) {
		...
		tasks.addTask(2, createBraavosAttackAI());
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeBraavos) {
			f += 20.0f;
		}
		return f;
	}
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		...
		if (isFriendly(entityplayer)) {
			return "essos/braavos/man/friendly";
		}
		return "essos/braavos/man/hostile";
	}
