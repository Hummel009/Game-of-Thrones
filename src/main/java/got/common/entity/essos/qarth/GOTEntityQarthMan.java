...
public class GOTEntityQarthMan extends GOTEntityHumanBase implements GOTBiome.ImmuneToHeat {
	...
	public GOTEntityQarthMan(World world) {
		...
		tasks.addTask(2, createQarthAttackAI());
	...
	public GOTNPCMount createMountToRide() {
		GOTEntityCamel camel = new GOTEntityCamel(worldObj);
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeQarth) {
			f += 20.0f;
		}
		return f;
	}
