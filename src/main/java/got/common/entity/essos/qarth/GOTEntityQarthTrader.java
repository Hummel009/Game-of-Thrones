...
public abstract class GOTEntityQarthTrader extends GOTEntityQarthMan implements GOTTradeable {
	public GOTEntityQarthTrader(World world) {
		super(world);
		canBeMarried = false;
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (isFriendly(entityplayer)) {
			return "essos/qarth/bazaarTrader/friendly";
		}
		return "essos/qarth/bazaarTrader/hostile";
	}
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
		...
		setCurrentItemOrArmor(4, GOTEntityQarthTrader.createTraderTurban(rand));
		return data;
	}
