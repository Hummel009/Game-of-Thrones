...
public class GOTEntityQarthBlacksmith extends GOTEntityQarthMan implements GOTTradeable.Smith {
	public GOTEntityQarthBlacksmith(World world) {
		super(world);
		canBeMarried = false;
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (isFriendly(entityplayer)) {
			if (canTradeWith(entityplayer)) {
				return "essos/qarth/blacksmith/friendly";
			}
			return "essos/qarth/blacksmith/neutral";
		}
		return "essos/qarth/blacksmith/hostile";
	}
