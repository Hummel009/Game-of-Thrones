...
public class GOTEntityMyrMan extends GOTEntityHumanBase implements IPickpocketable {
	public GOTEntityMyrMan(World world) {
		...
		tasks.addTask(2, createMyrAttackAI());
	...
	public GOTMQ createMiniQuest() {
		return GOTMQFactory.MYR.createQuest(this);
	}
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeMyr) {
			f += 20.0f;
		}
		return f;
	}
