...
public class GOTEntityJaqenHghar extends GOTEntityHumanBase {
	...
	public GOTAchievement getKillAchievement() {
		return GOTAchievement.KILL_JAQEN_HGHAR;
	}
	...
	public void onArtificalSpawn() {
		GOTJaqenHgharTracker.addNewFaceless(getUniqueID());
		arriveAt(null);
	}
	...
	public void onLivingUpdate() {
		...
		if (!worldObj.isRemote && !GOTJaqenHgharTracker.isFacelessActive(getUniqueID()) && getAttackTarget() == null) {
			depart();
		}
	}
