...
public class GOTEntityQohorMan extends GOTEntityHumanBase implements IPickpocketable {
	public GOTEntityQohorMan(World world) {
		...
		tasks.addTask(2, createQohorAttackAI());
	...
	public EntityAIBase createQohorAttackAI() {
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeQohor) {
			f += 20.0f;
		}
		return f;
	}
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		...
		if (isFriendly(entityplayer)) {
			return "essos/qohor/man/friendly";
		}
		return "essos/qohor/man/hostile";
	}
