...
public class GOTEntityLorathFarmer extends GOTEntityLorathMan implements GOTTradeable {
	public GOTEntityLorathFarmer(World world) {
		super(world);
		canBeMarried = false;
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (isFriendly(entityplayer)) {
			return "essos/lorath/farmer/friendly";
		}
		return "essos/lorath/farmer/hostile";
	}
