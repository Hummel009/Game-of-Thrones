...
public class GOTEntityLorathMan extends GOTEntityHumanBase implements IPickpocketable {
	public GOTEntityLorathMan(World world) {
		...
		tasks.addTask(2, createLorathAttackAI());
	...
	public GOTMQ createMiniQuest() {
		return GOTMQFactory.LORATH.createQuest(this);
	}
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeLorath) {
			f += 20.0f;
		}
		return f;
	}
