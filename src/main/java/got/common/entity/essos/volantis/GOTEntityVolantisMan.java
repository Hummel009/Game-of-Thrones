...
public class GOTEntityVolantisMan extends GOTEntityHumanBase implements IPickpocketable {
	public GOTEntityVolantisMan(World world) {
		...
		tasks.addTask(2, createVolantisAttackAI());
	...
	public EntityAIBase createVolantisAttackAI() {
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeVolantis) {
			f += 20.0f;
		}
		return f;
	}
