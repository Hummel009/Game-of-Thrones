...
public class GOTEntityArrowPoisoned extends EntityArrow implements IEntityAdditionalSpawnData {
	public GOTEntityArrowPoisoned(World world) {
		super(world);
	}

	public GOTEntityArrowPoisoned(World world, double d, double d1, double d2) {
		super(world, d, d1, d2);
	}

	public GOTEntityArrowPoisoned(World world, EntityLivingBase shooter, EntityLivingBase target, float charge, float inaccuracy) {
		super(world, shooter, target, charge, inaccuracy);
	}

	public GOTEntityArrowPoisoned(World world, EntityLivingBase shooter, float charge) {
