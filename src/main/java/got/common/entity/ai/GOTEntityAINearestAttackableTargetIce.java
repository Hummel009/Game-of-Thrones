...
public class GOTEntityAINearestAttackableTargetIce extends GOTEntityAINearestAttackableTargetPatriot {
	...
	public boolean isSuitableTarget(EntityLivingBase entity, boolean flag) {
		...
		if (entity instanceof GOTEntityBandit
		 || entity instanceof GOTEntityGoldenMan
		 || entity instanceof GOTEntityScrapTrader
		 || entity instanceof GOTEntityGendryBaratheon
		 || entity instanceof GOTEntityBronn
		 || entity instanceof GOTEntityGeroldDayne
		 || entity instanceof GOTEntityThreeEyedRaven
		 || entity instanceof GOTEntityMaester
		 || entity instanceof GOTEntityWhore) {
			return true;
		}
		return false;
	}
