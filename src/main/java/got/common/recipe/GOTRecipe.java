...
public class GOTRecipe {
	...
	public static void createAsshaiRecipes() {
		...
		asshai.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableAsshai), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createBraavosRecipes() {
		braavos.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableBraavos), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createCrownlandsRecipes() {
		crownlands.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.kingsguardHelmet), "XXX", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		crownlands.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.kingsguardChestplate), "X X", "XXX", "XXX", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
	...
	public static void createDothrakiRecipes() {
		dothraki.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.dothrakiHorseArmor), "X  ", "XXX", "XXX", Character.valueOf('X'), Items.leather));
	...
	public static void createGhiscarRecipes() {
		ghiscar.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.unsulliedHelmet), "XXX", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		ghiscar.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.unsulliedChestplate), "X X", "XXX", "XXX", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		ghiscar.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.unsulliedLeggings), "XXX", "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		ghiscar.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.unsulliedBoots), "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		ghiscar.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableGhiscar), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createHillmanRecipes() {
		hillmen.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableHillTribes), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createLhazarRecipes() {
		lhazar.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableLhazar), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createLorathRecipes() {
		lorath.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableLorath), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createLysRecipes() {
		lys.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableLys), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createMyrRecipes() {
		myr.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableMyr), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createNorthRecipes() {
		north.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.northguardHelmet), "XXX", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		north.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.northguardChestplate), "X X", "XXX", "XXX", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
	...
	public static void createNorvosRecipes() {
		norvos.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableNorvos), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createPentosRecipes() {
		pentos.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tablePentos), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createQarthRecipes() {
		qarth.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableQarth), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createQohorRecipes() {
		qohor.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.unsulliedHelmet), "XXX", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		qohor.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.unsulliedChestplate), "X X", "XXX", "XXX", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		qohor.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.unsulliedLeggings), "XXX", "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		qohor.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.unsulliedBoots), "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		qohor.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableQohor), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createReachRecipes() {
		reach.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.reachguardHelmet), "XXX", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		reach.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.reachguardChestplate), "X X", "XXX", "XXX", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
	...
	public static void createSothoryosRecipes() {
		sothoryos.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableSothoryos), "XX", "XX", Character.valueOf('X'), "plankWood"));
		...
		sothoryos.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.sarbacane), "XYY", Character.valueOf('X'), "stickWood", Character.valueOf('Y'), GOTRegistry.reeds));
		...
		sothoryos.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.sarbacaneTrap), "XXX", "XYX", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick4, 1, 0), Character.valueOf('Y'), new ItemStack(GOTRegistry.sarbacane, 1, 0)));
		...
		sothoryos.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.sarbacaneTrapGold), "XXX", "XYX", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick4, 1, 3), Character.valueOf('Y'), new ItemStack(GOTRegistry.sarbacane, 1, 0)));
		...
		sothoryos.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.sarbacaneTrapObsidian), "XXX", "XYX", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick4, 1, 4), Character.valueOf('Y'), new ItemStack(GOTRegistry.sarbacane, 1, 0)));
	...
	public static void createStandardRecipes() {
		int i;
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.brick6, 1, 3), "XXX", "XYX", "XXX", Character.valueOf('X'), GOTRegistry.westerosSword, Character.valueOf('Y'), Items.lava_bucket));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.brick6, 1, 3), "XXX", "XYX", "XXX", Character.valueOf('X'), Items.iron_sword, Character.valueOf('Y'), Items.lava_bucket));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.beacon), "XXX", "XXX", "YYY", Character.valueOf('X'), "logWood", Character.valueOf('Y'), Blocks.cobblestone));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsSandstoneBrick, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick1, 1, 15)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.wallStone1, 6, 15), "XXX", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick1, 1, 15)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.pillar1, 3, 5), "X", "X", "X", Character.valueOf('X'), new ItemStack(Blocks.sandstone, 1, 0)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle4, 6, 7), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.pillar1, 1, 5)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.brick3, 1, 8), "XX", "XX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick1, 1, 15)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle7, 6, 1), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick3, 1, 11)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsSandstoneBrickCracked, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick3, 1, 11)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.wallStone3, 6, 3), "XXX", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick3, 1, 11)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.brick3, 4, 13), "XX", "XX", Character.valueOf('X'), new ItemStack(GOTRegistry.redSandstone, 1, 0)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle7, 6, 2), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick3, 1, 13)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsSandstoneBrickRed, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick3, 1, 13)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.wallStone3, 6, 4), "XXX", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick3, 1, 13)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.brick3, 1, 15), "XX", "XX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick3, 1, 13)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle7, 6, 3), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick3, 1, 14)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsSandstoneBrickRedCracked, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick3, 1, 14)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.wallStone3, 6, 5), "XXX", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick3, 1, 14)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.pillar1, 3, 15), "X", "X", "X", Character.valueOf('X'), new ItemStack(GOTRegistry.redSandstone, 1, 0)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle7, 6, 4), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.pillar1, 1, 15)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.brick4, 1, 7), " X ", "XYX", " X ", Character.valueOf('X'), "gemLapis", Character.valueOf('Y'), new ItemStack(GOTRegistry.brick1, 1, 15)));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.brick1, 1, 5), "XX", "XX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick1, 1, 1)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.brick1, 4, 1), "XX", "XX", Character.valueOf('X'), new ItemStack(GOTRegistry.rock, 1, 1)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.pillar1, 3, 6), "X", "X", "X", Character.valueOf('X'), new ItemStack(GOTRegistry.rock, 1, 1)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle1, 6, 2), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.smoothStone, 1, 1)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle1, 6, 3), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick1, 1, 1)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle1, 6, 4), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick1, 1, 2)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle1, 6, 5), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick1, 1, 3)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle11, 6, 3), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.rock, 1, 1)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle5, 6, 0), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.pillar1, 1, 6)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.smoothStone, 2, 1), "X", "X", Character.valueOf('X'), new ItemStack(GOTRegistry.rock, 1, 1)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsAndesite, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.rock, 1, 1)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsAndesiteBrick, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick1, 1, 1)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsAndesiteBrickCracked, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick1, 1, 3)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsAndesiteBrickMossy, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick1, 1, 2)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.wallStone1, 6, 2), "XXX", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.rock, 1, 1)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.wallStone1, 6, 3), "XXX", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick1, 1, 1)));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.alloySteelHoe), "XX", " Y", " Y", Character.valueOf('X'), GOTRegistry.alloySteelIngot, Character.valueOf('Y'), "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.alloySteelPickaxe), "XXX", " Y ", " Y ", Character.valueOf('X'), GOTRegistry.alloySteelIngot, Character.valueOf('Y'), "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.alloySteelShovel), "X", "Y", "Y", Character.valueOf('X'), GOTRegistry.alloySteelIngot, Character.valueOf('Y'), "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.alloySteelSword), "X", "X", "Y", Character.valueOf('X'), GOTRegistry.alloySteelIngot, Character.valueOf('Y'), "stickWood"));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsLabradorite, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.rock, 1, 6)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsLabradoriteBrick, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick6, 1, 4)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsLabradoriteBrickMossy, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick6, 1, 7)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsLabradoriteBrickCracked, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick6, 1, 6)));
		...
		GameRegistry.addRecipe(new ItemStack(GOTRegistry.blockMetal2, 1, 4), "XXX", "XXX", "XXX", Character.valueOf('X'), GOTRegistry.alloySteelIngot);
		...
		GameRegistry.addRecipe(new ItemStack(GOTRegistry.pressurePlateLabradorite), "XX", Character.valueOf('X'), new ItemStack(GOTRegistry.rock, 1, 6));
	...
	public static void createSummerRecipes() {
		summer.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableSummer), "XX", "XX", Character.valueOf('X'), "plankWood"));
		...
		summer.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.summerSword), "X", "X", "Y", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), "stickWood"));
		summer.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.summerDagger), "X", "Y", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), "stickWood"));
		summer.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.summerSpear), "  X", " Y ", "Y  ", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), "stickWood"));
		summer.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.summerPike), "  X", " YX", "Y  ", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), "stickWood"));
		summer.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.essosBow), " XY", "X Y", " XY", Character.valueOf('X'), "stickWood", Character.valueOf('Y'), Items.string));
	}

	public static void createTinyBasaltRecipes() {
		tinyBasalt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.brick2, 4, 11), "XX", "XX", Character.valueOf('X'), new ItemStack(GOTRegistry.rock, 1, 0)));
		tinyBasalt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.brick4, 1, 6), "XX", "XX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick2, 1, 11)));
		tinyBasalt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.pillar1, 3, 9), "X", "X", "X", Character.valueOf('X'), new ItemStack(GOTRegistry.rock, 1, 0)));
		tinyBasalt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle5, 6, 3), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick2, 1, 11)));
		tinyBasalt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.slabSingle5, 6, 4), "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.pillar1, 1, 9)));
		tinyBasalt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.wallStone2, 6, 10), "XXX", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick2, 1, 11)));
		tinyBasalt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.stairsBasaltWesterosBrick, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(GOTRegistry.brick2, 1, 11)));
	}

	public static void createTyroshRecipes() {
		tyrosh.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableTyrosh), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createUnsmeltingRecipes() {
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.renlyHelmet), "XXX", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.renlyChestplate), "X X", "XXX", "XXX", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.renlyLeggings), "XXX", "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.renlyBoots), "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		...
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.redkingHelmet), "XXX", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.redkingChestplate), "X X", "XXX", "XXX", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.redkingLeggings), "XXX", "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.redkingBoots), "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.westkingHelmet), "XXX", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.westkingChestplate), "X X", "XXX", "XXX", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.westkingLeggings), "XXX", "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.westkingBoots), "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.blackfyreHelmet), "XXX", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.blackfyreChestplate), "X X", "XXX", "XXX", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.blackfyreLeggings), "XXX", "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.blackfyreBoots), "X X", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
	...
	public static void createVolantisRecipes() {
		volantis.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.tableVolantis), "XX", "XX", Character.valueOf('X'), "plankWood"));
	...
	public static void createWesterlandsRecipes() {
		westerlands.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.westerlandsguardHelmet), "XXX", "X X", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
		westerlands.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.westerlandsguardChestplate), "X X", "XXX", "XXX", Character.valueOf('X'), GOTRegistry.alloySteelIngot));
	...
	public static void createYiTiRecipes() {
		...
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.brick5, 4, 11), "XX", "XX", Character.valueOf('X'), new ItemStack(Blocks.stone, 1, 0)));
		...
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.pillar2, 3, 8), "X", "X", "X", Character.valueOf('X'), new ItemStack(Blocks.stone, 1, 0)));
		...
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.yitiBoots), "X X", "X X", Character.valueOf('X'), "ingotIron"));
		...
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.yitiBootsSamurai), "Y Y", "X X", Character.valueOf('X'), GOTRegistry.yitiSteelIngot, Character.valueOf('Y'), "ingotIron"));
		...
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.yitiChestplate), "X X", "XXX", "XXX", Character.valueOf('X'), "ingotIron"));
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.yitiChestplateFrontier), "X X", "YXY", "XYX", Character.valueOf('X'), GOTRegistry.yitiSteelIngot, Character.valueOf('Y'), "ingotIron"));
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.yitiChestplateSamurai), "X X", "XYX", "YXY", Character.valueOf('X'), GOTRegistry.yitiSteelIngot, Character.valueOf('Y'), "ingotIron"));
		...
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.yitiHelmet), "XXX", "X X", Character.valueOf('X'), "ingotIron"));
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.yitiHelmetFrontier), "XYX", "Y Y", Character.valueOf('X'), GOTRegistry.yitiSteelIngot, Character.valueOf('Y'), "ingotIron"));
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.yitiHelmetSamurai), "YYY", "X X", Character.valueOf('X'), GOTRegistry.yitiSteelIngot, Character.valueOf('Y'), "ingotIron"));
		...
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.yitiHorseArmor), "X  ", "XXX", "XXX", Character.valueOf('X'), "ingotIron"));
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.yitiLeggings), "XXX", "X X", "X X", Character.valueOf('X'), "ingotIron"));
		...
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.yitiLeggingsSamurai), "XXX", "X X", "Y Y", Character.valueOf('X'), GOTRegistry.yitiSteelIngot, Character.valueOf('Y'), "ingotIron"));
