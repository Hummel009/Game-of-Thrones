...
public class NEIGOTIntegratorConfig implements IConfigureNEI {
	...
	public void loadConfig() {
		...
		hideItem(true, GOTBlocks.dateBlock);
		hideItem(true, GOTBlocks.bananaBlock);
		...
		hideItem(true, GOTBlocks.mugBlock);
		hideItem(true, GOTBlocks.ceramicMugBlock);
		hideItem(true, GOTBlocks.gobletGoldBlock);
		hideItem(true, GOTBlocks.gobletSilverBlock);
		hideItem(true, GOTBlocks.gobletCopperBlock);
		hideItem(true, GOTBlocks.gobletWoodBlock);
		hideItem(true, GOTBlocks.skullCupBlock);
		hideItem(true, GOTBlocks.wineGlassBlock);
		hideItem(true, GOTBlocks.glassBottleBlock);
		hideItem(true, GOTBlocks.aleHornBlock);
		hideItem(true, GOTBlocks.aleHornGoldBlock);
		hideItem(true, GOTBlocks.plateBlock);
		hideItem(true, GOTBlocks.ceramicPlateBlock);
		hideItem(true, GOTBlocks.woodPlateBlock);
