...
public class GOTHandlerAlloyForge extends TemplateRecipeHandler {
	...
	public List<GOTHandlerAlloyForge.CachedForgeRecipe> getAlloySmeltingRecipes(ItemStack result) {
	...
	public List<GOTHandlerAlloyForge.CachedForgeRecipe> getAlloySmeltingRecipesUsage(ItemStack ingredient) {
		ArrayList<GOTHandlerAlloyForge.CachedForgeRecipe> ret = new ArrayList<>();
	...
	public void handlerCRStack(Item forgeItem, ItemStack result) {
		...
		if (NEIServerUtils.areStacksSameType(alloyForgeDummy.getSmeltingResult(stack), result)) {
			...
			list.add(stack);
			arecipes.add(new GOTHandlerAlloyForge.CachedForgeRecipe((ItemStack[]) null, list.toArray(new ItemStack[list.size()]), result));
		}
	}
